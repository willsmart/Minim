...
@implementation NSObject(minim)

-(NSObject*)asValidJsonObject {MSGSTART("NSObject:-(NSObject*)asValidJsonObject")
  return(self.description);}
-(bool)isWeakSelf {MSGSTART("NSObject:-(bool)isWeakSelf")
  return(NO);
}
-(NSString*)jsonString {MSGSTART("NSObject:-(NSString*)jsonString")
  return(self.description);}
...
-(void)performUnknownVoidSelector:(SEL)aSelector {MSGSTART("NSObject:-(void)performUnknownVoidSelector:(SEL)aSelector")
...
-(void)performUnknownVoidSelector:(SEL)aSelector withObject:(id)anObject {MSGSTART("NSObject:-(void)performUnknownVoidSelector:(SEL)aSelector withObject:(id)anObject")
...
-(void)performUnknownVoidSelector:(SEL)aSelector withObject:(id)anObject withObject:(id)anotherObject {MSGSTART("NSObject:-(void)performUnknownVoidSelector:(SEL)aSelector withObject:(id)anObject withObject:(id)anotherObject")
...
-(id)selfWithWeakness:(bool)weak {MSGSTART("NSObject:-(id)selfWithWeakness:(bool)weak")
...
@implementation NSString(minim)

-(void)applyRegexes:(NSObject*)regexesArrayOrDictionary mutableString:(NSMutableString*__strong*)pmutableString {MSGSTART("NSString:-(void)applyRegexes:(NSObject*)regexesArrayOrDictionary mutableString:(NSMutableString*__strong*)pmutableString")
...
-(NSObject*)asValidJsonObject {MSGSTART("NSString:-(NSObject*)asValidJsonObject")
  return(self);}
-(BOOL)isMatchedByRegex:(NSRegularExpression*)regex {MSGSTART("NSString:-(BOOL)isMatchedByRegex:(NSRegularExpression*)regex")

          return([regex rangeOfFirstMatchInString:self options:0 range:NSMakeRange(0,self.length)].location!=NSNotFound);
    }
-(NSString*)JSONString {MSGSTART("NSString:-(NSString*)JSONString")
  return(JSONStringForString(self));}
-(NSString*)jsonString {MSGSTART("NSString:-(NSString*)jsonString")
  return(self);}
+(NSString*)JSONStringForCString:(const char *)from withLength:(Int)N useTmpDataObject:(NSMutableData*)d {MSGSTART("NSString:+(NSString*)JSONStringForCString:(const char *)from withLength:(Int)N useTmpDataObject:(NSMutableData*)d")

          return(JSONStringForCString(from,N,d));
    }
+(const unichar*)JSONunicharsStringForCString:(const char *)from withLength:(Int)N useTmpDataObject:(NSMutableData*__strong*)pd retLength:(Int*)retLength {MSGSTART("NSString:+(const unichar*)JSONunicharsStringForCString:(const char *)from withLength:(Int)N useTmpDataObject:(NSMutableData*__strong*)pd retLength:(Int*)retLength")

          return(JSONunicharsStringForCString(from,N,pd,retLength));
    }
-(NSString*)replaceEnvironmentVariables_error:(NSError*__strong*)perror {MSGSTART("NSString:-(NSString*)replaceEnvironmentVariables_error:(NSError*__strong*)perror")
...
+(StringRequestURLDelegate*)requestStringWithContentsOfURL:(NSURL*)aurl encoding:(NSStringEncoding)encoding timeoutInterval:(float)timeout completion:(StringRequestURLDelegateCompletionBlock)completionBlock {MSGSTART("NSString:+(StringRequestURLDelegate*)requestStringWithContentsOfURL:(NSURL*)aurl encoding:(NSStringEncoding)encoding timeoutInterval:(float)timeout completion:(StringRequestURLDelegateCompletionBlock)completionBlock")
...
-(NSRegularExpression*)stringAsRegularExpression {MSGSTART("NSString:-(NSRegularExpression*)stringAsRegularExpression")
...
-(NSString*)stringByApplyingRegexes:(NSObject*)regexesArrayOrDictionary {MSGSTART("NSString:-(NSString*)stringByApplyingRegexes:(NSObject*)regexesArrayOrDictionary")

          NSMutableString *ms=nil;
          [self applyRegexes:regexesArrayOrDictionary mutableString:&ms];
          return(ms?ms:self);
    }
-(NSString*)stringByDecodingCEscapes {MSGSTART("NSString:-(NSString*)stringByDecodingCEscapes")

          return([self stringByReplacingPairs:@"\\\\",@"\\\\ ",@"\\t",@"\t",@"\\r",@"\r",@"\\n",@"\n",@"\\\"",@"\"",@"\\'",@"'",@"\\\\ ",@"\\",nil]);
    }
-(NSString*)stringByEncodingCEscapes {MSGSTART("NSString:-(NSString*)stringByEncodingCEscapes")

          return([self stringByReplacingPairs:@"\\",@"\\\\",@"\"",@"\\\"",@"\n",@"\\n",@"\r",@"\\r",@"\t",@"\\t",nil]);
    }
-(NSString*)stringByEncodingHTMLEntities {MSGSTART("NSString:-(NSString*)stringByEncodingHTMLEntities")

          return([self stringByReplacingPairs:@"&",@"&amp;",@"<",@"&lt;",@">",@"&gt;",@"\"",@"&quot;",@"\n",@"<br/>\n",nil]);
    }
-(NSString*)stringByReplacingPairs:(NSObject*)firstNeedle,... {MSGSTART("NSString:-(NSString*)stringByReplacingPairs:(NSObject*)firstNeedle,...")
...
+(NSString*)stringWithContentsOfURL:(NSURL*)aurl encoding:(NSStringEncoding)encoding error:(NSError*__strong*)aerr timeoutInterval:(float)timeout {MSGSTART("NSString:+(NSString*)stringWithContentsOfURL:(NSURL*)aurl encoding:(NSStringEncoding)encoding error:(NSError*__strong*)aerr timeoutInterval:(float)timeout")
...
-(unichar*)unicharCString {MSGSTART("NSString:-(unichar*)unicharCString")
          ...
          for (int i=0;i<self.length;i++) ret[i]=[self characterAtIndex:i];
          ret[self.length]=0;
          return(ret);
    }
-(NSString*)urlEncodeUsingEncoding:(NSStringEncoding)encoding {MSGSTART("NSString:-(NSString*)urlEncodeUsingEncoding:(NSStringEncoding)encoding")

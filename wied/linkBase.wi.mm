...
-(void)_startObjectOfClassEndpoint1 {MSGSTART("Endpoint1:-(void)_startObjectOfClassEndpoint1")
  ...
  /*i0*/}
-(bool)_addReferrer:(NSObject<LinkEndpoint>*)ep {MSGSTART("Endpoint1:-(bool)_addReferrer:(NSObject<LinkEndpoint>*)ep")
...
-(void)_removeReferrer:(NSObject<LinkEndpoint>*)ep {MSGSTART("Endpoint1:-(void)_removeReferrer:(NSObject<LinkEndpoint>*)ep")
...
-(void)addDelegate:(NSObject<MutableValueDelegate>*)v {MSGSTART("Endpoint1:-(void)addDelegate:(NSObject<MutableValueDelegate>*)v")
...
-(constchar*)cdescription {MSGSTART("Endpoint1:-(constchar*)cdescription")
  return([self.description cStringUsingEncoding:NSASCIIStringEncoding]);}
-(constchar*)cobjectName {MSGSTART("Endpoint1:-(constchar*)cobjectName")
  return([self.objectName cStringUsingEncoding:NSASCIIStringEncoding]);}
-(void)dealloc {MSGSTART("Endpoint1:-(void)dealloc")
...
/*i999*/}
-(NSString*)description {MSGSTART("Endpoint1:-(NSString*)description")
  
  /*i-999*/NSMutableString *ret=self.objectName;
          
  /*i999*/return(ret);
    }
-(void)didSetValueTo:(id)object {MSGSTART("Endpoint1:-(void)didSetValueTo:(id)object")

          
  /*i100*/[valueDelegate didSetValueTo:object];
    }
-(void)die {MSGSTART("Endpoint1:-(void)die")
  
  /*i900*/}
-(NSObject<LinkEndpoint>*)endpointForObject:(id)obj {MSGSTART("Endpoint1:-(NSObject<LinkEndpoint>*)endpointForObject:(id)obj")

          if (obj) return((NSObject<LinkEndpoint>*)[self.owner performUnknownSelector:otherEndObjectToEndpoint withObject:obj]);
          else return(nil);
    }
+(Endpoint1*)endpointWithOwner:(id)aowner retains:(bool)aretains acceptableSel:(SEL)aacceptableSel otherEndObjectToEndpoint:(SEL)aotherEndObjectToEndpoint {MSGSTART("Endpoint1:+(Endpoint1*)endpointWithOwner:(id)aowner retains:(bool)aretains acceptableSel:(SEL)aacceptableSel otherEndObjectToEndpoint:(SEL)aotherEndObjectToEndpoint")
...
-(Endpoint1*)initWithOwner:(id)aowner retains:(bool)aretains acceptableSel:(SEL)aacceptableSel otherEndObjectToEndpoint:(SEL)aotherEndObjectToEndpoint {MSGSTART("Endpoint1:-(Endpoint1*)initWithOwner:(id)aowner retains:(bool)aretains acceptableSel:(SEL)aacceptableSel otherEndObjectToEndpoint:(SEL)aotherEndObjectToEndpoint")
...
/*i10001*/return(self);}
-(NSMutableString*)objectName {MSGSTART("Endpoint1:-(NSMutableString*)objectName")
...
-(id)owner {MSGSTART("Endpoint1:-(id)owner")
  
  /*i-999*/id ret=owner;
  /*i999*/return(ret);}
-(NSObject<MutableValueDelegate>*)parentValueDelegate {MSGSTART("Endpoint1:-(NSObject<MutableValueDelegate>*)parentValueDelegate")
  
  /*i-999*/NSObject<MutableValueDelegate>* ret=parentValueDelegate;
  /*i999*/return(ret);}
-(void)removedDelegate {MSGSTART("Endpoint1:-(void)removedDelegate")
}
-(void)removeDelegate:(NSObject<MutableValueDelegate>*)v {MSGSTART("Endpoint1:-(void)removeDelegate:(NSObject<MutableValueDelegate>*)v")
...
-(void)setParentValueDelegate:(NSObject<MutableValueDelegate>*)v {MSGSTART("Endpoint1:-(void)setParentValueDelegate:(NSObject<MutableValueDelegate>*)v")
  
  /*i-905*/if(parentValueDelegate==v)return;
  /*i-900*/{parentValueDelegate=(id)v;}}
-(void)setValue:(id)v {MSGSTART("Endpoint1:-(void)setValue:(id)v")
...
-(void)setValue_strong:(id)v {MSGSTART("Endpoint1:-(void)setValue_strong:(id)v")
...
-(void)setValueDelegate:(NSObject<MutableValueDelegate>*)v {MSGSTART("Endpoint1:-(void)setValueDelegate:(NSObject<MutableValueDelegate>*)v")
  
  /*i-905*/if(valueDelegate==v)return;
  /*i-900*/{valueDelegate=(id)v;}}
-(void)setValueDelegate_strong:(NSObject<MutableValueDelegate>*)v {MSGSTART("Endpoint1:-(void)setValueDelegate_strong:(NSObject<MutableValueDelegate>*)v")
  
  /*i-905*/if(valueDelegate_strong==v)return;
  /*i-900*/{valueDelegate_strong=(id)v;}}
-(bool)unacceptable:(id)obj {MSGSTART("Endpoint1:-(bool)unacceptable:(id)obj")
  return(!(acceptableSel&&[self.owner performUnknownSelector:acceptableSel withObject:obj]));}
-(void)unlinkValueDelegate {MSGSTART("Endpoint1:-(void)unlinkValueDelegate")
...
-(id)value {MSGSTART("Endpoint1:-(id)value")
  return(v_value);}
-(id)value_strong {MSGSTART("Endpoint1:-(id)value_strong")
  return(v_value);}
-(NSObject<MutableValueDelegate>*)valueDelegate {MSGSTART("Endpoint1:-(NSObject<MutableValueDelegate>*)valueDelegate")
  
  /*i-999*/NSObject<MutableValueDelegate>* ret=valueDelegate;
  /*i999*/return(ret);}
-(NSObject<MutableValueDelegate>*)valueDelegate_strong {MSGSTART("Endpoint1:-(NSObject<MutableValueDelegate>*)valueDelegate_strong")
  
  /*i-999*/NSObject<MutableValueDelegate>* ret=valueDelegate_strong;
  /*i999*/return(ret);}
-(void)willChangeValueFrom:(id)fromObject to:(id)toObject {MSGSTART("Endpoint1:-(void)willChangeValueFrom:(id)fromObject to:(id)toObject")
...
-(void)_startObjectOfClassEndpointA {MSGSTART("EndpointA:-(void)_startObjectOfClassEndpointA")
...
-(NSArray*)__array {MSGSTART("EndpointA:-(NSArray*)__array")
  
  /*i-999*/NSArray* ret=__array;
  /*i999*/return(ret);}
-(NSMutableDictionary*)__arrayObjectIndexes {MSGSTART("EndpointA:-(NSMutableDictionary*)__arrayObjectIndexes")
  
  /*i-999*/NSMutableDictionary* ret=__arrayObjectIndexes;
  /*i999*/return(ret);}
-(NSMutableArray*)__mutableArray {MSGSTART("EndpointA:-(NSMutableArray*)__mutableArray")
  
  /*i-999*/NSMutableArray* ret=__mutableArray;
  /*i999*/return(ret);}
-(bool)_addObjectsFromArray:(NSArray*)array {MSGSTART("EndpointA:-(bool)_addObjectsFromArray:(NSArray*)array")
...
-(bool)_addReferrer:(NSObject<LinkEndpoint>*)ep {MSGSTART("EndpointA:-(bool)_addReferrer:(NSObject<LinkEndpoint>*)ep")
...
-(bool)_insertObject:(id)object atIndex:(Unsigned)index {MSGSTART("EndpointA:-(bool)_insertObject:(id)object atIndex:(Unsigned)index")
...
-(bool)_insertObjects:(NSArray*)objects atIndexes:(NSIndexSet*)indexes {MSGSTART("EndpointA:-(bool)_insertObjects:(NSArray*)objects atIndexes:(NSIndexSet*)indexes")
...
-(bool)_removeAllObjects {MSGSTART("EndpointA:-(bool)_removeAllObjects")
...
-(bool)_removeObjectAtIndex:(Unsigned)index {MSGSTART("EndpointA:-(bool)_removeObjectAtIndex:(Unsigned)index")
...
-(bool)_removeObjectsAtIndexes:(NSIndexSet*)indexes {MSGSTART("EndpointA:-(bool)_removeObjectsAtIndexes:(NSIndexSet*)indexes")
...
-(void)_removeReferrer:(NSObject<LinkEndpoint>*)ep {MSGSTART("EndpointA:-(void)_removeReferrer:(NSObject<LinkEndpoint>*)ep")
...
-(bool)_replaceObjectAtIndex:(Unsigned)index withObject:(id)object {MSGSTART("EndpointA:-(bool)_replaceObjectAtIndex:(Unsigned)index withObject:(id)object")
...
-(void)addDelegate:(NSObject<MutableArrayDelegate>*)v {MSGSTART("EndpointA:-(void)addDelegate:(NSObject<MutableArrayDelegate>*)v")
...
-(void)addObject:(id)object {MSGSTART("EndpointA:-(void)addObject:(id)object")

          [self insertObject:object atIndex:__mutableArray.count];
    }
-(void)addObjectsFromArray:(NSArray*)array {MSGSTART("EndpointA:-(void)addObjectsFromArray:(NSArray*)array")

          if ([self _addObjectsFromArray:array]) [self stateOK];
    }
-(void)addObserver:(NSObject *)observer forKeyPath:(NSString *)keyPath options:(NSKeyValueObservingOptions)options context:(void *)context {MSGSTART("EndpointA:-(void)addObserver:(NSObject *)observer forKeyPath:(NSString *)keyPath options:(NSKeyValueObservingOptions)options context:(void *)context")

          [__array addObserver:observer forKeyPath:keyPath options:options context:context];
    }
-(void)addObserver:(NSObject *)observer toObjectsAtIndexes:(NSIndexSet*)indexes forKeyPath:(NSString *)keyPath options:(NSKeyValueObservingOptions)options context:(void *)context {MSGSTART("EndpointA:-(void)addObserver:(NSObject *)observer toObjectsAtIndexes:(NSIndexSet*)indexes forKeyPath:(NSString *)keyPath options:(NSKeyValueObservingOptions)options context:(void *)context")

          [__array addObserver:observer toObjectsAtIndexes:indexes forKeyPath:keyPath options:options context:context];
    }
-(void)allObjectsMoved {MSGSTART("EndpointA:-(void)allObjectsMoved")
...
+(EndpointA*)array {MSGSTART("EndpointA:+(EndpointA*)array")
  return([[EndpointA alloc] init]);}
-(NSArray*)arrayByAddingObject:(id)object {MSGSTART("EndpointA:-(NSArray*)arrayByAddingObject:(id)object")

          return([self.objects arrayByAddingObject:object]);
    }
-(NSArray*)arrayByAddingObjectsFromArray:(NSArray*)array {MSGSTART("EndpointA:-(NSArray*)arrayByAddingObjectsFromArray:(NSArray*)array")

          return([self.objects arrayByAddingObjectsFromArray:array]);
    }
-(NSObject<MutableArrayDelegate>*)arrayDelegate {MSGSTART("EndpointA:-(NSObject<MutableArrayDelegate>*)arrayDelegate")
  
  /*i-999*/NSObject<MutableArrayDelegate>* ret=arrayDelegate;
  /*i999*/return(ret);}
+(EndpointA*)arrayWithArray:(NSArray*)array {MSGSTART("EndpointA:+(EndpointA*)arrayWithArray:(NSArray*)array")
  return([[EndpointA alloc] initWithArray:array]);}
+(id)arrayWithCapacity:(Unsigned)numItems {MSGSTART("EndpointA:+(id)arrayWithCapacity:(Unsigned)numItems")

          return([[EndpointA alloc] initWithCapacity:numItems]);
    }
+(EndpointA*)arrayWithContentsOfFile:(NSString*)file {MSGSTART("EndpointA:+(EndpointA*)arrayWithContentsOfFile:(NSString*)file")
  return([[EndpointA alloc] initWithContentsOfFile:file]);}
+(EndpointA*)arrayWithContentsOfURL:(NSURL*)url {MSGSTART("EndpointA:+(EndpointA*)arrayWithContentsOfURL:(NSURL*)url")
  return([[EndpointA alloc] initWithContentsOfURL:url]);}
+(EndpointA*)arrayWithObject:(id)object {MSGSTART("EndpointA:+(EndpointA*)arrayWithObject:(id)object")
  return([[EndpointA alloc] initWithObjects:&object count:1]);}
+(EndpointA*)arrayWithObjects:(id*)objects count:(Unsigned)count {MSGSTART("EndpointA:+(EndpointA*)arrayWithObjects:(id*)objects count:(Unsigned)count")
  return([[EndpointA alloc] initWithObjects:objects count:count]);}
-(constchar*)cdescription {MSGSTART("EndpointA:-(constchar*)cdescription")
  return([self.description cStringUsingEncoding:NSASCIIStringEncoding]);}
-(constchar*)cobjectName {MSGSTART("EndpointA:-(constchar*)cobjectName")
  return([self.objectName cStringUsingEncoding:NSASCIIStringEncoding]);}
-(NSString *)componentsJoinedByString:(NSString *)separator {MSGSTART("EndpointA:-(NSString *)componentsJoinedByString:(NSString *)separator")

          return([__array componentsJoinedByString:separator]);
    }
-(BOOL)containsObject:(id)object {MSGSTART("EndpointA:-(BOOL)containsObject:(id)object")
  return([__array containsObject:object]);}
-(id)copyWithZone:(NSZone*)zone {MSGSTART("EndpointA:-(id)copyWithZone:(NSZone*)zone")

          return([[ImmutableArray allocWithZone:zone] initWithArray:__array]);
    }
-(Unsigned)count {MSGSTART("EndpointA:-(Unsigned)count")
  return([__array count]);}
-(Unsigned)countByEnumeratingWithState:(NSFastEnumerationState *)state objects:(__unsafe_unretained id*)stackbuf count:(Unsigned)len {MSGSTART("EndpointA:-(Unsigned)countByEnumeratingWithState:(NSFastEnumerationState *)state objects:(__unsafe_unretained id*)stackbuf count:(Unsigned)len")

          return([__array countByEnumeratingWithState:state objects:stackbuf count:len]);
    }
-(void)countWeakObjects {MSGSTART("EndpointA:-(void)countWeakObjects")

          Int c=0;
          for (NSObject *o in __array) if (o.isWeakSelf) c++;
          weakObjectCount=c;
    }
-(void)dealloc {MSGSTART("EndpointA:-(void)dealloc")
...
/*i999*/}
-(NSArray*)delegateForArray {MSGSTART("EndpointA:-(NSArray*)delegateForArray")
  
  /*i-999*/NSArray* ret=delegateForArray;
  /*i999*/return(ret);}
-(void)delegateForArrayChanged {MSGSTART("EndpointA:-(void)delegateForArrayChanged")
}
-(NSString*)description {MSGSTART("EndpointA:-(NSString*)description")
...
-(NSString *)descriptionWithLocale:(id)locale {MSGSTART("EndpointA:-(NSString *)descriptionWithLocale:(id)locale")

          return([self.objects descriptionWithLocale:locale]);
    }
-(NSString *)descriptionWithLocale:(id)locale indent:(Unsigned)level {MSGSTART("EndpointA:-(NSString *)descriptionWithLocale:(id)locale indent:(Unsigned)level")

          return([self.objects descriptionWithLocale:locale indent:level]);
    }
-(void)didAddObject:(id)object withIndex:(Unsigned)index {MSGSTART("EndpointA:-(void)didAddObject:(id)object withIndex:(Unsigned)index")
...
-(void)didRemoveObject:(id)object {MSGSTART("EndpointA:-(void)didRemoveObject:(id)object")

          
  /*i100*/[arrayDelegate didRemoveObject:object];
    }
-(void)die {MSGSTART("EndpointA:-(void)die")
  
  /*i900*/}
-(void)doAddIndex:(Unsigned)index forObject:(id)object {MSGSTART("EndpointA:-(void)doAddIndex:(Unsigned)index forObject:(id)object")
...
-(void)doChangeIndex:(Unsigned)fromIndex toIndex:(Unsigned)toIndex forObject:(id)object {MSGSTART("EndpointA:-(void)doChangeIndex:(Unsigned)fromIndex toIndex:(Unsigned)toIndex forObject:(id)object")
...
-(void)doRemoveIndex:(Unsigned)index forObject:(id)object {MSGSTART("EndpointA:-(void)doRemoveIndex:(Unsigned)index forObject:(id)object")
...
-(void)encodeWithCoder:(NSCoder*)coder {MSGSTART("EndpointA:-(void)encodeWithCoder:(NSCoder*)coder")

          [__array encodeWithCoder:coder];
    }
-(NSObject<LinkEndpoint>*)endpointForObject:(id)obj {MSGSTART("EndpointA:-(NSObject<LinkEndpoint>*)endpointForObject:(id)obj")

          if (obj) return((NSObject<LinkEndpoint>*)[self.owner performUnknownSelector:otherEndObjectToEndpoint withObject:obj]);
          else return(nil);
    }
+(EndpointA*)endpointWithOwner:(id)aowner retains:(bool)aretains acceptableSel:(SEL)aacceptableSel otherEndObjectToEndpoint:(SEL)aotherEndObjectToEndpoint {MSGSTART("EndpointA:+(EndpointA*)endpointWithOwner:(id)aowner retains:(bool)aretains acceptableSel:(SEL)aacceptableSel otherEndObjectToEndpoint:(SEL)aotherEndObjectToEndpoint")
...
-(void)enumerateObjectsAtIndexes:(NSIndexSet *)indexSet options:(NSEnumerationOptions)opts usingBlock:(void (^)(id obj, Unsigned idx, BOOL *stop))block {MSGSTART("EndpointA:-(void)enumerateObjectsAtIndexes:(NSIndexSet *)indexSet options:(NSEnumerationOptions)opts usingBlock:(void (^)(id obj, Unsigned idx, BOOL *stop))block")

          [__array enumerateObjectsAtIndexes:indexSet options:opts usingBlock:block];
    }
-(void)enumerateObjectsUsingBlock:(void (^)(id obj, Unsigned idx, BOOL *stop))block {MSGSTART("EndpointA:-(void)enumerateObjectsUsingBlock:(void (^)(id obj, Unsigned idx, BOOL *stop))block")

          [__array enumerateObjectsUsingBlock:block];
    }
-(void)enumerateObjectsWithOptions:(NSEnumerationOptions)opts usingBlock:(void (^)(id obj, Unsigned idx, BOOL *stop))block {MSGSTART("EndpointA:-(void)enumerateObjectsWithOptions:(NSEnumerationOptions)opts usingBlock:(void (^)(id obj, Unsigned idx, BOOL *stop))block")

          [__array enumerateObjectsWithOptions:opts usingBlock:block];
    }
-(NSMutableString*)errs {MSGSTART("EndpointA:-(NSMutableString*)errs")
  
  /*i-999*/NSMutableString* ret=v_errs;
  /*i999*/return(ret);}
-(void)exchangeObjectAtIndex:(Unsigned)fromi withObjectAtIndex:(Unsigned)toi {MSGSTART("EndpointA:-(void)exchangeObjectAtIndex:(Unsigned)fromi withObjectAtIndex:(Unsigned)toi")
...
-(NSArray*)filteredArrayUsingPredicate:(NSPredicate *)predicate {MSGSTART("EndpointA:-(NSArray*)filteredArrayUsingPredicate:(NSPredicate *)predicate")

          return([self.objects filteredArrayUsingPredicate:predicate]);
    }
-(void)filterUsingPredicate:(NSPredicate *)predicate {MSGSTART("EndpointA:-(void)filterUsingPredicate:(NSPredicate *)predicate")
...
-(id)firstObjectCommonWithArray:(NSArray*)array {MSGSTART("EndpointA:-(id)firstObjectCommonWithArray:(NSArray*)array")

          return([__array firstObjectCommonWithArray:array]);
    }
-(void)getObjects:(__unsafe_unretained id[])aBuffer range:(NSRange)aRange {MSGSTART("EndpointA:-(void)getObjects:(__unsafe_unretained id[])aBuffer range:(NSRange)aRange")
...
-(Unsigned)hash {MSGSTART("EndpointA:-(Unsigned)hash")
  return((Unsigned)obfuscateULL(objectIDInTotal));}
-(NSIndexSet*)indexesOfObjectsAtIndexes:(NSIndexSet *)indexSet options:(NSEnumerationOptions)opts passingTest:(BOOL (^)(id obj, Unsigned idx, BOOL *stop))predicate {MSGSTART("EndpointA:-(NSIndexSet*)indexesOfObjectsAtIndexes:(NSIndexSet *)indexSet options:(NSEnumerationOptions)opts passingTest:(BOOL (^)(id obj, Unsigned idx, BOOL *stop))predicate")

          return([__array indexesOfObjectsAtIndexes:indexSet options:opts passingTest:predicate]);
    }
-(NSIndexSet*)indexesOfObjectsPassingTest:(BOOL (^)(id obj, Unsigned idx, BOOL *stop))predicate {MSGSTART("EndpointA:-(NSIndexSet*)indexesOfObjectsPassingTest:(BOOL (^)(id obj, Unsigned idx, BOOL *stop))predicate")

          return([__array indexesOfObjectsPassingTest:predicate]);
    }
-(NSIndexSet*)indexesOfObjectsWithOptions:(NSEnumerationOptions)opts passingTest:(BOOL (^)(id obj, Unsigned idx, BOOL *stop))predicate {MSGSTART("EndpointA:-(NSIndexSet*)indexesOfObjectsWithOptions:(NSEnumerationOptions)opts passingTest:(BOOL (^)(id obj, Unsigned idx, BOOL *stop))predicate")

          return([__array indexesOfObjectsWithOptions:opts passingTest:predicate]);
    }
-(Unsigned)indexOfObject:(id)obj inSortedRange:(NSRange)r options:(NSBinarySearchingOptions)opts usingComparator:(NSComparator)cmp {MSGSTART("EndpointA:-(Unsigned)indexOfObject:(id)obj inSortedRange:(NSRange)r options:(NSBinarySearchingOptions)opts usingComparator:(NSComparator)cmp")

          return([__array indexOfObject:obj inSortedRange:r options:opts usingComparator:cmp]);
    }
-(Unsigned)indexOfObject:(id)object {MSGSTART("EndpointA:-(Unsigned)indexOfObject:(id)object")

          return([__array indexOfObject:object]);
    }
-(Unsigned)indexOfObject:(id)object inRange:(NSRange)range {MSGSTART("EndpointA:-(Unsigned)indexOfObject:(id)object inRange:(NSRange)range")

          return([__array indexOfObject:object inRange:range]);
    }
-(Unsigned)indexOfObjectAtIndexes:(NSIndexSet *)indexSet options:(NSEnumerationOptions)opts passingTest:(BOOL (^)(id obj, Unsigned idx, BOOL *stop))predicate {MSGSTART("EndpointA:-(Unsigned)indexOfObjectAtIndexes:(NSIndexSet *)indexSet options:(NSEnumerationOptions)opts passingTest:(BOOL (^)(id obj, Unsigned idx, BOOL *stop))predicate")

          return([__array indexOfObjectAtIndexes:indexSet options:opts passingTest:predicate]);
    }
-(Unsigned)indexOfObjectIdenticalTo:(id)object {MSGSTART("EndpointA:-(Unsigned)indexOfObjectIdenticalTo:(id)object")
...
-(Unsigned)indexOfObjectIdenticalTo:(id)object inRange:(NSRange)range {MSGSTART("EndpointA:-(Unsigned)indexOfObjectIdenticalTo:(id)object inRange:(NSRange)range")
...
-(Unsigned)indexOfObjectPassingTest:(BOOL (^)(id obj, Unsigned idx, BOOL *stop))predicate {MSGSTART("EndpointA:-(Unsigned)indexOfObjectPassingTest:(BOOL (^)(id obj, Unsigned idx, BOOL *stop))predicate")

          return([__array indexOfObjectPassingTest:predicate]);
    }
-(Unsigned)indexOfObjectWithOptions:(NSEnumerationOptions)opts passingTest:(BOOL (^)(id obj, Unsigned idx, BOOL *stop))predicate {MSGSTART("EndpointA:-(Unsigned)indexOfObjectWithOptions:(NSEnumerationOptions)opts passingTest:(BOOL (^)(id obj, Unsigned idx, BOOL *stop))predicate")

          return([__array indexOfObjectWithOptions:opts passingTest:predicate]);
    }
-(EndpointA*)init {MSGSTART("EndpointA:-(EndpointA*)init")
...
/*i10001*/return(self);}
-(EndpointA*)initWithArray:(NSArray*)array {MSGSTART("EndpointA:-(EndpointA*)initWithArray:(NSArray*)array")
...
/*i10001*/return(self);}
-(EndpointA*)initWithArray:(NSArray*)array copyItems:(BOOL)copy {MSGSTART("EndpointA:-(EndpointA*)initWithArray:(NSArray*)array copyItems:(BOOL)copy")
...
/*i10001*/return(self);}
-(EndpointA*)initWithCapacity:(Unsigned)numItems {MSGSTART("EndpointA:-(EndpointA*)initWithCapacity:(Unsigned)numItems")
...
/*i10001*/return(self);}
-(EndpointA*)initWithCoder:(NSCoder*)coder {MSGSTART("EndpointA:-(EndpointA*)initWithCoder:(NSCoder*)coder")
...
/*i10001*/return(self);}
-(EndpointA*)initWithContentsOfFile:(NSString*)file {MSGSTART("EndpointA:-(EndpointA*)initWithContentsOfFile:(NSString*)file")
...
/*i10001*/return(self);}
-(EndpointA*)initWithContentsOfURL:(NSURL*)url {MSGSTART("EndpointA:-(EndpointA*)initWithContentsOfURL:(NSURL*)url")
...
/*i10001*/return(self);}
-(EndpointA*)initWithObjects:(id*)objects count:(Unsigned)count {MSGSTART("EndpointA:-(EndpointA*)initWithObjects:(id*)objects count:(Unsigned)count")
...
/*i10001*/return(self);}
-(EndpointA*)initWithOwner:(id)aowner retains:(bool)aretains acceptableSel:(SEL)aacceptableSel otherEndObjectToEndpoint:(SEL)aotherEndObjectToEndpoint {MSGSTART("EndpointA:-(EndpointA*)initWithOwner:(id)aowner retains:(bool)aretains acceptableSel:(SEL)aacceptableSel otherEndObjectToEndpoint:(SEL)aotherEndObjectToEndpoint")
...
/*i10001*/return(self);}
-(void)insertObject:(id)object atIndex:(Unsigned)index {MSGSTART("EndpointA:-(void)insertObject:(id)object atIndex:(Unsigned)index")

          if ([self _insertObject:object atIndex:index]) [self stateOK];
    }
-(void)insertObjects:(NSArray*)objects atIndexes:(NSIndexSet*)indexes {MSGSTART("EndpointA:-(void)insertObjects:(NSArray*)objects atIndexes:(NSIndexSet*)indexes")

          if ([self _insertObjects:objects atIndexes:indexes]) [self stateOK];
    }
-(BOOL)isEqual:(id)obj {MSGSTART("EndpointA:-(BOOL)isEqual:(id)obj")
...
-(BOOL)isEqualToArray:(NSArray*)array {MSGSTART("EndpointA:-(BOOL)isEqualToArray:(NSArray*)array")

          return([__array isEqualToArray:array]);
    }
-(id)lastObject {MSGSTART("EndpointA:-(id)lastObject")
  return(weakObjectCount?[__array.lastObject strongSelf]:__array.lastObject);}
-(void)makeObjectsPerformSelector:(SEL)selector {MSGSTART("EndpointA:-(void)makeObjectsPerformSelector:(SEL)selector")

          [__array makeObjectsPerformSelector:selector];
    }
-(void)makeObjectsPerformSelector:(SEL)selector withObject:(id)object {MSGSTART("EndpointA:-(void)makeObjectsPerformSelector:(SEL)selector withObject:(id)object")

          [__array makeObjectsPerformSelector:selector withObject:object];
    }
-(id)mutableCopyWithZone:(NSZone*)zone {MSGSTART("EndpointA:-(id)mutableCopyWithZone:(NSZone*)zone")

          return([[MutableArray allocWithZone:zone] initWithArray:__array]);
    }
-(id)objectAtIndex:(Unsigned)index {MSGSTART("EndpointA:-(id)objectAtIndex:(Unsigned)index")
...
-(NSEnumerator*)objectEnumerator {MSGSTART("EndpointA:-(NSEnumerator*)objectEnumerator")
  return([__array objectEnumerator]);}
-(NSMutableString*)objectName {MSGSTART("EndpointA:-(NSMutableString*)objectName")
...
-(NSArray*)objects {MSGSTART("EndpointA:-(NSArray*)objects")
...
-(NSArray*)objectsAtIndexes:(NSIndexSet*)indexes {MSGSTART("EndpointA:-(NSArray*)objectsAtIndexes:(NSIndexSet*)indexes")
...
-(void)objectsMovedFromRange:(NSRange)fromRange toLocation:(Unsigned)toLocation {MSGSTART("EndpointA:-(void)objectsMovedFromRange:(NSRange)fromRange toLocation:(Unsigned)toLocation")
...
-(void)objectsSwappedWithIndex:(Unsigned)fromIndex andIndex:(Unsigned)toIndex {MSGSTART("EndpointA:-(void)objectsSwappedWithIndex:(Unsigned)fromIndex andIndex:(Unsigned)toIndex")
...
-(id)owner {MSGSTART("EndpointA:-(id)owner")
  
  /*i-999*/id ret=owner;
  /*i999*/return(ret);}
-(bool)passFail:(bool)pass format:(NSString*)format,... {MSGSTART("EndpointA:-(bool)passFail:(bool)pass format:(NSString*)format,...")
...
-(NSArray *)pathsMatchingExtensions:(NSArray *)filterTypes {MSGSTART("EndpointA:-(NSArray *)pathsMatchingExtensions:(NSArray *)filterTypes")

          return([self.objects pathsMatchingExtensions:filterTypes]);
    }
-(void)removeAllObjects {MSGSTART("EndpointA:-(void)removeAllObjects")

          if ([self _removeAllObjects]) [self stateOK];
    }
-(void)removedDelegate {MSGSTART("EndpointA:-(void)removedDelegate")
  
  /*i-100*/arrayDelegate=nil;}
-(void)removeDelegate:(NSObject<MutableArrayDelegate>*)v {MSGSTART("EndpointA:-(void)removeDelegate:(NSObject<MutableArrayDelegate>*)v")
...
-(void)removeLastObject {MSGSTART("EndpointA:-(void)removeLastObject")

          if (__array.count) [self removeObjectAtIndex:__array.count-1];
    }
-(void)removeObjectAtIndex:(Unsigned)index {MSGSTART("EndpointA:-(void)removeObjectAtIndex:(Unsigned)index")

          if ([self _removeObjectAtIndex:index]) [self stateOK];
    }
-(void)removeObjectsAtIndexes:(NSIndexSet*)indexes {MSGSTART("EndpointA:-(void)removeObjectsAtIndexes:(NSIndexSet*)indexes")

          if ([self _removeObjectsAtIndexes:indexes]) [self stateOK];
    }
-(void)removeObserver:(NSObject *)observer forKeyPath:(NSString *)keyPath {MSGSTART("EndpointA:-(void)removeObserver:(NSObject *)observer forKeyPath:(NSString *)keyPath")

          [__array removeObserver:observer forKeyPath:keyPath];
    }
-(void)removeObserver:(NSObject *)observer forKeyPath:(NSString *)keyPath context:(void *)context {MSGSTART("EndpointA:-(void)removeObserver:(NSObject *)observer forKeyPath:(NSString *)keyPath context:(void *)context")

          [__array removeObserver:observer forKeyPath:keyPath context:context];
    }
-(void)removeObserver:(NSObject *)observer fromObjectsAtIndexes:(NSIndexSet*)indexes forKeyPath:(NSString *)keyPath {MSGSTART("EndpointA:-(void)removeObserver:(NSObject *)observer fromObjectsAtIndexes:(NSIndexSet*)indexes forKeyPath:(NSString *)keyPath")

          [__array removeObserver:observer fromObjectsAtIndexes:indexes forKeyPath:keyPath];
    }
-(void)removeObserver:(NSObject *)observer fromObjectsAtIndexes:(NSIndexSet*)indexes forKeyPath:(NSString *)keyPath context:(void *)context {MSGSTART("EndpointA:-(void)removeObserver:(NSObject *)observer fromObjectsAtIndexes:(NSIndexSet*)indexes forKeyPath:(NSString *)keyPath context:(void *)context")

          [__array removeObserver:observer fromObjectsAtIndexes:indexes forKeyPath:keyPath context:context];
    }
-(void)replaceObjectAtIndex:(Unsigned)index withObject:(id)object {MSGSTART("EndpointA:-(void)replaceObjectAtIndex:(Unsigned)index withObject:(id)object")

          if ([self _replaceObjectAtIndex:index withObject:object]) [self stateOK];
    }
-(NSEnumerator*)reverseObjectEnumerator {MSGSTART("EndpointA:-(NSEnumerator*)reverseObjectEnumerator")
  return([__array reverseObjectEnumerator]);}
-(void)set__arrayObjectIndexes:(NSMutableDictionary*)v {MSGSTART("EndpointA:-(void)set__arrayObjectIndexes:(NSMutableDictionary*)v")
  
  /*i-905*/if(__arrayObjectIndexes==v)return;
  /*i-900*/{__arrayObjectIndexes=(id)v;}}
-(void)setArray:(NSArray*)array {MSGSTART("EndpointA:-(void)setArray:(NSArray*)array")
...
-(void)setDelegateForArray:(NSArray*)v {MSGSTART("EndpointA:-(void)setDelegateForArray:(NSArray*)v")
  
  /*i-905*/if(delegateForArray==v)return;
  /*i-900*/{delegateForArray=(id)v;}}
-(void)setErrs:(NSMutableString*)v {MSGSTART("EndpointA:-(void)setErrs:(NSMutableString*)v")
  
  /*i-905*/if(v_errs==v)return;
  /*i-900*/{v_errs=(id)v;}}
-(void)setValue:(id)value forKey:(NSString *)key {MSGSTART("EndpointA:-(void)setValue:(id)value forKey:(NSString *)key")

          [__array setValue:value forKey:key];
    }
-(void)setWeakness:(CollectionWeakness)v {MSGSTART("EndpointA:-(void)setWeakness:(CollectionWeakness)v")
...
#ifndef __SWIFT__
-(bool)shouldAddObject:(id)object makeWeak:(bool&)weak {MSGSTART("EndpointA:-(bool)shouldAddObject:(id)object makeWeak:(bool&)weak")
...
#endif// __SWIFT__
-(NSData*)sortedArrayHint {MSGSTART("EndpointA:-(NSData*)sortedArrayHint")

          return([__array sortedArrayHint]);
    }
-(NSArray *)sortedArrayUsingComparator:(NSComparator)cmptr {MSGSTART("EndpointA:-(NSArray *)sortedArrayUsingComparator:(NSComparator)cmptr")

          return([self.objects sortedArrayUsingComparator:cmptr]);
    }
-(NSArray *)sortedArrayUsingDescriptors:(NSArray *)sortDescriptors {MSGSTART("EndpointA:-(NSArray *)sortedArrayUsingDescriptors:(NSArray *)sortDescriptors")

          return([self.objects sortedArrayUsingDescriptors:sortDescriptors]);
    }
-(NSArray *)sortedArrayUsingFunction:(Int (*)(id, id, void *))comparator context:(void *)context {MSGSTART("EndpointA:-(NSArray *)sortedArrayUsingFunction:(Int (*)(id, id, void *))comparator context:(void *)context")

          return([self.objects sortedArrayUsingFunction:comparator context:context]);
    }
-(NSArray *)sortedArrayUsingFunction:(Int (*)(id, id, void *))comparator context:(void *)context hint:(NSData *)hint {MSGSTART("EndpointA:-(NSArray *)sortedArrayUsingFunction:(Int (*)(id, id, void *))comparator context:(void *)context hint:(NSData *)hint")

          return([self.objects sortedArrayUsingFunction:comparator context:context hint:hint]);
    }
-(NSArray*)sortedArrayUsingSelector:(SEL)selector {MSGSTART("EndpointA:-(NSArray*)sortedArrayUsingSelector:(SEL)selector")

          return([self.objects sortedArrayUsingSelector:selector]);
    }
-(NSArray *)sortedArrayWithOptions:(NSSortOptions)opts usingComparator:(NSComparator)cmptr {MSGSTART("EndpointA:-(NSArray *)sortedArrayWithOptions:(NSSortOptions)opts usingComparator:(NSComparator)cmptr")

          return([self.objects sortedArrayWithOptions:opts usingComparator:cmptr]);
    }
-(void)sortUsingComparator:(NSComparator)cmptr {MSGSTART("EndpointA:-(void)sortUsingComparator:(NSComparator)cmptr")

          [__mutableArray sortUsingComparator:cmptr];
          [self allObjectsMoved];
          [self stateOK];
    }
-(void)sortUsingDescriptors:(NSArray*)sortDescriptors {MSGSTART("EndpointA:-(void)sortUsingDescriptors:(NSArray*)sortDescriptors")

          [__mutableArray sortUsingDescriptors:sortDescriptors];
          [self allObjectsMoved];
          [self stateOK];
    }
-(void)sortUsingFunction:(Int (*)(id, id, void *))compare context:(void *)context {MSGSTART("EndpointA:-(void)sortUsingFunction:(Int (*)(id, id, void *))compare context:(void *)context")

          [__mutableArray sortUsingFunction:compare context:context];
          [self allObjectsMoved];
          [self stateOK];
    }
-(void)sortUsingSelector:(SEL)selector {MSGSTART("EndpointA:-(void)sortUsingSelector:(SEL)selector")

          [__mutableArray sortUsingSelector:selector];
          [self allObjectsMoved];
          [self stateOK];
    }
-(void)sortWithOptions:(NSSortOptions)opts usingComparator:(NSComparator)cmptr {MSGSTART("EndpointA:-(void)sortWithOptions:(NSSortOptions)opts usingComparator:(NSComparator)cmptr")

          [__mutableArray sortWithOptions:opts usingComparator:cmptr];
          [self allObjectsMoved];
          [self stateOK];
    }
-(void)stateOK {MSGSTART("EndpointA:-(void)stateOK")
...
-(NSArray*)subarrayWithRange:(NSRange)r {MSGSTART("EndpointA:-(NSArray*)subarrayWithRange:(NSRange)r")

          return([self.objects subarrayWithRange:r]);
    }
-(bool)unacceptable:(id)obj {MSGSTART("EndpointA:-(bool)unacceptable:(id)obj")
  return(!(acceptableSel&&[self.owner performUnknownSelector:acceptableSel withObject:obj]));}
-(id)valueForKey:(NSString*)key {MSGSTART("EndpointA:-(id)valueForKey:(NSString*)key")

          return([__array valueForKey:key]);
    }
-(CollectionWeakness)weakness {MSGSTART("EndpointA:-(CollectionWeakness)weakness")
...
-(void)willAddObject:(id)object withIndex:(Unsigned)index {MSGSTART("EndpointA:-(void)willAddObject:(id)object withIndex:(Unsigned)index")

          
  /*i100*/[arrayDelegate willAddObject:object withIndex:index];
    }
-(void)willRemoveObject:(id)object fromIndex:(Unsigned)index {MSGSTART("EndpointA:-(void)willRemoveObject:(id)object fromIndex:(Unsigned)index")
...
-(void)willRemoveObjectsWithCount:(Unsigned)count {MSGSTART("EndpointA:-(void)willRemoveObjectsWithCount:(Unsigned)count")

          
  /*i100*/[arrayDelegate willRemoveObjectsWithCount:count];
    }
-(void)willTryToAddObjectsWithCount:(Unsigned)count {MSGSTART("EndpointA:-(void)willTryToAddObjectsWithCount:(Unsigned)count")

          
  /*i100*/[arrayDelegate willTryToAddObjectsWithCount:count];
    }
-(void)wontAddObject:(id)object withIndex:(Unsigned)index {MSGSTART("EndpointA:-(void)wontAddObject:(id)object withIndex:(Unsigned)index")

          
  /*i100*/[arrayDelegate wontAddObject:object withIndex:index];
    }
-(BOOL)writeToFile:(NSString *)path atomically:(BOOL)flag {MSGSTART("EndpointA:-(BOOL)writeToFile:(NSString *)path atomically:(BOOL)flag")

          return([self.objects writeToFile:path atomically:flag]);
    }
-(BOOL)writeToURL:(NSURL *)url atomically:(BOOL)flag {MSGSTART("EndpointA:-(BOOL)writeToURL:(NSURL *)url atomically:(BOOL)flag")
...
@synthesize version=version;
@synthesize weakObjectCount=weakObjectCount;
-(void)_startObjectOfClassEndpointD {MSGSTART("EndpointD:-(void)_startObjectOfClassEndpointD")
...
-(NSDictionary*)__dictionary {MSGSTART("EndpointD:-(NSDictionary*)__dictionary")
  
  /*i-999*/NSDictionary* ret=__dictionary;
  /*i999*/return(ret);}
-(NSMutableDictionary*)__dictionaryObjectKeys {MSGSTART("EndpointD:-(NSMutableDictionary*)__dictionaryObjectKeys")
  
  /*i-999*/NSMutableDictionary* ret=__dictionaryObjectKeys;
  /*i999*/return(ret);}
-(NSMutableDictionary*)__mutableDictionary {MSGSTART("EndpointD:-(NSMutableDictionary*)__mutableDictionary")
  
  /*i-999*/NSMutableDictionary* ret=__mutableDictionary;
  /*i999*/return(ret);}
-(bool)_addEntriesFromDictionary:(NSDictionary*)dictionary {MSGSTART("EndpointD:-(bool)_addEntriesFromDictionary:(NSDictionary*)dictionary")
...
-(bool)_addReferrer:(NSObject<LinkEndpoint>*)ep {MSGSTART("EndpointD:-(bool)_addReferrer:(NSObject<LinkEndpoint>*)ep")
...
-(bool)_removeAllObjects {MSGSTART("EndpointD:-(bool)_removeAllObjects")
...
-(bool)_removeObjectForKey:(id<NSCopying>)key {MSGSTART("EndpointD:-(bool)_removeObjectForKey:(id<NSCopying>)key")
...
-(bool)_removeObjectsForKeys:(NSArray*)keys {MSGSTART("EndpointD:-(bool)_removeObjectsForKeys:(NSArray*)keys")
...
-(void)_removeReferrer:(NSObject<LinkEndpoint>*)ep {MSGSTART("EndpointD:-(void)_removeReferrer:(NSObject<LinkEndpoint>*)ep")
...
-(bool)_setDictionary:(NSDictionary*)dictionary {MSGSTART("EndpointD:-(bool)_setDictionary:(NSDictionary*)dictionary")
...
-(bool)_setObject:(id)object forKey:(id<NSCopying>)key {MSGSTART("EndpointD:-(bool)_setObject:(id)object forKey:(id<NSCopying>)key")
...
-(bool)_setValue:(id)object forKey:(NSString*)key {MSGSTART("EndpointD:-(bool)_setValue:(id)object forKey:(NSString*)key")
...
-(void)addDelegate:(NSObject<MutableDictionaryDelegate>*)v {MSGSTART("EndpointD:-(void)addDelegate:(NSObject<MutableDictionaryDelegate>*)v")
...
-(void)addEntriesFromDictionary:(NSDictionary*)dictionary {MSGSTART("EndpointD:-(void)addEntriesFromDictionary:(NSDictionary*)dictionary")

          if ([self _addEntriesFromDictionary:dictionary]) [self stateOK];
    }
-(NSArray*)allKeys {MSGSTART("EndpointD:-(NSArray*)allKeys")
  return([__dictionary allKeys]);}
-(NSArray*)allKeysForObject:(id)object {MSGSTART("EndpointD:-(NSArray*)allKeysForObject:(id)object")
  return([__dictionary allKeysForObject:object]);}
-(NSArray*)allValues {MSGSTART("EndpointD:-(NSArray*)allValues")
  return([__dictionary allValues]);}
-(constchar*)cdescription {MSGSTART("EndpointD:-(constchar*)cdescription")
  return([self.description cStringUsingEncoding:NSASCIIStringEncoding]);}
-(constchar*)cobjectName {MSGSTART("EndpointD:-(constchar*)cobjectName")
  return([self.objectName cStringUsingEncoding:NSASCIIStringEncoding]);}
-(id)copyWithZone:(NSZone*)zone {MSGSTART("EndpointD:-(id)copyWithZone:(NSZone*)zone")

          return([[ImmutableDictionary allocWithZone:zone] initWithDictionary:__dictionary]);
    }
-(Unsigned)count {MSGSTART("EndpointD:-(Unsigned)count")
  return([__dictionary count]);}
-(Unsigned)countByEnumeratingWithState:(NSFastEnumerationState *)state objects:(__unsafe_unretained id*)stackbuf count:(Unsigned)len {MSGSTART("EndpointD:-(Unsigned)countByEnumeratingWithState:(NSFastEnumerationState *)state objects:(__unsafe_unretained id*)stackbuf count:(Unsigned)len")

          Unsigned ret=[__dictionary countByEnumeratingWithState:state objects:stackbuf count:len];
          return(ret);
    }
-(void)countWeakObjects {MSGSTART("EndpointD:-(void)countWeakObjects")

          Int c=0;
          for (kid o in __dictionary) if ([[__dictionary objectForKey:o] isWeakSelf]) c++;
          weakObjectCount=c;
    }
-(void)dealloc {MSGSTART("EndpointD:-(void)dealloc")
...
/*i999*/}
-(NSDictionary*)delegateForDictionary {MSGSTART("EndpointD:-(NSDictionary*)delegateForDictionary")
  
  /*i-999*/NSDictionary* ret=delegateForDictionary;
  /*i999*/return(ret);}
-(void)delegateForDictionaryChanged {MSGSTART("EndpointD:-(void)delegateForDictionaryChanged")
}
-(NSString*)description {MSGSTART("EndpointD:-(NSString*)description")
...
-(NSString*)descriptionInStringsFileFormat {MSGSTART("EndpointD:-(NSString*)descriptionInStringsFileFormat")
  return([__dictionary descriptionInStringsFileFormat]);}
-(NSString *)descriptionWithLocale:(id)locale {MSGSTART("EndpointD:-(NSString *)descriptionWithLocale:(id)locale")

          return([__dictionary descriptionWithLocale:locale]);
    }
-(NSString *)descriptionWithLocale:(id)locale indent:(Unsigned)level {MSGSTART("EndpointD:-(NSString *)descriptionWithLocale:(id)locale indent:(Unsigned)level")

          return([__dictionary descriptionWithLocale:locale indent:level]);
    }
+(EndpointD*)dictionary {MSGSTART("EndpointD:+(EndpointD*)dictionary")
  return([[EndpointD alloc] init]);}
-(NSObject<MutableDictionaryDelegate>*)dictionaryDelegate {MSGSTART("EndpointD:-(NSObject<MutableDictionaryDelegate>*)dictionaryDelegate")
  
  /*i-999*/NSObject<MutableDictionaryDelegate>* ret=dictionaryDelegate;
  /*i999*/return(ret);}
+(id)dictionaryWithCapacity:(Unsigned)numItems {MSGSTART("EndpointD:+(id)dictionaryWithCapacity:(Unsigned)numItems")

          return([[EndpointD alloc] initWithCapacity:numItems]);
    }
+(EndpointD*)dictionaryWithContentsOfFile:(NSString*)file {MSGSTART("EndpointD:+(EndpointD*)dictionaryWithContentsOfFile:(NSString*)file")
  return([[EndpointD alloc] initWithContentsOfFile:file]);}
+(EndpointD*)dictionaryWithContentsOfURL:(NSURL*)url {MSGSTART("EndpointD:+(EndpointD*)dictionaryWithContentsOfURL:(NSURL*)url")
  return([[EndpointD alloc] initWithContentsOfURL:url]);}
+(EndpointD*)dictionaryWithDictionary:(NSDictionary*)dictionary {MSGSTART("EndpointD:+(EndpointD*)dictionaryWithDictionary:(NSDictionary*)dictionary")
  return([[EndpointD alloc] initWithDictionary:dictionary]);}
+(EndpointD*)dictionaryWithObject:(id)object forKey:(id<NSCopying>)key {MSGSTART("EndpointD:+(EndpointD*)dictionaryWithObject:(id)object forKey:(id<NSCopying>)key")
  return([[EndpointD alloc] initWithObjects:&object forKeys:&key count:1]);}
+(EndpointD*)dictionaryWithObjects:(__unsafe_unretained id[])objects forKeys:(__strong id<NSCopying>[])keys count:(Unsigned)count {MSGSTART("EndpointD:+(EndpointD*)dictionaryWithObjects:(__unsafe_unretained id[])objects forKeys:(__strong id<NSCopying>[])keys count:(Unsigned)count")
  return([[EndpointD alloc] initWithObjects:objects forKeys:keys count:/*ivar*/count]);}
-(void)didReplaceObject:(id)fromObject withObject:(id)toObject forKey:(id<NSCopying>)key {MSGSTART("EndpointD:-(void)didReplaceObject:(id)fromObject withObject:(id)toObject forKey:(id<NSCopying>)key")
...
-(void)die {MSGSTART("EndpointD:-(void)die")
  
  /*i900*/}
-(void)encodeWithCoder:(NSCoder*)coder {MSGSTART("EndpointD:-(void)encodeWithCoder:(NSCoder*)coder")

          [__dictionary encodeWithCoder:coder];
    }
-(NSObject<LinkEndpoint>*)endpointForObject:(id)obj {MSGSTART("EndpointD:-(NSObject<LinkEndpoint>*)endpointForObject:(id)obj")

          if (obj) return((NSObject<LinkEndpoint>*)[self.owner performUnknownSelector:otherEndObjectToEndpoint withObject:obj]);
          else return(nil);
    }
+(EndpointD*)endpointWithOwner:(id)aowner retains:(bool)aretains acceptableSel:(SEL)aacceptableSel otherEndObjectToEndpoint:(SEL)aotherEndObjectToEndpoint {MSGSTART("EndpointD:+(EndpointD*)endpointWithOwner:(id)aowner retains:(bool)aretains acceptableSel:(SEL)aacceptableSel otherEndObjectToEndpoint:(SEL)aotherEndObjectToEndpoint")
...
-(void)enumerateKeysAndObjectsUsingBlock:(void (^)(id key, id obj, BOOL *stop))block {MSGSTART("EndpointD:-(void)enumerateKeysAndObjectsUsingBlock:(void (^)(id key, id obj, BOOL *stop))block")

          [__dictionary enumerateKeysAndObjectsUsingBlock:block];
    }
-(void)enumerateKeysAndObjectsWithOptions:(NSEnumerationOptions)opts usingBlock:(void (^)(id key, id obj, BOOL *stop))block {MSGSTART("EndpointD:-(void)enumerateKeysAndObjectsWithOptions:(NSEnumerationOptions)opts usingBlock:(void (^)(id key, id obj, BOOL *stop))block")

          [__dictionary enumerateKeysAndObjectsWithOptions:opts usingBlock:block];
    }
-(NSMutableString*)errs {MSGSTART("EndpointD:-(NSMutableString*)errs")
  
  /*i-999*/NSMutableString* ret=v_errs;
  /*i999*/return(ret);}
-(NSDate*)fileCreationDate {MSGSTART("EndpointD:-(NSDate*)fileCreationDate")
  return([__dictionary fileCreationDate]);}
-(BOOL)fileExtensionHidden {MSGSTART("EndpointD:-(BOOL)fileExtensionHidden")
  return([__dictionary fileExtensionHidden]);}
-(NSNumber*)fileGroupOwnerAccountID {MSGSTART("EndpointD:-(NSNumber*)fileGroupOwnerAccountID")
  return([__dictionary fileGroupOwnerAccountID]);}
-(NSString*)fileGroupOwnerAccountName {MSGSTART("EndpointD:-(NSString*)fileGroupOwnerAccountName")
  return([__dictionary fileGroupOwnerAccountName]);}
-(OSType)fileHFSCreatorCode {MSGSTART("EndpointD:-(OSType)fileHFSCreatorCode")
  return([__dictionary fileHFSCreatorCode]);}
-(OSType)fileHFSTypeCode {MSGSTART("EndpointD:-(OSType)fileHFSTypeCode")
  return([__dictionary fileHFSTypeCode]);}
-(BOOL)fileIsAppendOnly {MSGSTART("EndpointD:-(BOOL)fileIsAppendOnly")
  return([__dictionary fileIsAppendOnly]);}
-(BOOL)fileIsImmutable {MSGSTART("EndpointD:-(BOOL)fileIsImmutable")
  return([__dictionary fileIsImmutable]);}
-(NSDate*)fileModificationDate {MSGSTART("EndpointD:-(NSDate*)fileModificationDate")
  return([__dictionary fileModificationDate]);}
-(NSNumber*)fileOwnerAccountID {MSGSTART("EndpointD:-(NSNumber*)fileOwnerAccountID")
  return([__dictionary fileOwnerAccountID]);}
-(NSString*)fileOwnerAccountName {MSGSTART("EndpointD:-(NSString*)fileOwnerAccountName")
  return([__dictionary fileOwnerAccountName]);}
-(Unsigned)filePosixPermissions {MSGSTART("EndpointD:-(Unsigned)filePosixPermissions")
  return([__dictionary filePosixPermissions]);}
-(ULL)fileSize {MSGSTART("EndpointD:-(ULL)fileSize")
  return([__dictionary fileSize]);}
-(Unsigned)fileSystemFileNumber {MSGSTART("EndpointD:-(Unsigned)fileSystemFileNumber")
  return([__dictionary fileSystemFileNumber]);}
-(Int)fileSystemNumber {MSGSTART("EndpointD:-(Int)fileSystemNumber")
  return([__dictionary fileSystemNumber]);}
-(NSString*)fileType {MSGSTART("EndpointD:-(NSString*)fileType")
  return([__dictionary fileType]);}
-(void)getObjects:(id __unsafe_unretained [])objects andKeys:(id __unsafe_unretained [])keys {MSGSTART("EndpointD:-(void)getObjects:(id __unsafe_unretained [])objects andKeys:(id __unsafe_unretained [])keys")

          [__dictionary getObjects:objects andKeys:keys];
    }
-(Unsigned)hash {MSGSTART("EndpointD:-(Unsigned)hash")
  return((Unsigned)obfuscateULL(objectIDInTotal));}
-(EndpointD*)init {MSGSTART("EndpointD:-(EndpointD*)init")
...
/*i10001*/return(self);}
-(EndpointD*)initWithCapacity:(Unsigned)numItems {MSGSTART("EndpointD:-(EndpointD*)initWithCapacity:(Unsigned)numItems")
...
/*i10001*/return(self);}
-(EndpointD*)initWithCoder:(NSCoder*)coder {MSGSTART("EndpointD:-(EndpointD*)initWithCoder:(NSCoder*)coder")
...
/*i10001*/return(self);}
-(EndpointD*)initWithContentsOfFile:(NSString*)file {MSGSTART("EndpointD:-(EndpointD*)initWithContentsOfFile:(NSString*)file")
...
/*i10001*/return(self);}
-(EndpointD*)initWithContentsOfURL:(NSURL*)url {MSGSTART("EndpointD:-(EndpointD*)initWithContentsOfURL:(NSURL*)url")
...
/*i10001*/return(self);}
-(EndpointD*)initWithDictionary:(NSDictionary*)dictionary {MSGSTART("EndpointD:-(EndpointD*)initWithDictionary:(NSDictionary*)dictionary")
...
/*i10001*/return(self);}
-(EndpointD*)initWithDictionary:(NSDictionary*)dictionary copyItems:(BOOL)copy {MSGSTART("EndpointD:-(EndpointD*)initWithDictionary:(NSDictionary*)dictionary copyItems:(BOOL)copy")
...
/*i10001*/return(self);}
-(EndpointD*)initWithObjects:(const id[])objects forKeys:(const id<NSCopying>[])keys count:(Unsigned)count {MSGSTART("EndpointD:-(EndpointD*)initWithObjects:(const id[])objects forKeys:(const id<NSCopying>[])keys count:(Unsigned)count")
...
/*i10001*/return(self);}
-(EndpointD*)initWithOwner:(id)aowner retains:(bool)aretains acceptableSel:(SEL)aacceptableSel otherEndObjectToEndpoint:(SEL)aotherEndObjectToEndpoint {MSGSTART("EndpointD:-(EndpointD*)initWithOwner:(id)aowner retains:(bool)aretains acceptableSel:(SEL)aacceptableSel otherEndObjectToEndpoint:(SEL)aotherEndObjectToEndpoint")
...
/*i10001*/return(self);}
-(BOOL)isEqual:(id)obj {MSGSTART("EndpointD:-(BOOL)isEqual:(id)obj")
...
-(BOOL)isEqualToDictionary:(NSDictionary*)dictionary {MSGSTART("EndpointD:-(BOOL)isEqualToDictionary:(NSDictionary*)dictionary")
  return([__dictionary isEqualToDictionary:dictionary]);}
-(NSEnumerator*)keyEnumerator {MSGSTART("EndpointD:-(NSEnumerator*)keyEnumerator")
  return([__dictionary keyEnumerator]);}
-(NSSet *)keysOfEntriesPassingTest:(BOOL (^)(id key, id obj, BOOL *stop))predicate {MSGSTART("EndpointD:-(NSSet *)keysOfEntriesPassingTest:(BOOL (^)(id key, id obj, BOOL *stop))predicate")

          return([__dictionary keysOfEntriesPassingTest:predicate]);
    }
-(NSSet *)keysOfEntriesWithOptions:(NSEnumerationOptions)opts passingTest:(BOOL (^)(id key, id obj, BOOL *stop))predicate {MSGSTART("EndpointD:-(NSSet *)keysOfEntriesWithOptions:(NSEnumerationOptions)opts passingTest:(BOOL (^)(id key, id obj, BOOL *stop))predicate")

          return([__dictionary keysOfEntriesWithOptions:opts passingTest:predicate]);
    }
-(NSArray*)keysSortedByValueUsingComparator:(NSComparator)cmptr {MSGSTART("EndpointD:-(NSArray*)keysSortedByValueUsingComparator:(NSComparator)cmptr")

          return([__dictionary keysSortedByValueUsingComparator:cmptr]);
    }
-(NSArray*)keysSortedByValueUsingSelector:(SEL)selector {MSGSTART("EndpointD:-(NSArray*)keysSortedByValueUsingSelector:(SEL)selector")

          return([__dictionary keysSortedByValueUsingSelector:selector]);
    }
-(NSArray*)keysSortedByValueWithOptions:(NSSortOptions)opts usingComparator:(NSComparator)cmptr {MSGSTART("EndpointD:-(NSArray*)keysSortedByValueWithOptions:(NSSortOptions)opts usingComparator:(NSComparator)cmptr")

          return([__dictionary keysSortedByValueWithOptions:opts usingComparator:cmptr]);
    }
-(id)mutableCopyWithZone:(NSZone*)zone {MSGSTART("EndpointD:-(id)mutableCopyWithZone:(NSZone*)zone")

          return([[MutableDictionary allocWithZone:zone] initWithDictionary:__dictionary]);
    }
-(NSEnumerator*)objectEnumerator {MSGSTART("EndpointD:-(NSEnumerator*)objectEnumerator")
  return([__dictionary objectEnumerator]);}
-(id)objectForKey:(id<NSCopying>)key {MSGSTART("EndpointD:-(id)objectForKey:(id<NSCopying>)key")
  
  /*i-10*/id ret=[__dictionary objectForKey:key];
          
  /*i999*/return(ret);
    }
-(NSMutableString*)objectName {MSGSTART("EndpointD:-(NSMutableString*)objectName")
...
-(NSArray*)objectsForKeys:(NSArray *)keys notFoundMarker:(id)anObject {MSGSTART("EndpointD:-(NSArray*)objectsForKeys:(NSArray *)keys notFoundMarker:(id)anObject")

          return([__dictionary objectsForKeys:keys notFoundMarker:anObject]);
    }
-(id)owner {MSGSTART("EndpointD:-(id)owner")
  
  /*i-999*/id ret=owner;
  /*i999*/return(ret);}
-(bool)passFail:(bool)pass format:(NSString*)format,... {MSGSTART("EndpointD:-(bool)passFail:(bool)pass format:(NSString*)format,...")
...
-(void)removeAllObjects {MSGSTART("EndpointD:-(void)removeAllObjects")

          if ([self _removeAllObjects]) [self stateOK];
    }
-(void)removedDelegate {MSGSTART("EndpointD:-(void)removedDelegate")
  
  /*i-100*/dictionaryDelegate=nil;}
-(void)removeDelegate:(NSObject<MutableDictionaryDelegate>*)v {MSGSTART("EndpointD:-(void)removeDelegate:(NSObject<MutableDictionaryDelegate>*)v")
...
-(void)removeObjectForKey:(id<NSCopying>)key {MSGSTART("EndpointD:-(void)removeObjectForKey:(id<NSCopying>)key")

          if ([self _removeObjectForKey:key]) [self stateOK];
    }
-(void)removeObjectsForKeys:(NSArray*)keys {MSGSTART("EndpointD:-(void)removeObjectsForKeys:(NSArray*)keys")

          if ([self _removeObjectsForKeys:keys]) [self stateOK];
    }
-(void)set__dictionaryObjectKeys:(NSMutableDictionary*)v {MSGSTART("EndpointD:-(void)set__dictionaryObjectKeys:(NSMutableDictionary*)v")
  
  /*i-905*/if(__dictionaryObjectKeys==v)return;
  /*i-900*/{__dictionaryObjectKeys=(id)v;}}
-(void)setDelegateForDictionary:(NSDictionary*)v {MSGSTART("EndpointD:-(void)setDelegateForDictionary:(NSDictionary*)v")
  
  /*i-905*/if(delegateForDictionary==v)return;
  /*i-900*/{delegateForDictionary=(id)v;}}
-(void)setDictionary:(NSDictionary*)dictionary {MSGSTART("EndpointD:-(void)setDictionary:(NSDictionary*)dictionary")

          if ([self _setDictionary:dictionary]) [self stateOK];
    }
-(void)setErrs:(NSMutableString*)v {MSGSTART("EndpointD:-(void)setErrs:(NSMutableString*)v")
  
  /*i-905*/if(v_errs==v)return;
  /*i-900*/{v_errs=(id)v;}}
-(void)setObject:(id)object forKey:(id<NSCopying>)key {MSGSTART("EndpointD:-(void)setObject:(id)object forKey:(id<NSCopying>)key")

          if ([self _setObject:object forKey:key]) [self stateOK];
    }
-(void)setValue:(id)object forKey:(NSString*)key {MSGSTART("EndpointD:-(void)setValue:(id)object forKey:(NSString*)key")

          if ([self _setValue:object forKey:key]) [self stateOK];
    }
-(void)setWeakness:(CollectionWeakness)v {MSGSTART("EndpointD:-(void)setWeakness:(CollectionWeakness)v")
...
#ifndef __SWIFT__
-(bool)shouldAddObject:(id)object forKey:(id<NSCopying>)key makeWeak:(bool&)weak {MSGSTART("EndpointD:-(bool)shouldAddObject:(id)object forKey:(id<NSCopying>)key makeWeak:(bool&)weak")
...
#endif// __SWIFT__
-(void)stateOK {MSGSTART("EndpointD:-(void)stateOK")
...
-(bool)unacceptable:(id)obj {MSGSTART("EndpointD:-(bool)unacceptable:(id)obj")
  return(!(acceptableSel&&[self.owner performUnknownSelector:acceptableSel withObject:obj]));}
-(id)valueForKey:(NSString*)key {MSGSTART("EndpointD:-(id)valueForKey:(NSString*)key")
  return([__dictionary valueForKey:key]);}
-(CollectionWeakness)weakness {MSGSTART("EndpointD:-(CollectionWeakness)weakness")
  

  return(self.count?(weakObjectCount?(weakObjectCount==self.count?CollectionIsWeak:CollectionIsWeakAndStrong):CollectionIsWeak):CollectionIsEmpty);}
-(void)willReplaceObject:(id)fromObject withObject:(id)toObject forKey:(id<NSCopying>)key {MSGSTART("EndpointD:-(void)willReplaceObject:(id)fromObject withObject:(id)toObject forKey:(id<NSCopying>)key")
...
-(BOOL)writeToFile:(NSString *)path atomically:(BOOL)flag {MSGSTART("EndpointD:-(BOOL)writeToFile:(NSString *)path atomically:(BOOL)flag")

          return([__dictionary writeToFile:path atomically:flag]);
    }
-(BOOL)writeToURL:(NSURL *)url atomically:(BOOL)flag {MSGSTART("EndpointD:-(BOOL)writeToURL:(NSURL *)url atomically:(BOOL)flag")
...
@synthesize version=version;
@synthesize weakObjectCount=weakObjectCount;
-(void)_startObjectOfClassEndpointS {MSGSTART("EndpointS:-(void)_startObjectOfClassEndpointS")
...
-(NSMutableSet*)__mutableSet {MSGSTART("EndpointS:-(NSMutableSet*)__mutableSet")
  
  /*i-999*/NSMutableSet* ret=__mutableSet;
  /*i999*/return(ret);}
-(NSSet*)__set {MSGSTART("EndpointS:-(NSSet*)__set")
  
  /*i-999*/NSSet* ret=__set;
  /*i999*/return(ret);}
-(bool)_addObject:(id)object {MSGSTART("EndpointS:-(bool)_addObject:(id)object")
...
-(bool)_addObjectsFromArray:(NSArray*)array {MSGSTART("EndpointS:-(bool)_addObjectsFromArray:(NSArray*)array")

          bool ret=NO;
          for (NSObject *object in array) if ([self _addObject:object]) ret=YES;
          return(ret);
    }
-(bool)_addReferrer:(NSObject<LinkEndpoint>*)ep {MSGSTART("EndpointS:-(bool)_addReferrer:(NSObject<LinkEndpoint>*)ep")
...
-(bool)_filterUsingPredicate:(NSPredicate *)predicate {MSGSTART("EndpointS:-(bool)_filterUsingPredicate:(NSPredicate *)predicate")
...
-(bool)_intersectSet:(NSSet*)set {MSGSTART("EndpointS:-(bool)_intersectSet:(NSSet*)set")
...
-(bool)_minusSet:(NSSet*)set {MSGSTART("EndpointS:-(bool)_minusSet:(NSSet*)set")

          bool ret=NO;
          for (NSObject *object in set) if ([self _removeObject:object]) ret=YES;
          return(ret);
    }
-(bool)_removeAllObjects {MSGSTART("EndpointS:-(bool)_removeAllObjects")
...
-(bool)_removeObject:(id)object {MSGSTART("EndpointS:-(bool)_removeObject:(id)object")
...
-(void)_removeReferrer:(NSObject<LinkEndpoint>*)ep {MSGSTART("EndpointS:-(void)_removeReferrer:(NSObject<LinkEndpoint>*)ep")
...
-(bool)_setSet:(NSSet*)set {MSGSTART("EndpointS:-(bool)_setSet:(NSSet*)set")

          bool ret=[self _intersectSet:set];
          if ([self _unionSet:set]) ret=YES;
          return(ret);
    }
-(bool)_unionSet:(NSSet*)set {MSGSTART("EndpointS:-(bool)_unionSet:(NSSet*)set")

          bool ret=NO;
          for (NSObject *object in set) if ([self _addObject:object]) ret=YES;
          return(ret);
    }
-(void)addDelegate:(NSObject<MutableSetDelegate>*)v {MSGSTART("EndpointS:-(void)addDelegate:(NSObject<MutableSetDelegate>*)v")
...
-(void)addObject:(id)object {MSGSTART("EndpointS:-(void)addObject:(id)object")

          if ([self _addObject:object]) [self stateOK];
    }
-(void)addObjectsFromArray:(NSArray*)array {MSGSTART("EndpointS:-(void)addObjectsFromArray:(NSArray*)array")

          if ([self _addObjectsFromArray:array]) [self stateOK];
    }
-(void)addObserver:(NSObject *)observer forKeyPath:(NSString *)keyPath options:(NSKeyValueObservingOptions)options context:(void *)context {MSGSTART("EndpointS:-(void)addObserver:(NSObject *)observer forKeyPath:(NSString *)keyPath options:(NSKeyValueObservingOptions)options context:(void *)context")

          [__set addObserver:observer forKeyPath:keyPath options:options context:context];
    }
-(NSArray*)allObjects {MSGSTART("EndpointS:-(NSArray*)allObjects")
  return([__set allObjects]);}
-(id)anyObject {MSGSTART("EndpointS:-(id)anyObject")
  return([[__set anyObject] selfWithWeakness:retrievesWeakValues]);}
-(constchar*)cdescription {MSGSTART("EndpointS:-(constchar*)cdescription")
  return([self.description cStringUsingEncoding:NSASCIIStringEncoding]);}
-(constchar*)cobjectName {MSGSTART("EndpointS:-(constchar*)cobjectName")
  return([self.objectName cStringUsingEncoding:NSASCIIStringEncoding]);}
-(BOOL)containsObject:(id)object {MSGSTART("EndpointS:-(BOOL)containsObject:(id)object")
  return([__set containsObject:object]);}
-(id)copyWithZone:(NSZone*)zone {MSGSTART("EndpointS:-(id)copyWithZone:(NSZone*)zone")

          return([[ImmutableSet allocWithZone:zone] initWithSet:__set]);
    }
-(Unsigned)count {MSGSTART("EndpointS:-(Unsigned)count")
  return([__set count]);}
-(Unsigned)countByEnumeratingWithState:(NSFastEnumerationState *)state objects:(__unsafe_unretained id*)stackbuf count:(Unsigned)len {MSGSTART("EndpointS:-(Unsigned)countByEnumeratingWithState:(NSFastEnumerationState *)state objects:(__unsafe_unretained id*)stackbuf count:(Unsigned)len")

          return([__set countByEnumeratingWithState:state objects:stackbuf count:len]);
    }
-(void)countWeakObjects {MSGSTART("EndpointS:-(void)countWeakObjects")

          Int c=0;
          for (NSObject *o in __set) if (o.isWeakSelf) c++;
          weakObjectCount=c;
    }
-(void)dealloc {MSGSTART("EndpointS:-(void)dealloc")
...
/*i999*/}
-(NSSet*)delegateForSet {MSGSTART("EndpointS:-(NSSet*)delegateForSet")
  
  /*i-999*/NSSet* ret=delegateForSet;
  /*i999*/return(ret);}
-(void)delegateForSetChanged {MSGSTART("EndpointS:-(void)delegateForSetChanged")
}
-(NSString*)description {MSGSTART("EndpointS:-(NSString*)description")
...
-(NSString*)descriptionWithLocale:(id)locale {MSGSTART("EndpointS:-(NSString*)descriptionWithLocale:(id)locale")
  return([__set descriptionWithLocale:locale]);}
-(void)didAddObject:(id)object {MSGSTART("EndpointS:-(void)didAddObject:(id)object")
...
-(void)didRemoveObject:(id)object {MSGSTART("EndpointS:-(void)didRemoveObject:(id)object")

          
  /*i100*/[setDelegate didRemoveObject:object];
    }
-(void)die {MSGSTART("EndpointS:-(void)die")
  
  /*i900*/}
-(void)encodeWithCoder:(NSCoder*)coder {MSGSTART("EndpointS:-(void)encodeWithCoder:(NSCoder*)coder")

          [__set encodeWithCoder:coder];
    }
-(NSObject<LinkEndpoint>*)endpointForObject:(id)obj {MSGSTART("EndpointS:-(NSObject<LinkEndpoint>*)endpointForObject:(id)obj")

          if (obj) return((NSObject<LinkEndpoint>*)[self.owner performUnknownSelector:otherEndObjectToEndpoint withObject:obj]);
          else return(nil);
    }
+(EndpointS*)endpointWithOwner:(id)aowner retains:(bool)aretains acceptableSel:(SEL)aacceptableSel otherEndObjectToEndpoint:(SEL)aotherEndObjectToEndpoint {MSGSTART("EndpointS:+(EndpointS*)endpointWithOwner:(id)aowner retains:(bool)aretains acceptableSel:(SEL)aacceptableSel otherEndObjectToEndpoint:(SEL)aotherEndObjectToEndpoint")
...
-(void)enumerateObjectsUsingBlock:(void (^)(id obj, BOOL *stop))block {MSGSTART("EndpointS:-(void)enumerateObjectsUsingBlock:(void (^)(id obj, BOOL *stop))block")

          [__set enumerateObjectsUsingBlock:block];
    }
-(void)enumerateObjectsWithOptions:(NSEnumerationOptions)opts usingBlock:(void (^)(id obj, BOOL *stop))block {MSGSTART("EndpointS:-(void)enumerateObjectsWithOptions:(NSEnumerationOptions)opts usingBlock:(void (^)(id obj, BOOL *stop))block")

          [__set enumerateObjectsWithOptions:opts usingBlock:block];
    }
-(NSSet*)filteredSetUsingPredicate:(NSPredicate *)predicate {MSGSTART("EndpointS:-(NSSet*)filteredSetUsingPredicate:(NSPredicate *)predicate")
  return([__set filteredSetUsingPredicate:predicate]);}
-(void)filterUsingPredicate:(NSPredicate *)predicate {MSGSTART("EndpointS:-(void)filterUsingPredicate:(NSPredicate *)predicate")

          if ([self _filterUsingPredicate:predicate]) [self stateOK];
    }
-(NSMutableSet*)getAndClear {MSGSTART("EndpointS:-(NSMutableSet*)getAndClear")
...
-(Unsigned)hash {MSGSTART("EndpointS:-(Unsigned)hash")
  return((Unsigned)obfuscateULL(objectIDInTotal));}
-(EndpointS*)init {MSGSTART("EndpointS:-(EndpointS*)init")
...
/*i10001*/return(self);}
-(EndpointS*)initWithArray:(NSArray*)array {MSGSTART("EndpointS:-(EndpointS*)initWithArray:(NSArray*)array")
...
/*i10001*/return(self);}
-(EndpointS*)initWithCapacity:(Unsigned)numItems {MSGSTART("EndpointS:-(EndpointS*)initWithCapacity:(Unsigned)numItems")
...
/*i10001*/return(self);}
-(EndpointS*)initWithCoder:(NSCoder*)coder {MSGSTART("EndpointS:-(EndpointS*)initWithCoder:(NSCoder*)coder")
...
/*i10001*/return(self);}
-(EndpointS*)initWithObjects:(id*)objects count:(Unsigned)count {MSGSTART("EndpointS:-(EndpointS*)initWithObjects:(id*)objects count:(Unsigned)count")
...
/*i10001*/return(self);}
-(EndpointS*)initWithOwner:(id)aowner retains:(bool)aretains acceptableSel:(SEL)aacceptableSel otherEndObjectToEndpoint:(SEL)aotherEndObjectToEndpoint {MSGSTART("EndpointS:-(EndpointS*)initWithOwner:(id)aowner retains:(bool)aretains acceptableSel:(SEL)aacceptableSel otherEndObjectToEndpoint:(SEL)aotherEndObjectToEndpoint")
...
/*i10001*/return(self);}
-(EndpointS*)initWithSet:(NSSet*)set {MSGSTART("EndpointS:-(EndpointS*)initWithSet:(NSSet*)set")
...
/*i10001*/return(self);}
-(EndpointS*)initWithSet:(NSSet*)set copyItems:(BOOL)copy {MSGSTART("EndpointS:-(EndpointS*)initWithSet:(NSSet*)set copyItems:(BOOL)copy")
...
/*i10001*/return(self);}
-(void)intersectSet:(NSSet*)set {MSGSTART("EndpointS:-(void)intersectSet:(NSSet*)set")

          if ([self _intersectSet:set]) [self stateOK];
    }
-(BOOL)intersectsSet:(NSSet*)set {MSGSTART("EndpointS:-(BOOL)intersectsSet:(NSSet*)set")
  return([__set intersectsSet:set]);}
-(BOOL)isEqual:(id)obj {MSGSTART("EndpointS:-(BOOL)isEqual:(id)obj")
...
-(BOOL)isEqualToSet:(NSSet*)set {MSGSTART("EndpointS:-(BOOL)isEqualToSet:(NSSet*)set")
  return([__set isEqualToSet:set]);}
-(BOOL)isSubsetOfSet:(NSSet*)set {MSGSTART("EndpointS:-(BOOL)isSubsetOfSet:(NSSet*)set")
  return([__set isSubsetOfSet:set]);}
-(void)makeObjectsPerformSelector:(SEL)selector {MSGSTART("EndpointS:-(void)makeObjectsPerformSelector:(SEL)selector")
  [__set makeObjectsPerformSelector:selector];}
-(void)makeObjectsPerformSelector:(SEL)selector withObject:(id)object {MSGSTART("EndpointS:-(void)makeObjectsPerformSelector:(SEL)selector withObject:(id)object")
  [__set makeObjectsPerformSelector:selector withObject:object];}
-(id)member:(id)object {MSGSTART("EndpointS:-(id)member:(id)object")
  return([__set member:object]);}
-(void)minusSet:(NSSet*)set {MSGSTART("EndpointS:-(void)minusSet:(NSSet*)set")

          if ([self _minusSet:set]) [self stateOK];
    }
-(id)mutableCopyWithZone:(NSZone*)zone {MSGSTART("EndpointS:-(id)mutableCopyWithZone:(NSZone*)zone")

          return([[MutableSet allocWithZone:zone] initWithSet:__set]);
    }
-(NSEnumerator*)objectEnumerator {MSGSTART("EndpointS:-(NSEnumerator*)objectEnumerator")
  return([__set objectEnumerator]);}
-(NSMutableString*)objectName {MSGSTART("EndpointS:-(NSMutableString*)objectName")
...
-(NSSet*)objectsPassingTest:(BOOL (^)(id obj, BOOL *stop))predicate {MSGSTART("EndpointS:-(NSSet*)objectsPassingTest:(BOOL (^)(id obj, BOOL *stop))predicate")
  return([__set objectsPassingTest:predicate]);}
-(NSSet*)objectsWithOptions:(NSEnumerationOptions)opts passingTest:(BOOL (^)(id obj, BOOL *stop))predicate {MSGSTART("EndpointS:-(NSSet*)objectsWithOptions:(NSEnumerationOptions)opts passingTest:(BOOL (^)(id obj, BOOL *stop))predicate")
  return([__set objectsWithOptions:opts passingTest:predicate]);}
-(id)owner {MSGSTART("EndpointS:-(id)owner")
  
  /*i-999*/id ret=owner;
  /*i999*/return(ret);}
-(void)removeAllObjects {MSGSTART("EndpointS:-(void)removeAllObjects")

          if ([self _removeAllObjects]) [self stateOK];
    }
-(void)removedDelegate {MSGSTART("EndpointS:-(void)removedDelegate")
  
  /*i-100*/setDelegate=nil;}
-(void)removeDelegate:(NSObject<MutableSetDelegate>*)v {MSGSTART("EndpointS:-(void)removeDelegate:(NSObject<MutableSetDelegate>*)v")
...
-(void)removeObject:(id)object {MSGSTART("EndpointS:-(void)removeObject:(id)object")

          if ([self _removeObject:object]) [self stateOK];
    }
-(void)removeObserver:(NSObject *)observer forKeyPath:(NSString *)keyPath {MSGSTART("EndpointS:-(void)removeObserver:(NSObject *)observer forKeyPath:(NSString *)keyPath")

          [__set removeObserver:observer forKeyPath:keyPath];
    }
-(void)removeObserver:(NSObject *)observer forKeyPath:(NSString *)keyPath context:(void *)context {MSGSTART("EndpointS:-(void)removeObserver:(NSObject *)observer forKeyPath:(NSString *)keyPath context:(void *)context")

          [__set removeObserver:observer forKeyPath:keyPath context:context];
    }
+(EndpointS*)set {MSGSTART("EndpointS:+(EndpointS*)set")
  return([[EndpointS alloc] init]);}
-(NSSet*)setByAddingObject:(id)object {MSGSTART("EndpointS:-(NSSet*)setByAddingObject:(id)object")
  return([__set setByAddingObject:object]);}
-(NSSet*)setByAddingObjectsFromArray:(NSArray*)array {MSGSTART("EndpointS:-(NSSet*)setByAddingObjectsFromArray:(NSArray*)array")
  return([__set setByAddingObjectsFromArray:array]);}
-(NSSet*)setByAddingObjectsFromSet:(NSSet*)set {MSGSTART("EndpointS:-(NSSet*)setByAddingObjectsFromSet:(NSSet*)set")
  return([__set setByAddingObjectsFromSet:set]);}
-(NSObject<MutableSetDelegate>*)setDelegate {MSGSTART("EndpointS:-(NSObject<MutableSetDelegate>*)setDelegate")
  
  /*i-999*/NSObject<MutableSetDelegate>* ret=setDelegate;
  /*i999*/return(ret);}
-(void)setDelegateForSet:(NSSet*)v {MSGSTART("EndpointS:-(void)setDelegateForSet:(NSSet*)v")
  
  /*i-905*/if(delegateForSet==v)return;
  /*i-900*/{delegateForSet=(id)v;}}
-(void)setSet:(NSSet*)set {MSGSTART("EndpointS:-(void)setSet:(NSSet*)set")

          if ([self _setSet:set]) [self stateOK];
    }
-(void)setValue:(id)value forKey:(NSString *)key {MSGSTART("EndpointS:-(void)setValue:(id)value forKey:(NSString *)key")
  [__set setValue:value forKey:key];}
-(void)setWeakness:(CollectionWeakness)v {MSGSTART("EndpointS:-(void)setWeakness:(CollectionWeakness)v")
...
+(EndpointS*)setWithArray:(NSArray*)array {MSGSTART("EndpointS:+(EndpointS*)setWithArray:(NSArray*)array")
  return([[EndpointS alloc] initWithArray:array]);}
+(id)setWithCapacity:(Unsigned)numItems {MSGSTART("EndpointS:+(id)setWithCapacity:(Unsigned)numItems")

          return([[EndpointS alloc] initWithCapacity:numItems]);
    }
+(EndpointS*)setWithObject:(id)object {MSGSTART("EndpointS:+(EndpointS*)setWithObject:(id)object")
  return([[EndpointS alloc] initWithObjects:&object count:1]);}
+(EndpointS*)setWithSet:(NSSet*)set {MSGSTART("EndpointS:+(EndpointS*)setWithSet:(NSSet*)set")
  return([[EndpointS alloc] initWithSet:set]);}
#ifndef __SWIFT__
-(bool)shouldAddObject:(id)object makeWeak:(bool&)weak {MSGSTART("EndpointS:-(bool)shouldAddObject:(id)object makeWeak:(bool&)weak")
...
#endif// __SWIFT__
-(NSArray*)sortedArrayUsingDescriptors:(NSArray*)sortDescriptors {MSGSTART("EndpointS:-(NSArray*)sortedArrayUsingDescriptors:(NSArray*)sortDescriptors")
  return([__set sortedArrayUsingDescriptors:sortDescriptors]);}
-(void)stateOK {MSGSTART("EndpointS:-(void)stateOK")
...
-(bool)unacceptable:(id)obj {MSGSTART("EndpointS:-(bool)unacceptable:(id)obj")
  return(!(acceptableSel&&[self.owner performUnknownSelector:acceptableSel withObject:obj]));}
-(void)unionSet:(NSSet*)set {MSGSTART("EndpointS:-(void)unionSet:(NSSet*)set")

          if ([self _unionSet:set]) [self stateOK];
    }
-(id)valueForKey:(NSString*)key {MSGSTART("EndpointS:-(id)valueForKey:(NSString*)key")
  return([__set valueForKey:key]);}
-(CollectionWeakness)weakness {MSGSTART("EndpointS:-(CollectionWeakness)weakness")
  

  return(self.count?(weakObjectCount?(weakObjectCount==self.count?CollectionIsWeak:CollectionIsWeakAndStrong):CollectionIsWeak):CollectionIsEmpty);}
-(void)willAddObject:(id)object {MSGSTART("EndpointS:-(void)willAddObject:(id)object")

          
  /*i100*/[setDelegate willAddObject:object];
    }
-(void)willRemoveObject:(id)object {MSGSTART("EndpointS:-(void)willRemoveObject:(id)object")

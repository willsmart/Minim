...
// !!!: Implementations: r
    ...
    - (void)_startObjectOfClassRegexHelper {
        MSGSTART("RegexHelper:-(void)_startObjectOfClassRegexHelper")
...
/*i999*/}
    - (NSString *)description {
        MSGSTART("RegexHelper:-(NSString*)description")
    ...
    - (void)die {
        MSGSTART("RegexHelper:-(void)die")

        /*i900*/}
    - (NSMutableString *)objectName {
        MSGSTART("RegexHelper:-(NSMutableString*)objectName")
    ...
    + (NSRegularExpression *)regexForString:(NSString *)str {
        MSGSTART("RegexHelper:+(NSRegularExpression*)regexForString:(NSString*)str")

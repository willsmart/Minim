...
-(void)_startObjectOfClassLog {MSGSTART("Log:-(void)_startObjectOfClassLog")
  ...
  /*i0*/}
-(constchar*)cdescription {MSGSTART("Log:-(constchar*)cdescription")
  return([self.description cStringUsingEncoding:NSASCIIStringEncoding]);}
-(constchar*)cobjectName {MSGSTART("Log:-(constchar*)cobjectName")
  return([self.objectName cStringUsingEncoding:NSASCIIStringEncoding]);}
-(void)dealloc {MSGSTART("Log:-(void)dealloc")
...
/*i999*/}
-(NSString*)description {MSGSTART("Log:-(NSString*)description")
  
  /*i-999*/NSMutableString *ret=self.objectName;
          
  /*i999*/return(ret);
    }
-(void)die {MSGSTART("Log:-(void)die")
  
  /*i900*/}
+(Log*)get {MSGSTART("Log:+(Log*)get")
  return([[Log alloc] init]);}
+(Log*)getDefault {MSGSTART("Log:+(Log*)getDefault")
  return(g_singletons.log);}
-(Log*)init {MSGSTART("Log:-(Log*)init")
...
/*i10001*/return(self);}
+(void)log:(NSString*)format,... {MSGSTART("Log:+(void)log:(NSString*)format,...")
...
-(NSMutableString*)objectName {MSGSTART("Log:-(NSMutableString*)objectName")
...
+(void)sendToLog:(NSString*)logName format:(NSString*)format,... {MSGSTART("Log:+(void)sendToLog:(NSString*)logName format:(NSString*)format,...")
...
-(void)setWithDictionary:(NSDictionary*)d {MSGSTART("Log:-(void)setWithDictionary:(NSDictionary*)d")
}
-(void)tick {MSGSTART("Log:-(void)tick")
...
-(NSTimer*)tim {MSGSTART("Log:-(NSTimer*)tim")
  
  /*i-999*/NSTimer* ret=tim;
  /*i999*/return(ret);}
-(NSMutableString*)value {MSGSTART("Log:-(NSMutableString*)value")
...
@synthesize objectIDInClass=objectIDInClass;
@synthesize objectIDInTotal=objectIDInTotal;
-(void)_startObjectOfClassPartiallyOrderedSet {MSGSTART("PartiallyOrderedSet:-(void)_startObjectOfClassPartiallyOrderedSet")
  ...
  /*i0*/}
-(void)add:(NSObject*)v toArray:(NSMutableArray*)array todo:(NSMutableSet*)todo todoa:(NSMutableArray*)todoa {MSGSTART("PartiallyOrderedSet:-(void)add:(NSObject*)v toArray:(NSMutableArray*)array todo:(NSMutableSet*)todo todoa:(NSMutableArray*)todoa")
...
-(void)addObject:(NSObject*)v {MSGSTART("PartiallyOrderedSet:-(void)addObject:(NSObject*)v")
...
-(NSMutableDictionary*)afters {MSGSTART("PartiallyOrderedSet:-(NSMutableDictionary*)afters")

              return(v_afters.copy);
        }
-(void)appendObject:(NSObject*)v {MSGSTART("PartiallyOrderedSet:-(void)appendObject:(NSObject*)v")
...
-(NSArray*)asArray {MSGSTART("PartiallyOrderedSet:-(NSArray*)asArray")
...
-(NSMutableDictionary*)befores {MSGSTART("PartiallyOrderedSet:-(NSMutableDictionary*)befores")

              return(v_befores.copy);
        }
-(constchar*)cdescription {MSGSTART("PartiallyOrderedSet:-(constchar*)cdescription")
  return([self.description cStringUsingEncoding:NSASCIIStringEncoding]);}
-(constchar*)cobjectName {MSGSTART("PartiallyOrderedSet:-(constchar*)cobjectName")
  return([self.objectName cStringUsingEncoding:NSASCIIStringEncoding]);}
-(void)dealloc {MSGSTART("PartiallyOrderedSet:-(void)dealloc")
...
/*i999*/}
-(NSString*)description {MSGSTART("PartiallyOrderedSet:-(NSString*)description")
  
  /*i-999*/NSMutableString *ret=self.objectName;
          
  /*i999*/return(ret);
    }
-(void)die {MSGSTART("PartiallyOrderedSet:-(void)die")
  
  /*i900*/}
-(PartiallyOrderedSet*)init {MSGSTART("PartiallyOrderedSet:-(PartiallyOrderedSet*)init")
...
/*i10001*/return(self);}
-(PartiallyOrderedSet*)initWithArray:(NSArray*)array {MSGSTART("PartiallyOrderedSet:-(PartiallyOrderedSet*)initWithArray:(NSArray*)array")
...
/*i10001*/return(self);}
-(PartiallyOrderedSet*)initWithSet:(NSSet*)set {MSGSTART("PartiallyOrderedSet:-(PartiallyOrderedSet*)initWithSet:(NSSet*)set")
...
/*i10001*/return(self);}
-(void)mergeWith:(NSObject*)other {MSGSTART("PartiallyOrderedSet:-(void)mergeWith:(NSObject*)other")

          if ([other isKindOfClass:NSSet.class]) {
                for (NSObject *v in (NSSet*)other) [self addObject:v];
            }
...
-(NSMutableString*)objectName {MSGSTART("PartiallyOrderedSet:-(NSMutableString*)objectName")
...
+(PartiallyOrderedSet*)partiallyOrderedSet {MSGSTART("PartiallyOrderedSet:+(PartiallyOrderedSet*)partiallyOrderedSet")
  return([self new]);}
+(PartiallyOrderedSet*)partiallyOrderedSetWithArray:(NSArray*)array {MSGSTART("PartiallyOrderedSet:+(PartiallyOrderedSet*)partiallyOrderedSetWithArray:(NSArray*)array")
  return([self.alloc initWithArray:array]);}
+(PartiallyOrderedSet*)partiallyOrderedSetWithSet:(NSSet*)set {MSGSTART("PartiallyOrderedSet:+(PartiallyOrderedSet*)partiallyOrderedSetWithSet:(NSSet*)set")
  return([self.alloc initWithSet:set]);}
-(NSMutableSet*)set {MSGSTART("PartiallyOrderedSet:-(NSMutableSet*)set")

              return(v_set.copy);
        }
-(NSMutableDictionary*)usedKeys {MSGSTART("PartiallyOrderedSet:-(NSMutableDictionary*)usedKeys")
...
@synthesize objectIDInClass=objectIDInClass;
@synthesize objectIDInTotal=objectIDInTotal;
-(void)_startObjectOfClassStringRequestURLDelegate {MSGSTART("StringRequestURLDelegate:-(void)_startObjectOfClassStringRequestURLDelegate")
  ...
  /*i0*/}
-(void)cancel {MSGSTART("StringRequestURLDelegate:-(void)cancel")
...
-(constchar*)cdescription {MSGSTART("StringRequestURLDelegate:-(constchar*)cdescription")
  return([self.description cStringUsingEncoding:NSASCIIStringEncoding]);}
-(constchar*)cobjectName {MSGSTART("StringRequestURLDelegate:-(constchar*)cobjectName")
  return([self.objectName cStringUsingEncoding:NSASCIIStringEncoding]);}
-(StringRequestURLDelegateCompletionBlock)completionBlock {MSGSTART("StringRequestURLDelegate:-(StringRequestURLDelegateCompletionBlock)completionBlock")
  
  /*i-999*/StringRequestURLDelegateCompletionBlock ret=v_completionBlock;
  /*i999*/return(ret);}
-(NSURLConnection*)connection {MSGSTART("StringRequestURLDelegate:-(NSURLConnection*)connection")
  
  /*i-999*/NSURLConnection* ret=v_connection;
  /*i999*/return(ret);}
-(void)connection:(NSURLConnection*)connection didFailWithError:(NSError *)error {MSGSTART("StringRequestURLDelegate:-(void)connection:(NSURLConnection*)connection didFailWithError:(NSError *)error")
...
-(void)connection:(NSURLConnection*)connection didReceiveData:(NSData *)data {MSGSTART("StringRequestURLDelegate:-(void)connection:(NSURLConnection*)connection didReceiveData:(NSData *)data")

          NSString *str=[[NSString alloc] initWithData:data encoding:encoding];
          if (str) [self.partialRequestedString appendString:str];
    }
-(void)connection:(NSURLConnection*)connection didReceiveResponse:(NSURLResponse*)response {MSGSTART("StringRequestURLDelegate:-(void)connection:(NSURLConnection*)connection didReceiveResponse:(NSURLResponse*)response")

    }
-(void)connectionDidFinishLoading:(NSURLConnection *)connection {MSGSTART("StringRequestURLDelegate:-(void)connectionDidFinishLoading:(NSURLConnection *)connection")
...
-(void)dealloc {MSGSTART("StringRequestURLDelegate:-(void)dealloc")
...
/*i999*/}
-(NSString*)description {MSGSTART("StringRequestURLDelegate:-(NSString*)description")
  
  /*i-999*/NSMutableString *ret=self.objectName;
          
  /*i999*/return(ret);
    }
-(void)die {MSGSTART("StringRequestURLDelegate:-(void)die")
  
  /*i900*/}
-(StringRequestURLDelegate*)initWithEncoding:(NSStringEncoding)aencoding completionBlock:(StringRequestURLDelegateCompletionBlock)acompletionBlock {MSGSTART("StringRequestURLDelegate:-(StringRequestURLDelegate*)initWithEncoding:(NSStringEncoding)aencoding completionBlock:(StringRequestURLDelegateCompletionBlock)acompletionBlock")
...
/*i10001*/return(self);}
-(NSMutableString*)objectName {MSGSTART("StringRequestURLDelegate:-(NSMutableString*)objectName")
...
-(NSMutableString*)partialRequestedString {MSGSTART("StringRequestURLDelegate:-(NSMutableString*)partialRequestedString")
  
  /*i-999*/NSMutableString* ret=v_partialRequestedString;
  /*i999*/return(ret);}
-(void)setCompletionBlock:(StringRequestURLDelegateCompletionBlock)v {MSGSTART("StringRequestURLDelegate:-(void)setCompletionBlock:(StringRequestURLDelegateCompletionBlock)v")
  
  /*i-905*/if(v_completionBlock==v)return;
  /*i-900*/{v_completionBlock=(id)v;}}
-(void)setConnection:(NSURLConnection*)v {MSGSTART("StringRequestURLDelegate:-(void)setConnection:(NSURLConnection*)v")
  
  /*i-905*/if(v_connection==v)return;
  /*i-900*/{v_connection=(id)v;}}
-(void)setPartialRequestedString:(NSMutableString*)v {MSGSTART("StringRequestURLDelegate:-(void)setPartialRequestedString:(NSMutableString*)v")
  
  /*i-905*/if(v_partialRequestedString==v)return;
  /*i-900*/{v_partialRequestedString=(id)v;}}

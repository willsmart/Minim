...
@synthesize pos=pos;
-(void)_startObjectOfClassWReader {MSGSTART("WReader:-(void)_startObjectOfClassWReader")
...
-(NSString*)_fileName {MSGSTART("WReader:-(NSString*)_fileName")
  
  /*i-999*/NSString* ret=v__fileName;
  /*i999*/return(ret);}
-(NSString*)_fileString {MSGSTART("WReader:-(NSString*)_fileString")
  
  /*i-999*/NSString* ret=v__fileString;
  /*i999*/return(ret);}
-(constchar*)cdescription {MSGSTART("WReader:-(constchar*)cdescription")
  return([self.description cStringUsingEncoding:NSASCIIStringEncoding]);}
-(constchar*)cobjectName {MSGSTART("WReader:-(constchar*)cobjectName")
  return([self.objectName cStringUsingEncoding:NSASCIIStringEncoding]);}
-(WReaderToken*)currentToken {MSGSTART("WReader:-(WReaderToken*)currentToken")

          if (pos<0) pos=0;
          if (pos>=tokenizer.tokens.count) return(nil);
          return([tokenizer.tokens objectAtIndex:pos]);
    }
-(void)dealloc {MSGSTART("WReader:-(void)dealloc")
...
/*i999*/}
-(NSString*)description {MSGSTART("WReader:-(NSString*)description")
  
  /*i-999*/NSMutableString *ret=self.objectName;
          
  /*i999*/return(ret);
    }
-(void)die {MSGSTART("WReader:-(void)die")
  
  /*i900*/}
-(NSString*)fileName {MSGSTART("WReader:-(NSString*)fileName")
  return(v__fileName);}
-(NSString*)fileString {MSGSTART("WReader:-(NSString*)fileString")
  return(v__fileString);}
+(WReader*)get {MSGSTART("WReader:+(WReader*)get")
  return([[WReader alloc] init]);}
-(WReader*)init {MSGSTART("WReader:-(WReader*)init")
...
/*i10001*/return(self);}
-(NSArray*)lines {MSGSTART("WReader:-(NSArray*)lines")
  
  /*i-999*/NSArray* ret=lines;
  /*i999*/return(ret);}
-(NSString*)localString {MSGSTART("WReader:-(NSString*)localString")
...
-(WReaderToken*)nextToken {MSGSTART("WReader:-(WReaderToken*)nextToken")

          if (pos>=tokenizer.tokens.count) return(nil);
          pos++;
          return(self.currentToken);
    }
-(NSMutableString*)objectName {MSGSTART("WReader:-(NSMutableString*)objectName")
...
-(MutableDictionary*)replaces {MSGSTART("WReader:-(MutableDictionary*)replaces")
  
  /*i-999*/MutableDictionary* ret=replaces;
  /*i999*/return(ret);}
-(void)set_fileName:(NSString*)v {MSGSTART("WReader:-(void)set_fileName:(NSString*)v")
  
  /*i-905*/if(v__fileName==v)return;
  /*i-900*/{v__fileName=(id)v;}}
-(void)set_fileString:(NSString*)v {MSGSTART("WReader:-(void)set_fileString:(NSString*)v")
  
  /*i-905*/if(v__fileString==v)return;
  /*i-900*/{v__fileString=(id)v;}}
-(void)setFileName:(NSString*)v {MSGSTART("WReader:-(void)setFileName:(NSString*)v")
...
-(void)setFileString:(NSString*)v {MSGSTART("WReader:-(void)setFileString:(NSString*)v")
...
-(void)setReplaces:(MutableDictionary*)v {MSGSTART("WReader:-(void)setReplaces:(MutableDictionary*)v")
...
-(void)setTokenizer:(WReaderTokenizer*)v {MSGSTART("WReader:-(void)setTokenizer:(WReaderTokenizer*)v")
  ...
  /*i-900*/{tokenizer=(id)v;}
/*i-850*/REMOVEOWNER(tokenizer,self);ADDOWNER(v,self);}
-(void)setWithDictionary:(NSDictionary*)d {MSGSTART("WReader:-(void)setWithDictionary:(NSDictionary*)d")
}
-(NSString*)stringWithTokensInRange:(NSRange)r {MSGSTART("WReader:-(NSString*)stringWithTokensInRange:(NSRange)r")
...
-(WReaderTokenizer*)tokenizer {MSGSTART("WReader:-(WReaderTokenizer*)tokenizer")
...
-(void)_startObjectOfClassWReaderToken {MSGSTART("WReaderToken:-(void)_startObjectOfClassWReaderToken")
  
  /*i-996*/debugAutorelease=YES;
  /*i-995*/objInitFn(self,objectIDInTotal,objectIDInClass);
      
  /*i0*/}
-(constchar*)cdescription {MSGSTART("WReaderToken:-(constchar*)cdescription")
  return([self.description cStringUsingEncoding:NSASCIIStringEncoding]);}
-(constchar*)cobjectName {MSGSTART("WReaderToken:-(constchar*)cobjectName")
  return([self.objectName cStringUsingEncoding:NSASCIIStringEncoding]);}
-(void)dealloc {MSGSTART("WReaderToken:-(void)dealloc")
...
/*i999*/}
-(NSString*)description {MSGSTART("WReaderToken:-(NSString*)description")
...
-(void)die {MSGSTART("WReaderToken:-(void)die")
  
  /*i900*/}
-(WReaderToken*)initWithString:(NSString*)astr bracketCount:(Int)bc type:(char)atype {MSGSTART("WReaderToken:-(WReaderToken*)initWithString:(NSString*)astr bracketCount:(Int)bc type:(char)atype")
...
/*i10001*/return(self);}
-(NSMutableString*)objectName {MSGSTART("WReaderToken:-(NSMutableString*)objectName")
...
-(void)setStr:(NSString*)v {MSGSTART("WReaderToken:-(void)setStr:(NSString*)v")
  
  /*i-905*/if(v_str==v)return;
  /*i-900*/{v_str=(id)v;}}
-(NSString*)str {MSGSTART("WReaderToken:-(NSString*)str")
...
@synthesize objectIDInClass=objectIDInClass;
@synthesize objectIDInTotal=objectIDInTotal;
-(void)_startObjectOfClassWReaderTokenizer {MSGSTART("WReaderTokenizer:-(void)_startObjectOfClassWReaderTokenizer")
  ...
  /*i0*/}
-(NSString*)_str {MSGSTART("WReaderTokenizer:-(NSString*)_str")
  
  /*i-999*/NSString* ret=v__str;
  /*i999*/return(ret);}
-(constchar*)cdescription {MSGSTART("WReaderTokenizer:-(constchar*)cdescription")
  return([self.description cStringUsingEncoding:NSASCIIStringEncoding]);}
-(constchar*)cobjectName {MSGSTART("WReaderTokenizer:-(constchar*)cobjectName")
  return([self.objectName cStringUsingEncoding:NSASCIIStringEncoding]);}
-(void)dealloc {MSGSTART("WReaderTokenizer:-(void)dealloc")
...
/*i999*/}
-(NSString*)description {MSGSTART("WReaderTokenizer:-(NSString*)description")
  
  /*i-999*/NSMutableString *ret=self.objectName;
          
  /*i999*/return(ret);
    }
-(void)die {MSGSTART("WReaderTokenizer:-(void)die")
  
  /*i900*/}
+(WReaderTokenizer*)get {MSGSTART("WReaderTokenizer:+(WReaderTokenizer*)get")
  return([[WReaderTokenizer alloc] init]);}
-(WReaderTokenizer*)init {MSGSTART("WReaderTokenizer:-(WReaderTokenizer*)init")
...
/*i10001*/return(self);}
-(NSMutableString*)objectName {MSGSTART("WReaderTokenizer:-(NSMutableString*)objectName")
...
-(void)set_str:(NSString*)v {MSGSTART("WReaderTokenizer:-(void)set_str:(NSString*)v")
  
  /*i-905*/if(v__str==v)return;
  /*i-900*/{v__str=(id)v;}}
-(void)setStr:(NSString*)v {MSGSTART("WReaderTokenizer:-(void)setStr:(NSString*)v")
...
-(void)setWithDictionary:(NSDictionary*)d {MSGSTART("WReaderTokenizer:-(void)setWithDictionary:(NSDictionary*)d")
}
-(NSString*)str {MSGSTART("WReaderTokenizer:-(NSString*)str")

              return(v__str);
        }
-(NSMutableArray*)tokens {MSGSTART("WReaderTokenizer:-(NSMutableArray*)tokens")
  
  /*i-999*/NSMutableArray* ret=tokens;
  /*i999*/return(ret);}
-(NSString*)tokenStr {MSGSTART("WReaderTokenizer:-(NSString*)tokenStr")

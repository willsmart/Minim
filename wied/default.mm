...
@interface NSMutableArray(minim)
...
@interface NSMutableDictionary(minim)
...
@interface NSMutableString(minim)
...
-(void)_startObjectOfClassGlobals {MSGSTART("Globals:-(void)_startObjectOfClassGlobals")
  
  /*i-996*/debugAutorelease=YES;
  /*i-995*/objInitFn(self,objectIDInTotal,objectIDInClass);
      
  /*i0*/}
-(constchar*)cdescription {MSGSTART("Globals:-(constchar*)cdescription")
  return([self.description cStringUsingEncoding:NSASCIIStringEncoding]);}
-(constchar*)cobjectName {MSGSTART("Globals:-(constchar*)cobjectName")
  return([self.objectName cStringUsingEncoding:NSASCIIStringEncoding]);}
-(void)dealloc {MSGSTART("Globals:-(void)dealloc")
...
/*i999*/}
-(NSString*)description {MSGSTART("Globals:-(NSString*)description")
  
  /*i-999*/NSMutableString *ret=self.objectName;
          
  /*i999*/return(ret);
    }
-(void)die {MSGSTART("Globals:-(void)die")
  
  /*i900*/}
-(NSMutableString*)objectName {MSGSTART("Globals:-(NSMutableString*)objectName")
...
@implementation NSArray(minim)

-(NSArray*)arrayByApplyingRegexes:(NSObject*)regexes {MSGSTART("NSArray:-(NSArray*)arrayByApplyingRegexes:(NSObject*)regexes")
...
-(NSArray*)asStrong {MSGSTART("NSArray:-(NSArray*)asStrong")
...
-(NSObject*)asValidJsonObject {MSGSTART("NSArray:-(NSObject*)asValidJsonObject")
...
-(NSArray*)asWeak {MSGSTART("NSArray:-(NSArray*)asWeak")
  CollectionWeakness weakness=self.weakness;
...
-(NSArray*)copyWithWeakness:(CollectionWeakness)weakness {MSGSTART("NSArray:-(NSArray*)copyWithWeakness:(CollectionWeakness)weakness")
  switch (weakness) {
...
-(id)derefedObjectAtIndex:(Unsigned)index {MSGSTART("NSArray:-(id)derefedObjectAtIndex:(Unsigned)index")

          return([WeakObject deref:[self objectAtIndex:index]]);
    }
-(NSString*)jsonString {MSGSTART("NSArray:-(NSString*)jsonString")
...
-(NSMutableArray*)mutableCopyWithWeakness:(CollectionWeakness)weakness {MSGSTART("NSArray:-(NSMutableArray*)mutableCopyWithWeakness:(CollectionWeakness)weakness")
  switch (weakness) {
...
-(NSArray*)strongCopy {MSGSTART("NSArray:-(NSArray*)strongCopy")
  return(self.asStrong.copy);
}
-(NSMutableArray*)strongMutableCopy {MSGSTART("NSArray:-(NSMutableArray*)strongMutableCopy")
  NSMutableArray *ret=(NSMutableArray*)self.asStrong;
          return([ret isEqual:self]?self.mutableCopy:ret);
}
-(NSArray*)weakCopy {MSGSTART("NSArray:-(NSArray*)weakCopy")
  return(self.asWeak.copy);
}
-(NSMutableArray*)weakMutableCopy {MSGSTART("NSArray:-(NSMutableArray*)weakMutableCopy")
  NSMutableArray *ret=(NSMutableArray*)self.asWeak;
          return([ret isEqual:self]?self.mutableCopy:ret);
}
-(CollectionWeakness)weakness {MSGSTART("NSArray:-(CollectionWeakness)weakness")
...
-(NSArray*)withWeakness:(CollectionWeakness)weakness {MSGSTART("NSArray:-(NSArray*)withWeakness:(CollectionWeakness)weakness")
  switch (weakness) {
...
@implementation NSData(minim)

-(NSData*)sendAsBodyOfPOSTRequestWithURL:(NSURL*)url returningResponse:(NSURLResponse*__strong*)retresponse error:(NSError*__strong*)reterr {MSGSTART("NSData:-(NSData*)sendAsBodyOfPOSTRequestWithURL:(NSURL*)url returningResponse:(NSURLResponse*__strong*)retresponse error:(NSError*__strong*)reterr")
...
@implementation NSDictionary(minim)

-(NSDictionary*)asStrong {MSGSTART("NSDictionary:-(NSDictionary*)asStrong")
  CollectionWeakness weakness=self.weakness;
          if (weakness&CollectionIsWeak) {
...
-(NSObject*)asValidJsonObject {MSGSTART("NSDictionary:-(NSObject*)asValidJsonObject")
...
-(NSDictionary*)asWeak {MSGSTART("NSDictionary:-(NSDictionary*)asWeak")
  CollectionWeakness weakness=self.weakness;
          if (weakness&CollectionIsStrong) {
                NSMutableDictionary __block *ret=[NSMutableDictionary dictionaryWithCapacity:self.count];
                [self enumerateKeysAndObjectsWithOptions:0 usingBlock:^(id key, id object,BOOL *stop) {
...
-(NSDictionary*)copyWithWeakness:(CollectionWeakness)weakness {MSGSTART("NSDictionary:-(NSDictionary*)copyWithWeakness:(CollectionWeakness)weakness")
  switch (weakness) {
                case CollectionIsEmpty:case CollectionIsWeakAndStrong:default:return(self.copy);
                case CollectionIsWeak:return(self.weakCopy);
                case CollectionIsStrong:return(self.strongCopy);
...
-(id)derefedObjectForKey:(id)key {MSGSTART("NSDictionary:-(id)derefedObjectForKey:(id)key")

          return([WeakObject deref:[self objectForKey:key]]);
    }
-(NSDictionary*)dictionaryByApplyingRegexes:(NSObject*)regexes {MSGSTART("NSDictionary:-(NSDictionary*)dictionaryByApplyingRegexes:(NSObject*)regexes")
...
-(NSString*)jsonString {MSGSTART("NSDictionary:-(NSString*)jsonString")

          NSError *err=nil;
          return [NSString.alloc initWithData:[NSJSONSerialization dataWithJSONObject:self.asValidJsonObject options:0 error:&err] encoding:NSUTF8StringEncoding];
    }
-(NSMutableDictionary*)mutableCopyWithWeakness:(CollectionWeakness)weakness {MSGSTART("NSDictionary:-(NSMutableDictionary*)mutableCopyWithWeakness:(CollectionWeakness)weakness")
  switch (weakness) {
                case CollectionIsEmpty:case CollectionIsWeakAndStrong:default:return(self.mutableCopy);
                case CollectionIsWeak:return(self.weakMutableCopy);
                case CollectionIsStrong:return(self.strongMutableCopy);
...
-(NSDictionary*)strongCopy {MSGSTART("NSDictionary:-(NSDictionary*)strongCopy")
  return(self.asStrong.copy);
}
-(NSMutableDictionary*)strongMutableCopy {MSGSTART("NSDictionary:-(NSMutableDictionary*)strongMutableCopy")
  NSMutableDictionary *ret=(NSMutableDictionary*)self.asStrong;
          return([ret isEqual:self]?self.mutableCopy:ret);
}
-(NSDictionary*)weakCopy {MSGSTART("NSDictionary:-(NSDictionary*)weakCopy")
  return(self.asWeak.copy);
}
-(NSMutableDictionary*)weakMutableCopy {MSGSTART("NSDictionary:-(NSMutableDictionary*)weakMutableCopy")
  NSMutableDictionary *ret=(NSMutableDictionary*)self.asWeak;
          return([ret isEqual:self]?self.mutableCopy:ret);
}
-(CollectionWeakness)weakness {MSGSTART("NSDictionary:-(CollectionWeakness)weakness")
  CollectionWeakness __block ret=CollectionIsEmpty;
          [self enumerateKeysAndObjectsWithOptions:0 usingBlock:^(id key, id object, BOOL *stop) {
                  if (((ret=(CollectionWeakness)(ret|([object isWeakSelf]?CollectionIsWeak:CollectionIsStrong))))==CollectionIsWeakAndStrong) *stop=YES;
              }];
...
-(NSDictionary*)withWeakness:(CollectionWeakness)weakness {MSGSTART("NSDictionary:-(NSDictionary*)withWeakness:(CollectionWeakness)weakness")
  switch (weakness) {
                case CollectionIsEmpty:case CollectionIsWeakAndStrong:default:return(self);
                case CollectionIsWeak:return(self.asWeak);
                case CollectionIsStrong:return(self.asStrong);
...
@implementation NSMutableArray(minim)

-(void)addObject:(id)anObject weak:(bool)weakObject {MSGSTART("NSMutableArray:-(void)addObject:(id)anObject weak:(bool)weakObject")

          if (weakObject) [self addWeakObject:anObject];
          else [self addObject:anObject];
    }
-(void)addWeakObject:(id)anObject {MSGSTART("NSMutableArray:-(void)addWeakObject:(id)anObject")

          WeakObject *v=[[WeakObject alloc] initWithObject:anObject];
          [self addObject:v];
    }
-(void)insertObject:(id)anObject weak:(bool)weakObject atIndex:(Unsigned)index {MSGSTART("NSMutableArray:-(void)insertObject:(id)anObject weak:(bool)weakObject atIndex:(Unsigned)index")

          if (weakObject) [self insertWeakObject:anObject atIndex:index];
          else [self insertObject:anObject atIndex:index];
    }
-(void)insertWeakObject:(id)anObject atIndex:(Unsigned)index {MSGSTART("NSMutableArray:-(void)insertWeakObject:(id)anObject atIndex:(Unsigned)index")

          WeakObject *v=[[WeakObject alloc] initWithObject:anObject];
          [self insertObject:v atIndex:index];
    }
-(void)mergeWith:(NSObject*)other {MSGSTART("NSMutableArray:-(void)mergeWith:(NSObject*)other")

          PartiallyOrderedSet *pos=[PartiallyOrderedSet partiallyOrderedSetWithArray:self];
          [pos mergeWith:other];
          [self setArray:pos.asArray];
    }
-(void)replaceObjectAtIndex:(Unsigned)index withObject:(id)anObject weak:(bool)weakObject {MSGSTART("NSMutableArray:-(void)replaceObjectAtIndex:(Unsigned)index withObject:(id)anObject weak:(bool)weakObject")
...
-(void)replaceObjectAtIndex:(Unsigned)index withWeakObject:(id)anObject {MSGSTART("NSMutableArray:-(void)replaceObjectAtIndex:(Unsigned)index withWeakObject:(id)anObject")
...
@implementation NSMutableDictionary(minim)

-(void)mergeWith:(NSObject*)other {MSGSTART("NSMutableDictionary:-(void)mergeWith:(NSObject*)other")
...
-(void)setObject:(id)anObject forPointerKey:(id)aKeyo {MSGSTART("NSMutableDictionary:-(void)setObject:(id)anObject forPointerKey:(id)aKeyo")

          PointerKey *k=[[PointerKey alloc] initWithObject:aKeyo];
          [self setObject:anObject forKey:k];
    }
-(void)setObject:(id)anObject forWeakKey:(id)aKeyo {MSGSTART("NSMutableDictionary:-(void)setObject:(id)anObject forWeakKey:(id)aKeyo")

          WeakObject *k=[[WeakObject alloc] initWithObject:aKeyo];
          [self setObject:anObject forKey:k];
    }
-(void)setObject:(id)anObject weak:(bool)weakObject forKey:(id)aKeyo weak:(bool)weakKey pointer:(bool)pointerKey {MSGSTART("NSMutableDictionary:-(void)setObject:(id)anObject weak:(bool)weakObject forKey:(id)aKeyo weak:(bool)weakKey pointer:(bool)pointerKey")
...
-(void)setWeakObject:(id)anObject forKey:(id)aKeyo {MSGSTART("NSMutableDictionary:-(void)setWeakObject:(id)anObject forKey:(id)aKeyo")

          WeakObject *v=[[WeakObject alloc] initWithObject:anObject];
          [self setObject:v forKey:aKeyo];
    }
-(void)setWeakObject:(id)anObject forPointerKey:(id)aKeyo {MSGSTART("NSMutableDictionary:-(void)setWeakObject:(id)anObject forPointerKey:(id)aKeyo")

          WeakObject *v=[[WeakObject alloc] initWithObject:anObject];
          PointerKey *k=[[PointerKey alloc] initWithObject:aKeyo];
          [self setObject:v forKey:k];
    }
-(void)setWeakObject:(id)anObject forWeakKey:(id)aKeyo {MSGSTART("NSMutableDictionary:-(void)setWeakObject:(id)anObject forWeakKey:(id)aKeyo")
...
@implementation NSMutableSet(minim)

-(void)addObject:(id)anObject weak:(bool)weakObject {MSGSTART("NSMutableSet:-(void)addObject:(id)anObject weak:(bool)weakObject")

          if (weakObject) [self addWeakObject:anObject];
          else [self addObject:anObject];
    }
-(void)addWeakObject:(id)anObject {MSGSTART("NSMutableSet:-(void)addWeakObject:(id)anObject")

          WeakObject *v=[[WeakObject alloc] initWithObject:anObject];
          [self addObject:v];
    }
-(void)mergeWith:(NSObject*)other {MSGSTART("NSMutableSet:-(void)mergeWith:(NSObject*)other")
...
@implementation NSMutableString(minim)

-(NSMutableString*)applyRegexes:(NSObject*)regexesArrayOrDictionary {MSGSTART("NSMutableString:-(NSMutableString*)applyRegexes:(NSObject*)regexesArrayOrDictionary")
...
-(void)match:(NSRegularExpression*)regex replace:(NSUInteger)count withString:(NSString*)replaceStr {MSGSTART("NSMutableString:-(void)match:(NSRegularExpression*)regex replace:(NSUInteger)count withString:(NSString*)replaceStr")
...
@implementation NSNull(minim)

-(NSObject*)asValidJsonObject {MSGSTART("NSNull:-(NSObject*)asValidJsonObject")
  return(self);}
...
@implementation NSNumber(minim)

-(NSObject*)asValidJsonObject {MSGSTART("NSNumber:-(NSObject*)asValidJsonObject")
  return(self);}
...
@implementation NSSet(minim)

-(NSSet*)asStrong {MSGSTART("NSSet:-(NSSet*)asStrong")
  CollectionWeakness weakness=self.weakness;
          if (weakness&CollectionIsWeak) {
...
-(NSObject*)asValidJsonObject {MSGSTART("NSSet:-(NSObject*)asValidJsonObject")
  return(self.allObjects.asValidJsonObject);}
-(NSSet*)asWeak {MSGSTART("NSSet:-(NSSet*)asWeak")
  CollectionWeakness weakness=self.weakness;
          if (weakness&CollectionIsStrong) {
                NSMutableSet __block *ret=[NSMutableSet setWithCapacity:self.count];
                [self enumerateObjectsWithOptions:0 usingBlock:^(id object,BOOL *stop) {
...
-(NSSet*)copyWithWeakness:(CollectionWeakness)weakness {MSGSTART("NSSet:-(NSSet*)copyWithWeakness:(CollectionWeakness)weakness")
  switch (weakness) {
                case CollectionIsEmpty:case CollectionIsWeakAndStrong:default:return(self.copy);
                case CollectionIsWeak:return(self.weakCopy);
                case CollectionIsStrong:return(self.strongCopy);
...
-(NSString*)jsonString {MSGSTART("NSSet:-(NSString*)jsonString")
  return(self.allObjects.jsonString);}
-(NSMutableSet*)mutableCopyWithWeakness:(CollectionWeakness)weakness {MSGSTART("NSSet:-(NSMutableSet*)mutableCopyWithWeakness:(CollectionWeakness)weakness")
  switch (weakness) {
                case CollectionIsEmpty:case CollectionIsWeakAndStrong:default:return(self.mutableCopy);
                case CollectionIsWeak:return(self.weakMutableCopy);
                case CollectionIsStrong:return(self.strongMutableCopy);
...
-(NSSet*)setByApplyingRegexes:(NSObject*)regexes {MSGSTART("NSSet:-(NSSet*)setByApplyingRegexes:(NSObject*)regexes")
...
-(NSSet*)strongCopy {MSGSTART("NSSet:-(NSSet*)strongCopy")
  return(self.asStrong.copy);
}
-(NSMutableSet*)strongMutableCopy {MSGSTART("NSSet:-(NSMutableSet*)strongMutableCopy")
  NSMutableSet *ret=(NSMutableSet*)self.asStrong;
          return([ret isEqual:self]?self.mutableCopy:ret);
}
-(NSSet*)weakCopy {MSGSTART("NSSet:-(NSSet*)weakCopy")
  return(self.asWeak.copy);
}
-(NSMutableSet*)weakMutableCopy {MSGSTART("NSSet:-(NSMutableSet*)weakMutableCopy")
  NSMutableSet *ret=(NSMutableSet*)self.asWeak;
          return([ret isEqual:self]?self.mutableCopy:ret);
}
-(CollectionWeakness)weakness {MSGSTART("NSSet:-(CollectionWeakness)weakness")
  CollectionWeakness __block ret=CollectionIsEmpty;
          [self enumerateObjectsWithOptions:0 usingBlock:^(id object,BOOL *stop) {
                  if (((ret=(CollectionWeakness)(ret|([object isWeakSelf]?CollectionIsWeak:CollectionIsStrong))))==CollectionIsWeakAndStrong) *stop=YES;
              }];
...
-(NSSet*)withWeakness:(CollectionWeakness)weakness {MSGSTART("NSSet:-(NSSet*)withWeakness:(CollectionWeakness)weakness")
  switch (weakness) {
                case CollectionIsEmpty:case CollectionIsWeakAndStrong:default:return(self);
                case CollectionIsWeak:return(self.asWeak);
                case CollectionIsStrong:return(self.asStrong);
...
@synthesize objectIDInClass=objectIDInClass;
@synthesize objectIDInTotal=objectIDInTotal;
-(void)_startObjectOfClassWIBody {MSGSTART("WIBody:-(void)_startObjectOfClassWIBody")
  ...
  /*i0*/}
-(WIBody*)applyRegexes:(NSArray*)regexes to:(WIVar*)tov {MSGSTART("WIBody:-(WIBody*)applyRegexes:(NSArray*)regexes to:(WIVar*)tov")
...
-(NSDictionary*)asD3Tree {MSGSTART("WIBody:-(NSDictionary*)asD3Tree")
  return([Treeable asD3Tree:self.asTree]);}
-(NSString*)asD3TreeJSON {MSGSTART("WIBody:-(NSString*)asD3TreeJSON")
...
-(NSDictionary*)asTree {MSGSTART("WIBody:-(NSDictionary*)asTree")
  return([self asTree:NSMutableSet.set]);}
-(NSMutableDictionary*)asTree:(NSMutableSet*)seen {MSGSTART("WIBody:-(NSMutableDictionary*)asTree:(NSMutableSet*)seen")

          return(([Treeable asTree:seen object:self]));
    }
-(constchar*)cdescription {MSGSTART("WIBody:-(constchar*)cdescription")
  return([self.description cStringUsingEncoding:NSASCIIStringEncoding]);}
-(constchar*)cobjectName {MSGSTART("WIBody:-(constchar*)cobjectName")
  return([self.objectName cStringUsingEncoding:NSASCIIStringEncoding]);}
-(void)dealloc {MSGSTART("WIBody:-(void)dealloc")
...
/*i999*/}
-(WIVar*)defaultValueForVar {MSGSTART("WIBody:-(WIVar*)defaultValueForVar")
  return((WIVar*)v_defaultValueForVar_endpoint.value);}
-(Endpoint1*)defaultValueForVar_endpoint {MSGSTART("WIBody:-(Endpoint1*)defaultValueForVar_endpoint")
  
  /*i-999*/Endpoint1* ret=v_defaultValueForVar_endpoint;
  /*i999*/return(ret);}
-(NSObject<LinkEndpoint>*)defaultValueForVarToEndpoint:(id)adefaultValueForVar {MSGSTART("WIBody:-(NSObject<LinkEndpoint>*)defaultValueForVarToEndpoint:(id)adefaultValueForVar")
  return([adefaultValueForVar performSelector:@selector(defaultValue_endpoint)]);}
-(NSString*)description {MSGSTART("WIBody:-(NSString*)description")
  
  /*i-999*/NSMutableString *ret=self.objectName;
          
  /*i999*/return(ret);
    }
-(NSString*)descriptiveName {MSGSTART("WIBody:-(NSString*)descriptiveName")
...
-(void)die {MSGSTART("WIBody:-(void)die")
  ...
  /*i900*/}
-(WIVar*)getterForVar {MSGSTART("WIBody:-(WIVar*)getterForVar")
  return((WIVar*)v_getterForVar_endpoint.value);}
-(Endpoint1*)getterForVar_endpoint {MSGSTART("WIBody:-(Endpoint1*)getterForVar_endpoint")
  
  /*i-999*/Endpoint1* ret=v_getterForVar_endpoint;
  /*i999*/return(ret);}
-(NSObject<LinkEndpoint>*)getterForVarToEndpoint:(id)agetterForVar {MSGSTART("WIBody:-(NSObject<LinkEndpoint>*)getterForVarToEndpoint:(id)agetterForVar")
  return([agetterForVar performSelector:@selector(getter_endpoint)]);}
-(void)incorporateBody:(NSString*)body {MSGSTART("WIBody:-(void)incorporateBody:(NSString*)body")
...
-(WIBody*)init {MSGSTART("WIBody:-(WIBody*)init")
...
/*i10001*/return(self);}
-(NSNumber*)isAcceptableDefaultValueForVar:(id)adefaultValueForVar {MSGSTART("WIBody:-(NSNumber*)isAcceptableDefaultValueForVar:(id)adefaultValueForVar")
  return([adefaultValueForVar isKindOfClass:[WIVar class]]?@YES:nil);}
-(NSNumber*)isAcceptableGetterForVar:(id)agetterForVar {MSGSTART("WIBody:-(NSNumber*)isAcceptableGetterForVar:(id)agetterForVar")
  return([agetterForVar isKindOfClass:[WIVar class]]?@YES:nil);}
-(NSNumber*)isAcceptableSetterForVar:(id)asetterForVar {MSGSTART("WIBody:-(NSNumber*)isAcceptableSetterForVar:(id)asetterForVar")
  return([asetterForVar isKindOfClass:[WIVar class]]?@YES:nil);}
-(NSNumber*)isAcceptableSnippet:(id)asnippet {MSGSTART("WIBody:-(NSNumber*)isAcceptableSnippet:(id)asnippet")
  return([asnippet isKindOfClass:[WIBodySnippet class]]?@YES:nil);}
-(kid)keyInSetterForVar {MSGSTART("WIBody:-(kid)keyInSetterForVar")

              for (id<NSCopying> key in self.keysInSetterForVar) return(key);
              return(nil);
        }
-(NSSet*)keysInSetterForVar {MSGSTART("WIBody:-(NSSet*)keysInSetterForVar")
...
-(void)mergeWith:(WIBody*)other {MSGSTART("WIBody:-(void)mergeWith:(WIBody*)other")
...
-(NSMutableString*)objectName {MSGSTART("WIBody:-(NSMutableString*)objectName")
...
-(void)removeAllSnippets {MSGSTART("WIBody:-(void)removeAllSnippets")
  [v_snippets removeAllObjects];}
-(void)removeSnippetForKey:(id<NSCopying>)key {MSGSTART("WIBody:-(void)removeSnippetForKey:(id<NSCopying>)key")
  [v_snippets removeObjectForKey:key];}
-(void)retract {MSGSTART("WIBody:-(void)retract")
  self.getterForVar=nil;
  self.defaultValueForVar=nil;
  self.setterForVar=nil;
  [self.snippets removeAllObjects];}
-(NSDictionary*)seenTreeNodeData {MSGSTART("WIBody:-(NSDictionary*)seenTreeNodeData")
  
  /*i-999*/NSDictionary *ret=nil;
  /*i999*/return(ret?ret:self.treeNodeData);}
-(void)setDefaultValueForVar:(WIVar*)v {MSGSTART("WIBody:-(void)setDefaultValueForVar:(WIVar*)v")
  [v_defaultValueForVar_endpoint setValue:v];}
-(void)setDefaultValueForVar_endpoint:(Endpoint1*)v {MSGSTART("WIBody:-(void)setDefaultValueForVar_endpoint:(Endpoint1*)v")
  ...
  /*i-900*/{v_defaultValueForVar_endpoint=(id)v;}
/*i-850*/REMOVEOWNER(v_defaultValueForVar_endpoint,self);ADDOWNER(v,self);}
-(void)setGetterForVar:(WIVar*)v {MSGSTART("WIBody:-(void)setGetterForVar:(WIVar*)v")
  [v_getterForVar_endpoint setValue:v];}
-(void)setGetterForVar_endpoint:(Endpoint1*)v {MSGSTART("WIBody:-(void)setGetterForVar_endpoint:(Endpoint1*)v")
  ...
  /*i-900*/{v_getterForVar_endpoint=(id)v;}
/*i-850*/REMOVEOWNER(v_getterForVar_endpoint,self);ADDOWNER(v,self);}
-(void)setKeyInSetterForVar:(kid)v {MSGSTART("WIBody:-(void)setKeyInSetterForVar:(kid)v")

              self.keysInSetterForVar=[NSSet setWithObject:v];
        }
-(void)setKeysInSetterForVar:(NSSet*)v {MSGSTART("WIBody:-(void)setKeysInSetterForVar:(NSSet*)v")
              ...
              if ([Util getInsertsAndDeletesForSetWhenChanging:setterForVar_keys_were to:v inss:&setterForVar_inss dels:&setterForVar_dels]) {
                    for (id<NSCopying> key in setterForVar_dels) [setterForVar_ep removeObjectForKey:key];
                    for (id<NSCopying> key in setterForVar_inss) [setterForVar_ep setObject:self forKey:key];
                }
        }
-(void)setSetterForVar:(WIVar*)v {MSGSTART("WIBody:-(void)setSetterForVar:(WIVar*)v")
  [v_setterForVar_endpoint setValue:v];}
-(void)setSetterForVar_endpoint:(Endpoint1*)v {MSGSTART("WIBody:-(void)setSetterForVar_endpoint:(Endpoint1*)v")
  ...
  /*i-900*/{v_setterForVar_endpoint=(id)v;}
/*i-850*/REMOVEOWNER(v_setterForVar_endpoint,self);ADDOWNER(v,self);}
-(void)setSnippet:(id)v forKey:(id<NSCopying>)key {MSGSTART("WIBody:-(void)setSnippet:(id)v forKey:(id<NSCopying>)key")
  [v_snippets setObject:v forKey:key];}
-(void)setSnippets:(EndpointD*)v {MSGSTART("WIBody:-(void)setSnippets:(EndpointD*)v")
  ...
  /*i-900*/{v_snippets=(id)v;}
/*i-850*/REMOVEOWNER(v_snippets,self);ADDOWNER(v,self);}
-(WIVar*)setterForVar {MSGSTART("WIBody:-(WIVar*)setterForVar")
  return((WIVar*)v_setterForVar_endpoint.value);}
-(Endpoint1*)setterForVar_endpoint {MSGSTART("WIBody:-(Endpoint1*)setterForVar_endpoint")
  
  /*i-999*/Endpoint1* ret=v_setterForVar_endpoint;
  /*i999*/return(ret);}
-(NSObject<LinkEndpoint>*)setterForVarToEndpoint:(id)asetterForVar {MSGSTART("WIBody:-(NSObject<LinkEndpoint>*)setterForVarToEndpoint:(id)asetterForVar")
  return([asetterForVar performSelector:@selector(setters)]);}
-(WIBodySnippet*)snippetAtOrdinal:(int)ordinal {MSGSTART("WIBody:-(WIBodySnippet*)snippetAtOrdinal:(int)ordinal")

          WIBodySnippet *ret=[self snippetForKey:@(ordinal)];
          if (!ret) [self setSnippet:ret=[WIBodySnippet new] forKey:@(ordinal)];
          return(ret);
    }
-(WIBodySnippet*)snippetForKey:(id<NSCopying>)key {MSGSTART("WIBody:-(WIBodySnippet*)snippetForKey:(id<NSCopying>)key")
  return([v_snippets objectForKey:key]);}
-(EndpointD*)snippets {MSGSTART("WIBody:-(EndpointD*)snippets")
  
  /*i-999*/EndpointD* ret=v_snippets;
  /*i999*/return(ret);}
-(NSObject<LinkEndpoint>*)snippetToEndpoint:(id)asnippet {MSGSTART("WIBody:-(NSObject<LinkEndpoint>*)snippetToEndpoint:(id)asnippet")
  return([asnippet performSelector:@selector(body_endpoint)]);}
+(NSRegularExpression*)splitterRegex {MSGSTART("WIBody:+(NSRegularExpression*)splitterRegex")
...
-(NSDictionary*)treeNodeData {MSGSTART("WIBody:-(NSDictionary*)treeNodeData")
  
  /*i-999*/NSDictionary *ret=nil;
  /*i0*/ret=@{@"type":@"Body",@"name":self.descriptiveName};
  
  /*i999*/return(ret?ret:@{});}
-(NSSet*)treePropertyNames {MSGSTART("WIBody:-(NSSet*)treePropertyNames")
  
  /*i-999*/static NSSet *retSet=nil;
  /*i-100*/if (!retSet) {NSArray *ret=nil;
    /*i0*/ret=@[];
    
    /*i100*/retSet=[NSSet setWithArray:ret?ret:@[]];}
  /*i999*/return(retSet);}
-(NSSet*)treeSingleNodePropertyNames {MSGSTART("WIBody:-(NSSet*)treeSingleNodePropertyNames")
...
@synthesize objectIDInClass=objectIDInClass;
@synthesize objectIDInTotal=objectIDInTotal;
-(void)_startObjectOfClassWIBodySnippet {MSGSTART("WIBodySnippet:-(void)_startObjectOfClassWIBodySnippet")
  ...
  /*i0*/}
-(WIBodySnippet*)applyRegexes:(NSArray*)regexes to:(WIBody*)tob {MSGSTART("WIBodySnippet:-(WIBodySnippet*)applyRegexes:(NSArray*)regexes to:(WIBody*)tob")
...
-(NSDictionary*)asD3Tree {MSGSTART("WIBodySnippet:-(NSDictionary*)asD3Tree")
  return([Treeable asD3Tree:self.asTree]);}
-(NSString*)asD3TreeJSON {MSGSTART("WIBodySnippet:-(NSString*)asD3TreeJSON")

          NSError *err=nil;
          return([[NSString alloc] initWithData:[NSJSONSerialization dataWithJSONObject:self.asD3Tree options:0 error:&err] encoding:NSUTF8StringEncoding]);
    }
-(NSDictionary*)asTree {MSGSTART("WIBodySnippet:-(NSDictionary*)asTree")
  return([self asTree:NSMutableSet.set]);}
-(NSMutableDictionary*)asTree:(NSMutableSet*)seen {MSGSTART("WIBodySnippet:-(NSMutableDictionary*)asTree:(NSMutableSet*)seen")

          return(([Treeable asTree:seen object:self]));
    }
-(WIBody*)body {MSGSTART("WIBodySnippet:-(WIBody*)body")
  return((WIBody*)v_body_endpoint.value);}
-(Endpoint1*)body_endpoint {MSGSTART("WIBodySnippet:-(Endpoint1*)body_endpoint")
  
  /*i-999*/Endpoint1* ret=v_body_endpoint;
  /*i999*/return(ret);}
-(NSObject<LinkEndpoint>*)bodyToEndpoint:(id)abody {MSGSTART("WIBodySnippet:-(NSObject<LinkEndpoint>*)bodyToEndpoint:(id)abody")
  return([abody performSelector:@selector(snippets)]);}
-(constchar*)cdescription {MSGSTART("WIBodySnippet:-(constchar*)cdescription")
  return([self.description cStringUsingEncoding:NSASCIIStringEncoding]);}
-(constchar*)cobjectName {MSGSTART("WIBodySnippet:-(constchar*)cobjectName")
  return([self.objectName cStringUsingEncoding:NSASCIIStringEncoding]);}
-(void)dealloc {MSGSTART("WIBodySnippet:-(void)dealloc")
...
/*i999*/}
-(NSString*)description {MSGSTART("WIBodySnippet:-(NSString*)description")
  
  /*i-999*/NSMutableString *ret=self.objectName;
          
  /*i999*/return(ret);
    }
-(void)die {MSGSTART("WIBodySnippet:-(void)die")
  self.body=nil;
  
  /*i900*/}
-(WIBodySnippet*)init {MSGSTART("WIBodySnippet:-(WIBodySnippet*)init")
...
/*i10001*/return(self);}
-(NSNumber*)isAcceptableBody:(id)abody {MSGSTART("WIBodySnippet:-(NSNumber*)isAcceptableBody:(id)abody")
  return([abody isKindOfClass:[WIBody class]]?@YES:nil);}
-(kid)keyInBody {MSGSTART("WIBodySnippet:-(kid)keyInBody")

              for (id<NSCopying> key in self.keysInBody) return(key);
              return(nil);
        }
-(NSSet*)keysInBody {MSGSTART("WIBodySnippet:-(NSSet*)keysInBody")
...
-(void)mergeWith:(WIBodySnippet*)other {MSGSTART("WIBodySnippet:-(void)mergeWith:(WIBodySnippet*)other")

          [self.strings mergeWith:other.strings];
    }
-(NSMutableString*)objectName {MSGSTART("WIBodySnippet:-(NSMutableString*)objectName")
...
-(void)retract {MSGSTART("WIBodySnippet:-(void)retract")
  self.body=nil;}
-(NSDictionary*)seenTreeNodeData {MSGSTART("WIBodySnippet:-(NSDictionary*)seenTreeNodeData")
  
  /*i-999*/NSDictionary *ret=nil;
  /*i999*/return(ret?ret:self.treeNodeData);}
-(void)setBody:(WIBody*)v {MSGSTART("WIBodySnippet:-(void)setBody:(WIBody*)v")
  [v_body_endpoint setValue:v];}
-(void)setBody_endpoint:(Endpoint1*)v {MSGSTART("WIBodySnippet:-(void)setBody_endpoint:(Endpoint1*)v")
  ...
  /*i-900*/{v_body_endpoint=(id)v;}
/*i-850*/REMOVEOWNER(v_body_endpoint,self);ADDOWNER(v,self);}
-(void)setKeyInBody:(kid)v {MSGSTART("WIBodySnippet:-(void)setKeyInBody:(kid)v")

              self.keysInBody=[NSSet setWithObject:v];
        }
-(void)setKeysInBody:(NSSet*)v {MSGSTART("WIBodySnippet:-(void)setKeysInBody:(NSSet*)v")
              ...
              if ([Util getInsertsAndDeletesForSetWhenChanging:body_keys_were to:v inss:&body_inss dels:&body_dels]) {
                    for (id<NSCopying> key in body_dels) [body_ep removeObjectForKey:key];
                    for (id<NSCopying> key in body_inss) [body_ep setObject:self forKey:key];
                }
        }
-(void)setStrings:(MutableSet*)v {MSGSTART("WIBodySnippet:-(void)setStrings:(MutableSet*)v")
  
  /*i-905*/if(v_strings==v)return;
  /*i-900*/{v_strings=(id)v;}
/*i-850*/REMOVEOWNER(v_strings,self);ADDOWNER(v,self);}
-(MutableSet*)strings {MSGSTART("WIBodySnippet:-(MutableSet*)strings")
  
  /*i-999*/MutableSet* ret=v_strings;
  /*i999*/return(ret);}
-(NSDictionary*)treeNodeData {MSGSTART("WIBodySnippet:-(NSDictionary*)treeNodeData")
  ...
  /*i999*/return(ret?ret:@{});}
-(NSSet*)treePropertyNames {MSGSTART("WIBodySnippet:-(NSSet*)treePropertyNames")
  
  /*i-999*/static NSSet *retSet=nil;
  /*i-100*/if (!retSet) {NSArray *ret=nil;
    /*i100*/retSet=[NSSet setWithArray:ret?ret:@[]];}
  /*i999*/return(retSet);}
-(NSSet*)treeSingleNodePropertyNames {MSGSTART("WIBodySnippet:-(NSSet*)treeSingleNodePropertyNames")
...
@synthesize objectIDInClass=objectIDInClass;
@synthesize objectIDInTotal=objectIDInTotal;
-(void)_startObjectOfClassWIClass {MSGSTART("WIClass:-(void)_startObjectOfClassWIClass")
  ...
  /*i0*/}
-(void)addConformedProtocol:(WIClass*)v {MSGSTART("WIClass:-(void)addConformedProtocol:(WIClass*)v")
  [v_conformedProtocols addObject:v];}
-(void)addConformingClass:(WIClass*)v {MSGSTART("WIClass:-(void)addConformingClass:(WIClass*)v")
  [v_conformingClasss addObject:v];}
-(void)addSubclass:(WIClass*)v {MSGSTART("WIClass:-(void)addSubclass:(WIClass*)v")
  [v_subclasss addObject:v];}
-(void)addSubprotocol:(WIClass*)v {MSGSTART("WIClass:-(void)addSubprotocol:(WIClass*)v")
  [v_subprotocols addObject:v];}
-(void)addSuperclass:(WIClass*)v {MSGSTART("WIClass:-(void)addSuperclass:(WIClass*)v")
  [v_superclasss addObject:v];}
-(void)addSuperprotocol:(WIClass*)v {MSGSTART("WIClass:-(void)addSuperprotocol:(WIClass*)v")
  [v_superprotocols addObject:v];}
-(WIClass*)applyRegexes {MSGSTART("WIClass:-(WIClass*)applyRegexes")
...
-(NSDictionary*)asD3Tree {MSGSTART("WIClass:-(NSDictionary*)asD3Tree")
  return([Treeable asD3Tree:self.asTree]);}
-(NSString*)asD3TreeJSON {MSGSTART("WIClass:-(NSString*)asD3TreeJSON")

          NSError *err=nil;
          return([[NSString alloc] initWithData:[NSJSONSerialization dataWithJSONObject:self.asD3Tree options:0 error:&err] encoding:NSUTF8StringEncoding]);
    }
-(NSDictionary*)asTree {MSGSTART("WIClass:-(NSDictionary*)asTree")
  return([self asTree:NSMutableSet.set]);}
-(NSMutableDictionary*)asTree:(NSMutableSet*)seen {MSGSTART("WIClass:-(NSMutableDictionary*)asTree:(NSMutableSet*)seen")

          return(([Treeable asTree:seen object:self]));
    }
-(constchar*)cdescription {MSGSTART("WIClass:-(constchar*)cdescription")
  return([self.description cStringUsingEncoding:NSASCIIStringEncoding]);}
-(WICtxt*)classInCtxt {MSGSTART("WIClass:-(WICtxt*)classInCtxt")
  return((WICtxt*)v_classInCtxt_endpoint.value);}
-(Endpoint1*)classInCtxt_endpoint {MSGSTART("WIClass:-(Endpoint1*)classInCtxt_endpoint")
  
  /*i-999*/Endpoint1* ret=v_classInCtxt_endpoint;
  /*i999*/return(ret);}
-(NSObject<LinkEndpoint>*)classInCtxtToEndpoint:(id)aclassInCtxt {MSGSTART("WIClass:-(NSObject<LinkEndpoint>*)classInCtxtToEndpoint:(id)aclassInCtxt")
  return([aclassInCtxt performSelector:@selector(clazzs)]);}
-(constchar*)cobjectName {MSGSTART("WIClass:-(constchar*)cobjectName")
  return([self.objectName cStringUsingEncoding:NSASCIIStringEncoding]);}
-(EndpointS*)conformedProtocols {MSGSTART("WIClass:-(EndpointS*)conformedProtocols")
  
  /*i-999*/EndpointS* ret=v_conformedProtocols;
  /*i999*/return(ret);}
-(NSObject<LinkEndpoint>*)conformedProtocolToEndpoint:(id)aconformedProtocol {MSGSTART("WIClass:-(NSObject<LinkEndpoint>*)conformedProtocolToEndpoint:(id)aconformedProtocol")
  return([aconformedProtocol performSelector:@selector(conformingClasss)]);}
-(EndpointS*)conformingClasss {MSGSTART("WIClass:-(EndpointS*)conformingClasss")
  
  /*i-999*/EndpointS* ret=v_conformingClasss;
  /*i999*/return(ret);}
-(NSObject<LinkEndpoint>*)conformingClassToEndpoint:(id)aconformingClass {MSGSTART("WIClass:-(NSObject<LinkEndpoint>*)conformingClassToEndpoint:(id)aconformingClass")
  return([aconformingClass performSelector:@selector(conformedProtocols)]);}
-(WICtxt*)context {MSGSTART("WIClass:-(WICtxt*)context")
  return(self.classInCtxt?self.classInCtxt:self.protocolInCtxt);}
-(void)dealloc {MSGSTART("WIClass:-(void)dealloc")
...
/*i999*/}
-(NSString*)description {MSGSTART("WIClass:-(NSString*)description")
  
  /*i-999*/NSMutableString *ret=self.objectName;
          
  /*i999*/return(ret);
    }
-(NSString*)descriptiveName {MSGSTART("WIClass:-(NSString*)descriptiveName")
...
-(void)die {MSGSTART("WIClass:-(void)die")
  ...
  /*i900*/}
-(WIType*)equivTypeTo:(WIType*)other {MSGSTART("WIClass:-(WIType*)equivTypeTo:(WIType*)other")

          return([self typeWithModifiers:(NSArray*)other.keyInClazz]);
    }
-(WIVarContext*)equivVarContextTo:(WIVarContext*)other {MSGSTART("WIClass:-(WIVarContext*)equivVarContextTo:(WIVarContext*)other")

          return([self varCtxtWithSettings:(NSSet*)other.keyInClazz]);
    }
-(WIVar*)equivVarTo:(WIVar*)other {MSGSTART("WIClass:-(WIVar*)equivVarTo:(WIVar*)other")

          return([[self equivVarContextTo:other.context] equivVarTo:other]);
    }
-(WIFile*)file {MSGSTART("WIClass:-(WIFile*)file")
  return(self.context.file);}
-(WIClass*)init {MSGSTART("WIClass:-(WIClass*)init")
...
/*i10001*/return(self);}
-(NSNumber*)isAcceptableClassInCtxt:(id)aclassInCtxt {MSGSTART("WIClass:-(NSNumber*)isAcceptableClassInCtxt:(id)aclassInCtxt")
  return([aclassInCtxt isKindOfClass:[WICtxt class]]?@YES:nil);}
-(NSNumber*)isAcceptableConformedProtocol:(id)aconformedProtocol {MSGSTART("WIClass:-(NSNumber*)isAcceptableConformedProtocol:(id)aconformedProtocol")
  return([aconformedProtocol isKindOfClass:[WIClass class]]?@YES:nil);}
-(NSNumber*)isAcceptableConformingClass:(id)aconformingClass {MSGSTART("WIClass:-(NSNumber*)isAcceptableConformingClass:(id)aconformingClass")
  return([aconformingClass isKindOfClass:[WIClass class]]?@YES:nil);}
-(NSNumber*)isAcceptableProtocolInCtxt:(id)aprotocolInCtxt {MSGSTART("WIClass:-(NSNumber*)isAcceptableProtocolInCtxt:(id)aprotocolInCtxt")
  return([aprotocolInCtxt isKindOfClass:[WICtxt class]]?@YES:nil);}
-(NSNumber*)isAcceptableSubclass:(id)asubclass {MSGSTART("WIClass:-(NSNumber*)isAcceptableSubclass:(id)asubclass")
  return([asubclass isKindOfClass:[WIClass class]]?@YES:nil);}
-(NSNumber*)isAcceptableSubprotocol:(id)asubprotocol {MSGSTART("WIClass:-(NSNumber*)isAcceptableSubprotocol:(id)asubprotocol")
  return([asubprotocol isKindOfClass:[WIClass class]]?@YES:nil);}
-(NSNumber*)isAcceptableSuperclass:(id)asuperclass {MSGSTART("WIClass:-(NSNumber*)isAcceptableSuperclass:(id)asuperclass")
  return([asuperclass isKindOfClass:[WIClass class]]?@YES:nil);}
-(NSNumber*)isAcceptableSuperprotocol:(id)asuperprotocol {MSGSTART("WIClass:-(NSNumber*)isAcceptableSuperprotocol:(id)asuperprotocol")
  return([asuperprotocol isKindOfClass:[WIClass class]]?@YES:nil);}
-(NSNumber*)isAcceptableType:(id)atype {MSGSTART("WIClass:-(NSNumber*)isAcceptableType:(id)atype")
  return([atype isKindOfClass:[WIType class]]?@YES:nil);}
-(NSNumber*)isAcceptableVarCtxt:(id)avarCtxt {MSGSTART("WIClass:-(NSNumber*)isAcceptableVarCtxt:(id)avarCtxt")
  return([avarCtxt isKindOfClass:[WIVarContext class]]?@YES:nil);}
-(kid)keyInClassInCtxt {MSGSTART("WIClass:-(kid)keyInClassInCtxt")

              for (id<NSCopying> key in self.keysInClassInCtxt) return(key);
              return(nil);
        }
-(kid)keyInProtocolInCtxt {MSGSTART("WIClass:-(kid)keyInProtocolInCtxt")

              for (id<NSCopying> key in self.keysInProtocolInCtxt) return(key);
              return(nil);
        }
-(NSSet*)keysInClassInCtxt {MSGSTART("WIClass:-(NSSet*)keysInClassInCtxt")
...
-(NSSet*)keysInProtocolInCtxt {MSGSTART("WIClass:-(NSSet*)keysInProtocolInCtxt")
...
-(void)mergeWith:(WIClass*)other {MSGSTART("WIClass:-(void)mergeWith:(WIClass*)other")
...
-(NSString*)name {MSGSTART("WIClass:-(NSString*)name")
  return(NSString*)(self.classInCtxt?self.keyInClassInCtxt:self.keyInProtocolInCtxt);}
-(NSMutableString*)objectName {MSGSTART("WIClass:-(NSMutableString*)objectName")
...
#ifndef __SWIFT__
-(void)process:(Token*)token regexes:(NSMutableArray*)regexes settings:(NSSet*)settings doingInitialSettings:(bool&)doingInitialSettings outerClass:(WIClass*)outerClass outerLinkType:(NSString*)outerLinkType outerLinkVar:(WIVar*)outerLinkVar mods:(NSArray*)mods {MSGSTART("WIClass:-(void)process:(Token*)token regexes:(NSMutableArray*)regexes settings:(NSSet*)settings doingInitialSettings:(bool&)doingInitialSettings outerClass:(WIClass*)outerClass outerLinkType:(NSString*)outerLinkType outerLinkVar:(WIVar*)outerLinkVar mods:(NSArray*)mods")
          ...
          if ((chs=[TokenHelper childrenForToken:token havingRuleIn:@[@"setting"]])) {
                ...
                if (t==token) {
                      ...
                      for (Token *ch in chs) [self process:ch regexes:newRegexes settings:settings doingInitialSettings:doingInitialSettings outerClass:outerClass outerLinkType:outerLinkType outerLinkVar:outerLinkVar mods:mods];
                  }
            }
...
#endif// __SWIFT__
-(WICtxt*)protocolInCtxt {MSGSTART("WIClass:-(WICtxt*)protocolInCtxt")
  return((WICtxt*)v_protocolInCtxt_endpoint.value);}
-(Endpoint1*)protocolInCtxt_endpoint {MSGSTART("WIClass:-(Endpoint1*)protocolInCtxt_endpoint")
  
  /*i-999*/Endpoint1* ret=v_protocolInCtxt_endpoint;
  /*i999*/return(ret);}
-(NSObject<LinkEndpoint>*)protocolInCtxtToEndpoint:(id)aprotocolInCtxt {MSGSTART("WIClass:-(NSObject<LinkEndpoint>*)protocolInCtxtToEndpoint:(id)aprotocolInCtxt")
  return([aprotocolInCtxt performSelector:@selector(protocols)]);}
-(void)removeAllConformedProtocols {MSGSTART("WIClass:-(void)removeAllConformedProtocols")
  [v_conformedProtocols removeAllObjects];}
-(void)removeAllConformingClasss {MSGSTART("WIClass:-(void)removeAllConformingClasss")
  [v_conformingClasss removeAllObjects];}
-(void)removeAllSubclasss {MSGSTART("WIClass:-(void)removeAllSubclasss")
  [v_subclasss removeAllObjects];}
-(void)removeAllSubprotocols {MSGSTART("WIClass:-(void)removeAllSubprotocols")
  [v_subprotocols removeAllObjects];}
-(void)removeAllSuperclasss {MSGSTART("WIClass:-(void)removeAllSuperclasss")
  [v_superclasss removeAllObjects];}
-(void)removeAllSuperprotocols {MSGSTART("WIClass:-(void)removeAllSuperprotocols")
  [v_superprotocols removeAllObjects];}
-(void)removeAllTypes {MSGSTART("WIClass:-(void)removeAllTypes")
  [v_types removeAllObjects];}
-(void)removeAllVarCtxts {MSGSTART("WIClass:-(void)removeAllVarCtxts")
  [v_varCtxts removeAllObjects];}
-(void)removeConformedProtocol:(WIClass*)v {MSGSTART("WIClass:-(void)removeConformedProtocol:(WIClass*)v")
  [v_conformedProtocols removeObject:v];}
-(void)removeConformingClass:(WIClass*)v {MSGSTART("WIClass:-(void)removeConformingClass:(WIClass*)v")
  [v_conformingClasss removeObject:v];}
-(void)removeSubclass:(WIClass*)v {MSGSTART("WIClass:-(void)removeSubclass:(WIClass*)v")
  [v_subclasss removeObject:v];}
-(void)removeSubprotocol:(WIClass*)v {MSGSTART("WIClass:-(void)removeSubprotocol:(WIClass*)v")
  [v_subprotocols removeObject:v];}
-(void)removeSuperclass:(WIClass*)v {MSGSTART("WIClass:-(void)removeSuperclass:(WIClass*)v")
  [v_superclasss removeObject:v];}
-(void)removeSuperprotocol:(WIClass*)v {MSGSTART("WIClass:-(void)removeSuperprotocol:(WIClass*)v")
  [v_superprotocols removeObject:v];}
-(void)removeTypeForKey:(id<NSCopying>)key {MSGSTART("WIClass:-(void)removeTypeForKey:(id<NSCopying>)key")
  [v_types removeObjectForKey:key];}
-(void)removeVarCtxtForKey:(id<NSCopying>)key {MSGSTART("WIClass:-(void)removeVarCtxtForKey:(id<NSCopying>)key")
  [v_varCtxts removeObjectForKey:key];}
-(void)retract {MSGSTART("WIClass:-(void)retract")
  self.classInCtxt=nil;
  self.protocolInCtxt=nil;
  [self.superclasss removeAllObjects];
  [self.subclasss removeAllObjects];
...
-(NSDictionary*)seenTreeNodeData {MSGSTART("WIClass:-(NSDictionary*)seenTreeNodeData")
  
  /*i-999*/NSDictionary *ret=nil;
  /*i999*/return(ret?ret:self.treeNodeData);}
-(void)setClassInCtxt:(WICtxt*)v {MSGSTART("WIClass:-(void)setClassInCtxt:(WICtxt*)v")
  [v_classInCtxt_endpoint setValue:v];}
-(void)setClassInCtxt_endpoint:(Endpoint1*)v {MSGSTART("WIClass:-(void)setClassInCtxt_endpoint:(Endpoint1*)v")
  ...
  /*i-900*/{v_classInCtxt_endpoint=(id)v;}
/*i-850*/REMOVEOWNER(v_classInCtxt_endpoint,self);ADDOWNER(v,self);}
-(void)setConformedProtocols:(EndpointS*)v {MSGSTART("WIClass:-(void)setConformedProtocols:(EndpointS*)v")
  ...
  /*i-900*/{v_conformedProtocols=(id)v;}
/*i-850*/REMOVEOWNER(v_conformedProtocols,self);ADDOWNER(v,self);}
-(void)setConformingClasss:(EndpointS*)v {MSGSTART("WIClass:-(void)setConformingClasss:(EndpointS*)v")
  ...
  /*i-900*/{v_conformingClasss=(id)v;}
/*i-850*/REMOVEOWNER(v_conformingClasss,self);ADDOWNER(v,self);}
-(void)setKeyInClassInCtxt:(kid)v {MSGSTART("WIClass:-(void)setKeyInClassInCtxt:(kid)v")

              self.keysInClassInCtxt=[NSSet setWithObject:v];
        }
-(void)setKeyInProtocolInCtxt:(kid)v {MSGSTART("WIClass:-(void)setKeyInProtocolInCtxt:(kid)v")

              self.keysInProtocolInCtxt=[NSSet setWithObject:v];
        }
-(void)setKeysInClassInCtxt:(NSSet*)v {MSGSTART("WIClass:-(void)setKeysInClassInCtxt:(NSSet*)v")
              ...
              if ([Util getInsertsAndDeletesForSetWhenChanging:classInCtxt_keys_were to:v inss:&classInCtxt_inss dels:&classInCtxt_dels]) {
                    for (id<NSCopying> key in classInCtxt_dels) [classInCtxt_ep removeObjectForKey:key];
                    for (id<NSCopying> key in classInCtxt_inss) [classInCtxt_ep setObject:self forKey:key];
                }
        }
-(void)setKeysInProtocolInCtxt:(NSSet*)v {MSGSTART("WIClass:-(void)setKeysInProtocolInCtxt:(NSSet*)v")
              ...
              if ([Util getInsertsAndDeletesForSetWhenChanging:protocolInCtxt_keys_were to:v inss:&protocolInCtxt_inss dels:&protocolInCtxt_dels]) {
                    for (id<NSCopying> key in protocolInCtxt_dels) [protocolInCtxt_ep removeObjectForKey:key];
                    for (id<NSCopying> key in protocolInCtxt_inss) [protocolInCtxt_ep setObject:self forKey:key];
                }
        }
-(void)setProtocolInCtxt:(WICtxt*)v {MSGSTART("WIClass:-(void)setProtocolInCtxt:(WICtxt*)v")
  [v_protocolInCtxt_endpoint setValue:v];}
-(void)setProtocolInCtxt_endpoint:(Endpoint1*)v {MSGSTART("WIClass:-(void)setProtocolInCtxt_endpoint:(Endpoint1*)v")
  ...
  /*i-900*/{v_protocolInCtxt_endpoint=(id)v;}
/*i-850*/REMOVEOWNER(v_protocolInCtxt_endpoint,self);ADDOWNER(v,self);}
-(void)setSettings:(MutableDictionary*)v {MSGSTART("WIClass:-(void)setSettings:(MutableDictionary*)v")
  
  /*i-905*/if(v_settings==v)return;
  /*i-900*/{v_settings=(id)v;}
/*i-850*/REMOVEOWNER(v_settings,self);ADDOWNER(v,self);}
-(void)setSubclasss:(EndpointS*)v {MSGSTART("WIClass:-(void)setSubclasss:(EndpointS*)v")
  ...
  /*i-900*/{v_subclasss=(id)v;}
/*i-850*/REMOVEOWNER(v_subclasss,self);ADDOWNER(v,self);}
-(void)setSubprotocols:(EndpointS*)v {MSGSTART("WIClass:-(void)setSubprotocols:(EndpointS*)v")
  ...
  /*i-900*/{v_subprotocols=(id)v;}
/*i-850*/REMOVEOWNER(v_subprotocols,self);ADDOWNER(v,self);}
-(void)setSuperclasss:(EndpointS*)v {MSGSTART("WIClass:-(void)setSuperclasss:(EndpointS*)v")
  ...
  /*i-900*/{v_superclasss=(id)v;}
/*i-850*/REMOVEOWNER(v_superclasss,self);ADDOWNER(v,self);}
-(void)setSuperprotocols:(EndpointS*)v {MSGSTART("WIClass:-(void)setSuperprotocols:(EndpointS*)v")
  ...
  /*i-900*/{v_superprotocols=(id)v;}
/*i-850*/REMOVEOWNER(v_superprotocols,self);ADDOWNER(v,self);}
-(MutableDictionary*)settings {MSGSTART("WIClass:-(MutableDictionary*)settings")
  
  /*i-999*/MutableDictionary* ret=v_settings;
  /*i999*/return(ret);}
-(void)setType:(id)v forKey:(id<NSCopying>)key {MSGSTART("WIClass:-(void)setType:(id)v forKey:(id<NSCopying>)key")
  [v_types setObject:v forKey:key];}
-(void)setTypes:(EndpointD*)v {MSGSTART("WIClass:-(void)setTypes:(EndpointD*)v")
...
-(void)setVarCtxt:(id)v forKey:(id<NSCopying>)key {MSGSTART("WIClass:-(void)setVarCtxt:(id)v forKey:(id<NSCopying>)key")
  [v_varCtxts setObject:v forKey:key];}
-(void)setVarCtxts:(EndpointD*)v {MSGSTART("WIClass:-(void)setVarCtxts:(EndpointD*)v")
  ...
  /*i-900*/{v_varCtxts=(id)v;}
/*i-850*/REMOVEOWNER(v_varCtxts,self);ADDOWNER(v,self);}
-(EndpointS*)subclasss {MSGSTART("WIClass:-(EndpointS*)subclasss")
  
  /*i-999*/EndpointS* ret=v_subclasss;
  /*i999*/return(ret);}
-(NSObject<LinkEndpoint>*)subclassToEndpoint:(id)asubclass {MSGSTART("WIClass:-(NSObject<LinkEndpoint>*)subclassToEndpoint:(id)asubclass")
  return([asubclass performSelector:@selector(superclasss)]);}
-(EndpointS*)subprotocols {MSGSTART("WIClass:-(EndpointS*)subprotocols")
  
  /*i-999*/EndpointS* ret=v_subprotocols;
  /*i999*/return(ret);}
-(NSObject<LinkEndpoint>*)subprotocolToEndpoint:(id)asubprotocol {MSGSTART("WIClass:-(NSObject<LinkEndpoint>*)subprotocolToEndpoint:(id)asubprotocol")
  return([asubprotocol performSelector:@selector(superprotocols)]);}
-(EndpointS*)superclasss {MSGSTART("WIClass:-(EndpointS*)superclasss")
  
  /*i-999*/EndpointS* ret=v_superclasss;
  /*i999*/return(ret);}
-(NSObject<LinkEndpoint>*)superclassToEndpoint:(id)asuperclass {MSGSTART("WIClass:-(NSObject<LinkEndpoint>*)superclassToEndpoint:(id)asuperclass")
  return([asuperclass performSelector:@selector(subclasss)]);}
-(EndpointS*)superprotocols {MSGSTART("WIClass:-(EndpointS*)superprotocols")
  
  /*i-999*/EndpointS* ret=v_superprotocols;
  /*i999*/return(ret);}
-(NSObject<LinkEndpoint>*)superprotocolToEndpoint:(id)asuperprotocol {MSGSTART("WIClass:-(NSObject<LinkEndpoint>*)superprotocolToEndpoint:(id)asuperprotocol")
  return([asuperprotocol performSelector:@selector(subprotocols)]);}
-(NSDictionary*)treeNodeData {MSGSTART("WIClass:-(NSDictionary*)treeNodeData")
  ...
  /*i999*/return(ret?ret:@{});}
-(NSSet*)treePropertyNames {MSGSTART("WIClass:-(NSSet*)treePropertyNames")
  ...
  /*i-100*/if (!retSet) {NSArray *ret=nil;
    ...
    /*i100*/retSet=[NSSet setWithArray:ret?ret:@[]];}
  /*i999*/return(retSet);}
-(NSSet*)treeSingleNodePropertyNames {MSGSTART("WIClass:-(NSSet*)treeSingleNodePropertyNames")
  ...
  /*i-100*/if (!retSet) {NSArray *ret=nil;
    ...
    /*i100*/retSet=[NSSet setWithArray:ret?ret:@[]];}
  /*i999*/return(retSet);}
-(WIType*)typeForKey:(id<NSCopying>)key {MSGSTART("WIClass:-(WIType*)typeForKey:(id<NSCopying>)key")
  return([v_types objectForKey:key]);}
-(EndpointD*)types {MSGSTART("WIClass:-(EndpointD*)types")
  
  /*i-999*/EndpointD* ret=v_types;
  /*i999*/return(ret);}
-(NSObject<LinkEndpoint>*)typeToEndpoint:(id)atype {MSGSTART("WIClass:-(NSObject<LinkEndpoint>*)typeToEndpoint:(id)atype")
  return([atype performSelector:@selector(clazz_endpoint)]);}
-(WIType*)typeWithModifiers:(NSArray*)mods {MSGSTART("WIClass:-(WIType*)typeWithModifiers:(NSArray*)mods")

          WIType *ret=[self typeForKey:mods];
          if (!ret) [self setType:ret=[WIType new] forKey:mods.copy];
          return(ret);
    }
-(WIVarContext*)varCtxtForKey:(id<NSCopying>)key {MSGSTART("WIClass:-(WIVarContext*)varCtxtForKey:(id<NSCopying>)key")
  return([v_varCtxts objectForKey:key]);}
-(EndpointD*)varCtxts {MSGSTART("WIClass:-(EndpointD*)varCtxts")
  
  /*i-999*/EndpointD* ret=v_varCtxts;
  /*i999*/return(ret);}
-(NSObject<LinkEndpoint>*)varCtxtToEndpoint:(id)avarCtxt {MSGSTART("WIClass:-(NSObject<LinkEndpoint>*)varCtxtToEndpoint:(id)avarCtxt")
  return([avarCtxt performSelector:@selector(clazz_endpoint)]);}
-(WIVarContext*)varCtxtWithSettings:(NSSet*)settings {MSGSTART("WIClass:-(WIVarContext*)varCtxtWithSettings:(NSSet*)settings")
...
@synthesize objectIDInClass=objectIDInClass;
@synthesize objectIDInTotal=objectIDInTotal;
-(void)_startObjectOfClassWICtxt {MSGSTART("WICtxt:-(void)_startObjectOfClassWICtxt")
  ...
  /*i0*/}
-(void)addClassesForRegexedProtocolsTo:(NSMutableDictionary*)classesForRegexedProtocols {MSGSTART("WICtxt:-(void)addClassesForRegexedProtocolsTo:(NSMutableDictionary*)classesForRegexedProtocols")
...
-(void)applyRegexes {MSGSTART("WICtxt:-(void)applyRegexes")
...
-(NSDictionary*)asD3Tree {MSGSTART("WICtxt:-(NSDictionary*)asD3Tree")
  return([Treeable asD3Tree:self.asTree]);}
-(NSString*)asD3TreeJSON {MSGSTART("WICtxt:-(NSString*)asD3TreeJSON")

          NSError *err=nil;
          return([[NSString alloc] initWithData:[NSJSONSerialization dataWithJSONObject:self.asD3Tree options:0 error:&err] encoding:NSUTF8StringEncoding]);
    }
-(NSDictionary*)asTree {MSGSTART("WICtxt:-(NSDictionary*)asTree")
  return([self asTree:NSMutableSet.set]);}
-(NSMutableDictionary*)asTree:(NSMutableSet*)seen {MSGSTART("WICtxt:-(NSMutableDictionary*)asTree:(NSMutableSet*)seen")

          return(([Treeable asTree:seen object:self]));
    }
-(constchar*)cdescription {MSGSTART("WICtxt:-(constchar*)cdescription")
  return([self.description cStringUsingEncoding:NSASCIIStringEncoding]);}
-(WIClass*)classWithName:(NSString*)name {MSGSTART("WICtxt:-(WIClass*)classWithName:(NSString*)name")

          WIClass *ret=[self clazzForKey:name];
          if (!ret) [self setClazz:ret=[WIClass new] forKey:name.copy];
          return(ret);
    }
-(WIClass*)clazzForKey:(id<NSCopying>)key {MSGSTART("WICtxt:-(WIClass*)clazzForKey:(id<NSCopying>)key")
  return([v_clazzs objectForKey:key]);}
-(EndpointD*)clazzs {MSGSTART("WICtxt:-(EndpointD*)clazzs")
  
  /*i-999*/EndpointD* ret=v_clazzs;
  /*i999*/return(ret);}
-(NSObject<LinkEndpoint>*)clazzToEndpoint:(id)aclazz {MSGSTART("WICtxt:-(NSObject<LinkEndpoint>*)clazzToEndpoint:(id)aclazz")
  return([aclazz performSelector:@selector(classInCtxt_endpoint)]);}
-(constchar*)cobjectName {MSGSTART("WICtxt:-(constchar*)cobjectName")
  return([self.objectName cStringUsingEncoding:NSASCIIStringEncoding]);}
-(void)dealloc {MSGSTART("WICtxt:-(void)dealloc")
...
/*i999*/}
-(NSString*)description {MSGSTART("WICtxt:-(NSString*)description")
  
  /*i-999*/NSMutableString *ret=self.objectName;
          
  /*i999*/return(ret);
    }
-(void)die {MSGSTART("WICtxt:-(void)die")
  self.file=nil;
  [v_clazzs removeAllObjects];
  [v_protocols removeAllObjects];
  
  /*i900*/}
-(WIClass*)equivClassTo:(WIClass*)other {MSGSTART("WICtxt:-(WIClass*)equivClassTo:(WIClass*)other")
...
-(WIType*)equivTypeTo:(WIType*)other {MSGSTART("WICtxt:-(WIType*)equivTypeTo:(WIType*)other")

          return([[self equivClassTo:other.clazz] equivTypeTo:other]);
    }
-(WIVarContext*)equivVarContextTo:(WIVarContext*)other {MSGSTART("WICtxt:-(WIVarContext*)equivVarContextTo:(WIVarContext*)other")

          return([[self equivClassTo:other.clazz] equivVarContextTo:other]);
    }
-(WIVar*)equivVarTo:(WIVar*)other {MSGSTART("WICtxt:-(WIVar*)equivVarTo:(WIVar*)other")

          return([[self equivClassTo:other.context.clazz] equivVarTo:other]);
    }
-(WIFile*)file {MSGSTART("WICtxt:-(WIFile*)file")
  return((WIFile*)v_file_endpoint.value);}
-(Endpoint1*)file_endpoint {MSGSTART("WICtxt:-(Endpoint1*)file_endpoint")
  
  /*i-999*/Endpoint1* ret=v_file_endpoint;
  /*i999*/return(ret);}
-(NSObject<LinkEndpoint>*)fileToEndpoint:(id)afile {MSGSTART("WICtxt:-(NSObject<LinkEndpoint>*)fileToEndpoint:(id)afile")
  return([afile performSelector:@selector(ctxts)]);}
-(WICtxt*)init {MSGSTART("WICtxt:-(WICtxt*)init")
...
/*i10001*/return(self);}
-(NSNumber*)isAcceptableClazz:(id)aclazz {MSGSTART("WICtxt:-(NSNumber*)isAcceptableClazz:(id)aclazz")
  return([aclazz isKindOfClass:[WIClass class]]?@YES:nil);}
-(NSNumber*)isAcceptableFile:(id)afile {MSGSTART("WICtxt:-(NSNumber*)isAcceptableFile:(id)afile")
  return([afile isKindOfClass:[WIFile class]]?@YES:nil);}
-(NSNumber*)isAcceptableProtocol:(id)aprotocol {MSGSTART("WICtxt:-(NSNumber*)isAcceptableProtocol:(id)aprotocol")
  return([aprotocol isKindOfClass:[WIClass class]]?@YES:nil);}
-(kid)keyInFile {MSGSTART("WICtxt:-(kid)keyInFile")

              for (id<NSCopying> key in self.keysInFile) return(key);
              return(nil);
        }
-(NSSet*)keysInFile {MSGSTART("WICtxt:-(NSSet*)keysInFile")
...
-(void)mergeWith:(WICtxt*)other {MSGSTART("WICtxt:-(void)mergeWith:(WICtxt*)other")
...
-(NSMutableString*)objectName {MSGSTART("WICtxt:-(NSMutableString*)objectName")
...
-(void)process:(Token*)token regexes:(NSMutableArray*)regexes settings:(NSSet*)settings outerClass:(WIClass*)outerClass outerLinkType:(NSString*)outerLinkType outerLinkVar:(WIVar*)outerLinkVar mods:(NSArray*)mods {MSGSTART("WICtxt:-(void)process:(Token*)token regexes:(NSMutableArray*)regexes settings:(NSSet*)settings outerClass:(WIClass*)outerClass outerLinkType:(NSString*)outerLinkType outerLinkVar:(WIVar*)outerLinkVar mods:(NSArray*)mods")
...
-(WIClass*)protocolForKey:(id<NSCopying>)key {MSGSTART("WICtxt:-(WIClass*)protocolForKey:(id<NSCopying>)key")
  return([v_protocols objectForKey:key]);}
-(EndpointD*)protocols {MSGSTART("WICtxt:-(EndpointD*)protocols")
  
  /*i-999*/EndpointD* ret=v_protocols;
  /*i999*/return(ret);}
-(NSObject<LinkEndpoint>*)protocolToEndpoint:(id)aprotocol {MSGSTART("WICtxt:-(NSObject<LinkEndpoint>*)protocolToEndpoint:(id)aprotocol")
  return([aprotocol performSelector:@selector(protocolInCtxt_endpoint)]);}
-(WIClass*)protocolWithName:(NSString*)name {MSGSTART("WICtxt:-(WIClass*)protocolWithName:(NSString*)name")

          WIClass *ret=[self protocolForKey:name];
          if (!ret) [self setProtocol:ret=[WIClass new] forKey:name.copy];
          return(ret);
    }
-(void)removeAllClazzs {MSGSTART("WICtxt:-(void)removeAllClazzs")
  [v_clazzs removeAllObjects];}
-(void)removeAllProtocols {MSGSTART("WICtxt:-(void)removeAllProtocols")
  [v_protocols removeAllObjects];}
-(void)removeClazzForKey:(id<NSCopying>)key {MSGSTART("WICtxt:-(void)removeClazzForKey:(id<NSCopying>)key")
  [v_clazzs removeObjectForKey:key];}
-(void)removeProtocolForKey:(id<NSCopying>)key {MSGSTART("WICtxt:-(void)removeProtocolForKey:(id<NSCopying>)key")
  [v_protocols removeObjectForKey:key];}
-(void)retract {MSGSTART("WICtxt:-(void)retract")
  self.file=nil;
  [self.clazzs removeAllObjects];
  [self.protocols removeAllObjects];}
-(NSDictionary*)seenTreeNodeData {MSGSTART("WICtxt:-(NSDictionary*)seenTreeNodeData")
  
  /*i-999*/NSDictionary *ret=nil;
  /*i999*/return(ret?ret:self.treeNodeData);}
-(void)setClazz:(id)v forKey:(id<NSCopying>)key {MSGSTART("WICtxt:-(void)setClazz:(id)v forKey:(id<NSCopying>)key")
  [v_clazzs setObject:v forKey:key];}
-(void)setClazzs:(EndpointD*)v {MSGSTART("WICtxt:-(void)setClazzs:(EndpointD*)v")
...
-(void)setFile:(WIFile*)v {MSGSTART("WICtxt:-(void)setFile:(WIFile*)v")
  [v_file_endpoint setValue:v];}
-(void)setFile_endpoint:(Endpoint1*)v {MSGSTART("WICtxt:-(void)setFile_endpoint:(Endpoint1*)v")
  ...
  /*i-900*/{v_file_endpoint=(id)v;}
/*i-850*/REMOVEOWNER(v_file_endpoint,self);ADDOWNER(v,self);}
-(void)setKeyInFile:(kid)v {MSGSTART("WICtxt:-(void)setKeyInFile:(kid)v")

              self.keysInFile=[NSSet setWithObject:v];
        }
-(void)setKeysInFile:(NSSet*)v {MSGSTART("WICtxt:-(void)setKeysInFile:(NSSet*)v")
              ...
              if ([Util getInsertsAndDeletesForSetWhenChanging:file_keys_were to:v inss:&file_inss dels:&file_dels]) {
                    for (id<NSCopying> key in file_dels) [file_ep removeObjectForKey:key];
                    for (id<NSCopying> key in file_inss) [file_ep setObject:self forKey:key];
                }
        }
-(void)setProtocol:(id)v forKey:(id<NSCopying>)key {MSGSTART("WICtxt:-(void)setProtocol:(id)v forKey:(id<NSCopying>)key")
  [v_protocols setObject:v forKey:key];}
-(void)setProtocols:(EndpointD*)v {MSGSTART("WICtxt:-(void)setProtocols:(EndpointD*)v")
  ...
  /*i-900*/{v_protocols=(id)v;}
/*i-850*/REMOVEOWNER(v_protocols,self);ADDOWNER(v,self);}
-(NSDictionary*)treeNodeData {MSGSTART("WICtxt:-(NSDictionary*)treeNodeData")
  ...
  /*i999*/return(ret?ret:@{});}
-(NSSet*)treePropertyNames {MSGSTART("WICtxt:-(NSSet*)treePropertyNames")
  ...
  /*i-100*/if (!retSet) {NSArray *ret=nil;
    ...
    /*i100*/retSet=[NSSet setWithArray:ret?ret:@[]];}
  /*i999*/return(retSet);}
-(NSSet*)treeSingleNodePropertyNames {MSGSTART("WICtxt:-(NSSet*)treeSingleNodePropertyNames")
...
@synthesize objectIDInClass=objectIDInClass;
@synthesize objectIDInTotal=objectIDInTotal;
-(void)_startObjectOfClassWIFile {MSGSTART("WIFile:-(void)_startObjectOfClassWIFile")
  ...
  /*i0*/}
-(void)applyRegexes {MSGSTART("WIFile:-(void)applyRegexes")
...
-(NSDictionary*)asD3Tree {MSGSTART("WIFile:-(NSDictionary*)asD3Tree")
  return([Treeable asD3Tree:self.asTree]);}
-(NSString*)asD3TreeJSON {MSGSTART("WIFile:-(NSString*)asD3TreeJSON")

          NSError *err=nil;
          return([[NSString alloc] initWithData:[NSJSONSerialization dataWithJSONObject:self.asD3Tree options:0 error:&err] encoding:NSUTF8StringEncoding]);
    }
-(NSDictionary*)asTree {MSGSTART("WIFile:-(NSDictionary*)asTree")
  return([self asTree:NSMutableSet.set]);}
-(NSMutableDictionary*)asTree:(NSMutableSet*)seen {MSGSTART("WIFile:-(NSMutableDictionary*)asTree:(NSMutableSet*)seen")

          return(([Treeable asTree:seen object:self]));
    }
-(constchar*)cdescription {MSGSTART("WIFile:-(constchar*)cdescription")
  return([self.description cStringUsingEncoding:NSASCIIStringEncoding]);}
-(constchar*)cobjectName {MSGSTART("WIFile:-(constchar*)cobjectName")
  return([self.objectName cStringUsingEncoding:NSASCIIStringEncoding]);}
-(WICtxt*)contextWithRegexes:(NSArray*)regexes {MSGSTART("WIFile:-(WICtxt*)contextWithRegexes:(NSArray*)regexes")

          WICtxt *ret=[self ctxtForKey:regexes];
          if (!ret) [self setCtxt:ret=[WICtxt new] forKey:regexes.copy];
          return(ret);
    }
-(void)copyConformedProtocol:(NSString*)protocolName usingRegexes:(NSArray*)regexes classesForRegexedProtocols:(NSMutableDictionary*)classesForRegexedProtocols regexedProtocolsForClasses:(NSMutableDictionary*)regexedProtocolsForClasses {MSGSTART("WIFile:-(void)copyConformedProtocol:(NSString*)protocolName usingRegexes:(NSArray*)regexes classesForRegexedProtocols:(NSMutableDictionary*)classesForRegexedProtocols regexedProtocolsForClasses:(NSMutableDictionary*)regexedProtocolsForClasses")
...
-(WICtxt*)ctxtForKey:(id<NSCopying>)key {MSGSTART("WIFile:-(WICtxt*)ctxtForKey:(id<NSCopying>)key")
  return([v_ctxts objectForKey:key]);}
-(EndpointD*)ctxts {MSGSTART("WIFile:-(EndpointD*)ctxts")
  
  /*i-999*/EndpointD* ret=v_ctxts;
  /*i999*/return(ret);}
-(NSObject<LinkEndpoint>*)ctxtToEndpoint:(id)actxt {MSGSTART("WIFile:-(NSObject<LinkEndpoint>*)ctxtToEndpoint:(id)actxt")
  return([actxt performSelector:@selector(file_endpoint)]);}
-(void)dealloc {MSGSTART("WIFile:-(void)dealloc")
...
/*i999*/}
-(NSString*)description {MSGSTART("WIFile:-(NSString*)description")
  
  /*i-999*/NSMutableString *ret=self.objectName;
          
  /*i999*/return(ret);
    }
-(void)die {MSGSTART("WIFile:-(void)die")
  [v_ctxts removeAllObjects];
  
  /*i900*/}
-(WIClass*)equivClassTo:(WIClass*)other {MSGSTART("WIFile:-(WIClass*)equivClassTo:(WIClass*)other")

          return([[self equivContextTo:other.context] equivClassTo:other]);
    }
-(WICtxt*)equivContextTo:(WICtxt*)other {MSGSTART("WIFile:-(WICtxt*)equivContextTo:(WICtxt*)other")

          return([self contextWithRegexes:(NSArray*)other.keyInFile]);
    }
-(WIType*)equivTypeTo:(WIType*)other {MSGSTART("WIFile:-(WIType*)equivTypeTo:(WIType*)other")

          return([[self equivContextTo:other.clazz.context] equivTypeTo:other]);
    }
-(WIVarContext*)equivVarContextTo:(WIVarContext*)other {MSGSTART("WIFile:-(WIVarContext*)equivVarContextTo:(WIVarContext*)other")

          return([[self equivContextTo:other.clazz.context] equivVarContextTo:other]);
    }
-(WIVar*)equivVarTo:(WIVar*)other {MSGSTART("WIFile:-(WIVar*)equivVarTo:(WIVar*)other")

          return([[self equivContextTo:other.context.clazz.context] equivVarTo:other]);
    }
-(NSArray*)includes {MSGSTART("WIFile:-(NSArray*)includes")

          return(self.includesSet.asArray);
    }
-(PartiallyOrderedSet*)includesSet {MSGSTART("WIFile:-(PartiallyOrderedSet*)includesSet")
  
  /*i-999*/PartiallyOrderedSet* ret=v_includesSet;
  /*i999*/return(ret);}
-(WIFile*)init {MSGSTART("WIFile:-(WIFile*)init")
...
/*i10001*/return(self);}
-(NSNumber*)isAcceptableCtxt:(id)actxt {MSGSTART("WIFile:-(NSNumber*)isAcceptableCtxt:(id)actxt")
  return([actxt isKindOfClass:[WICtxt class]]?@YES:nil);}
-(void)mergeWith:(WIFile*)other {MSGSTART("WIFile:-(void)mergeWith:(WIFile*)other")
...
-(NSMutableString*)objectName {MSGSTART("WIFile:-(NSMutableString*)objectName")
...
-(void)process:(NSArray*)tokens {MSGSTART("WIFile:-(void)process:(NSArray*)tokens")
...
-(void)process:(Token*)token regexes:(NSMutableArray*)regexes settings:(NSSet*)settings {MSGSTART("WIFile:-(void)process:(Token*)token regexes:(NSMutableArray*)regexes settings:(NSSet*)settings")
          ...
          if ([TokenHelper actualToken:t havingRuleIn:@[@"class",@"protocol",@"classwprotocol",@"mod"]]) {
                ...
                if (t==token) {
                      ...
                      for (Token *ch in chs) [self process:ch regexes:newRegexes settings:settings];
                  }
            }
...
-(void)removeAllCtxts {MSGSTART("WIFile:-(void)removeAllCtxts")
  [v_ctxts removeAllObjects];}
-(void)removeCtxtForKey:(id<NSCopying>)key {MSGSTART("WIFile:-(void)removeCtxtForKey:(id<NSCopying>)key")
  [v_ctxts removeObjectForKey:key];}
-(void)retract {MSGSTART("WIFile:-(void)retract")
  [self.ctxts removeAllObjects];}
-(NSDictionary*)seenTreeNodeData {MSGSTART("WIFile:-(NSDictionary*)seenTreeNodeData")
  
  /*i-999*/NSDictionary *ret=nil;
  /*i999*/return(ret?ret:self.treeNodeData);}
-(void)setCtxt:(id)v forKey:(id<NSCopying>)key {MSGSTART("WIFile:-(void)setCtxt:(id)v forKey:(id<NSCopying>)key")
  [v_ctxts setObject:v forKey:key];}
-(void)setCtxts:(EndpointD*)v {MSGSTART("WIFile:-(void)setCtxts:(EndpointD*)v")
...
-(void)setIncludesSet:(PartiallyOrderedSet*)v {MSGSTART("WIFile:-(void)setIncludesSet:(PartiallyOrderedSet*)v")
  
  /*i-905*/if(v_includesSet==v)return;
  /*i-900*/{v_includesSet=(id)v;}
/*i-850*/REMOVEOWNER(v_includesSet,self);ADDOWNER(v,self);}
-(void)setSettings:(MutableDictionary*)v {MSGSTART("WIFile:-(void)setSettings:(MutableDictionary*)v")
  
  /*i-905*/if(v_settings==v)return;
  /*i-900*/{v_settings=(id)v;}
/*i-850*/REMOVEOWNER(v_settings,self);ADDOWNER(v,self);}
-(MutableDictionary*)settings {MSGSTART("WIFile:-(MutableDictionary*)settings")
  
  /*i-999*/MutableDictionary* ret=v_settings;
  /*i999*/return(ret);}
-(NSDictionary*)treeNodeData {MSGSTART("WIFile:-(NSDictionary*)treeNodeData")
  
  /*i-999*/NSDictionary *ret=nil;
  /*i0*/ret=@{@"type":@"File"};
  
  /*i999*/return(ret?ret:@{});}
-(NSSet*)treePropertyNames {MSGSTART("WIFile:-(NSSet*)treePropertyNames")
  ...
  /*i-100*/if (!retSet) {NSArray *ret=nil;
    ...
    /*i100*/retSet=[NSSet setWithArray:ret?ret:@[]];}
  /*i999*/return(retSet);}
-(NSSet*)treeSingleNodePropertyNames {MSGSTART("WIFile:-(NSSet*)treeSingleNodePropertyNames")
...
@synthesize objectIDInClass=objectIDInClass;
@synthesize objectIDInTotal=objectIDInTotal;
-(void)_startObjectOfClassWIType {MSGSTART("WIType:-(void)_startObjectOfClassWIType")
  ...
  /*i0*/}
-(void)addArg:(WIVarArg*)v {MSGSTART("WIType:-(void)addArg:(WIVarArg*)v")
  [v_args addObject:v];}
-(void)addVar:(WIVar*)v {MSGSTART("WIType:-(void)addVar:(WIVar*)v")
  [v_vars addObject:v];}
-(WIType*)applyRegexes:(NSArray*)regexes {MSGSTART("WIType:-(WIType*)applyRegexes:(NSArray*)regexes")

          WIClass *toc=[self.clazz applyRegexes];
          return([toc typeWithModifiers:(NSArray*)self.keyInClazz]);
    }
-(EndpointS*)args {MSGSTART("WIType:-(EndpointS*)args")
  
  /*i-999*/EndpointS* ret=v_args;
  /*i999*/return(ret);}
-(NSObject<LinkEndpoint>*)argToEndpoint:(id)aarg {MSGSTART("WIType:-(NSObject<LinkEndpoint>*)argToEndpoint:(id)aarg")
  return([aarg performSelector:@selector(type_endpoint)]);}
-(NSDictionary*)asD3Tree {MSGSTART("WIType:-(NSDictionary*)asD3Tree")
  return([Treeable asD3Tree:self.asTree]);}
-(NSString*)asD3TreeJSON {MSGSTART("WIType:-(NSString*)asD3TreeJSON")

          NSError *err=nil;
          return([[NSString alloc] initWithData:[NSJSONSerialization dataWithJSONObject:self.asD3Tree options:0 error:&err] encoding:NSUTF8StringEncoding]);
    }
-(NSDictionary*)asTree {MSGSTART("WIType:-(NSDictionary*)asTree")
  return([self asTree:NSMutableSet.set]);}
-(NSMutableDictionary*)asTree:(NSMutableSet*)seen {MSGSTART("WIType:-(NSMutableDictionary*)asTree:(NSMutableSet*)seen")

          return(([Treeable asTree:seen object:self]));
    }
-(constchar*)cdescription {MSGSTART("WIType:-(constchar*)cdescription")
  return([self.description cStringUsingEncoding:NSASCIIStringEncoding]);}
-(WIClass*)clazz {MSGSTART("WIType:-(WIClass*)clazz")
  return((WIClass*)v_clazz_endpoint.value);}
-(Endpoint1*)clazz_endpoint {MSGSTART("WIType:-(Endpoint1*)clazz_endpoint")
  
  /*i-999*/Endpoint1* ret=v_clazz_endpoint;
  /*i999*/return(ret);}
-(NSObject<LinkEndpoint>*)clazzToEndpoint:(id)aclazz {MSGSTART("WIType:-(NSObject<LinkEndpoint>*)clazzToEndpoint:(id)aclazz")
  return([aclazz performSelector:@selector(types)]);}
-(constchar*)cobjectName {MSGSTART("WIType:-(constchar*)cobjectName")
  return([self.objectName cStringUsingEncoding:NSASCIIStringEncoding]);}
-(void)dealloc {MSGSTART("WIType:-(void)dealloc")
...
/*i999*/}
-(NSString*)description {MSGSTART("WIType:-(NSString*)description")
  
  /*i-999*/NSMutableString *ret=self.objectName;
          
  /*i999*/return(ret);
    }
-(NSString*)descriptiveName {MSGSTART("WIType:-(NSString*)descriptiveName")
...
-(void)die {MSGSTART("WIType:-(void)die")
  self.clazz=nil;
  [v_vars removeAllObjects];
  [v_args removeAllObjects];
  
  /*i900*/}
-(WIFile*)file {MSGSTART("WIType:-(WIFile*)file")
  return(self.clazz.context.file);}
-(WIType*)init {MSGSTART("WIType:-(WIType*)init")
...
/*i10001*/return(self);}
-(NSNumber*)isAcceptableArg:(id)aarg {MSGSTART("WIType:-(NSNumber*)isAcceptableArg:(id)aarg")
  return([aarg isKindOfClass:[WIVarArg class]]?@YES:nil);}
-(NSNumber*)isAcceptableClazz:(id)aclazz {MSGSTART("WIType:-(NSNumber*)isAcceptableClazz:(id)aclazz")
  return([aclazz isKindOfClass:[WIClass class]]?@YES:nil);}
-(NSNumber*)isAcceptableVar:(id)avar {MSGSTART("WIType:-(NSNumber*)isAcceptableVar:(id)avar")
  return([avar isKindOfClass:[WIVar class]]?@YES:nil);}
-(kid)keyInClazz {MSGSTART("WIType:-(kid)keyInClazz")

              for (id<NSCopying> key in self.keysInClazz) return(key);
              return(nil);
        }
-(NSSet*)keysInClazz {MSGSTART("WIType:-(NSSet*)keysInClazz")
...
-(void)mergeWith:(WIType*)other {MSGSTART("WIType:-(void)mergeWith:(WIType*)other")

    }
-(NSMutableString*)objectName {MSGSTART("WIType:-(NSMutableString*)objectName")
...
-(void)removeAllArgs {MSGSTART("WIType:-(void)removeAllArgs")
  [v_args removeAllObjects];}
-(void)removeAllVars {MSGSTART("WIType:-(void)removeAllVars")
  [v_vars removeAllObjects];}
-(void)removeArg:(WIVarArg*)v {MSGSTART("WIType:-(void)removeArg:(WIVarArg*)v")
  [v_args removeObject:v];}
-(void)removeVar:(WIVar*)v {MSGSTART("WIType:-(void)removeVar:(WIVar*)v")
  [v_vars removeObject:v];}
-(void)retract {MSGSTART("WIType:-(void)retract")
  self.clazz=nil;
  [self.vars removeAllObjects];
  [self.args removeAllObjects];}
-(NSDictionary*)seenTreeNodeData {MSGSTART("WIType:-(NSDictionary*)seenTreeNodeData")
  ...
  /*i999*/return(ret?ret:self.treeNodeData);}
-(void)setArgs:(EndpointS*)v {MSGSTART("WIType:-(void)setArgs:(EndpointS*)v")
...
-(void)setClazz:(WIClass*)v {MSGSTART("WIType:-(void)setClazz:(WIClass*)v")
  [v_clazz_endpoint setValue:v];}
-(void)setClazz_endpoint:(Endpoint1*)v {MSGSTART("WIType:-(void)setClazz_endpoint:(Endpoint1*)v")
  ...
  /*i-900*/{v_clazz_endpoint=(id)v;}
/*i-850*/REMOVEOWNER(v_clazz_endpoint,self);ADDOWNER(v,self);}
-(void)setKeyInClazz:(kid)v {MSGSTART("WIType:-(void)setKeyInClazz:(kid)v")

              self.keysInClazz=[NSSet setWithObject:v];
        }
-(void)setKeysInClazz:(NSSet*)v {MSGSTART("WIType:-(void)setKeysInClazz:(NSSet*)v")
              ...
              if ([Util getInsertsAndDeletesForSetWhenChanging:clazz_keys_were to:v inss:&clazz_inss dels:&clazz_dels]) {
                    for (id<NSCopying> key in clazz_dels) [clazz_ep removeObjectForKey:key];
                    for (id<NSCopying> key in clazz_inss) [clazz_ep setObject:self forKey:key];
                }
        }
-(void)setVars:(EndpointS*)v {MSGSTART("WIType:-(void)setVars:(EndpointS*)v")
...
-(NSDictionary*)treeNodeData {MSGSTART("WIType:-(NSDictionary*)treeNodeData")
  ...
  /*i999*/return(ret?ret:@{});}
-(NSSet*)treePropertyNames {MSGSTART("WIType:-(NSSet*)treePropertyNames")
  
  /*i-999*/static NSSet *retSet=nil;
  /*i-100*/if (!retSet) {NSArray *ret=nil;
    /*i100*/retSet=[NSSet setWithArray:ret?ret:@[]];}
  /*i999*/return(retSet);}
-(NSSet*)treeSingleNodePropertyNames {MSGSTART("WIType:-(NSSet*)treeSingleNodePropertyNames")
  
  /*i-999*/static NSSet *retSet=nil;
  /*i-100*/if (!retSet) {NSArray *ret=nil;
    /*i100*/retSet=[NSSet setWithArray:ret?ret:@[]];}
  /*i999*/return(retSet);}
-(EndpointS*)vars {MSGSTART("WIType:-(EndpointS*)vars")
  
  /*i-999*/EndpointS* ret=v_vars;
  /*i999*/return(ret);}
-(NSObject<LinkEndpoint>*)varToEndpoint:(id)avar {MSGSTART("WIType:-(NSObject<LinkEndpoint>*)varToEndpoint:(id)avar")
...
@synthesize objectIDInClass=objectIDInClass;
@synthesize objectIDInTotal=objectIDInTotal;
-(void)_startObjectOfClassWIVar {MSGSTART("WIVar:-(void)_startObjectOfClassWIVar")
  ...
  /*i0*/}
-(void)addArg:(WIVarArg*)v {MSGSTART("WIVar:-(void)addArg:(WIVarArg*)v")
  [v_args addObject:v];}
-(void)addAtomicVar:(WIVar*)v {MSGSTART("WIVar:-(void)addAtomicVar:(WIVar*)v")
  [v_atomicVars addObject:v];}
-(void)addFluidVar:(WIVar*)v {MSGSTART("WIVar:-(void)addFluidVar:(WIVar*)v")
  [v_fluidVars addObject:v];}
-(WIVar*)applyRegexes:(NSArray*)regexes {MSGSTART("WIVar:-(WIVar*)applyRegexes:(NSArray*)regexes")

          WIVarContext *tovc=[self.context applyRegexes:regexes];
          return([self applyRegexes:regexes to:tovc]);
    }
-(WIVar*)applyRegexes:(NSArray*)regexes to:(WIVarContext*)tovc {MSGSTART("WIVar:-(WIVar*)applyRegexes:(NSArray*)regexes to:(WIVarContext*)tovc")
...
-(WIVarArg*)argAtIndex:(Int)index {MSGSTART("WIVar:-(WIVarArg*)argAtIndex:(Int)index")
  return([v_args objectAtIndex:index]);}
-(EndpointA*)args {MSGSTART("WIVar:-(EndpointA*)args")
  
  /*i-999*/EndpointA* ret=v_args;
  /*i999*/return(ret);}
-(NSObject<LinkEndpoint>*)argToEndpoint:(id)aarg {MSGSTART("WIVar:-(NSObject<LinkEndpoint>*)argToEndpoint:(id)aarg")
  return([aarg performSelector:@selector(var_endpoint)]);}
-(NSDictionary*)asD3Tree {MSGSTART("WIVar:-(NSDictionary*)asD3Tree")
  return([Treeable asD3Tree:self.asTree]);}
-(NSString*)asD3TreeJSON {MSGSTART("WIVar:-(NSString*)asD3TreeJSON")

          NSError *err=nil;
          return([[NSString alloc] initWithData:[NSJSONSerialization dataWithJSONObject:self.asD3Tree options:0 error:&err] encoding:NSUTF8StringEncoding]);
    }
-(NSDictionary*)asTree {MSGSTART("WIVar:-(NSDictionary*)asTree")
  return([self asTree:NSMutableSet.set]);}
-(NSMutableDictionary*)asTree:(NSMutableSet*)seen {MSGSTART("WIVar:-(NSMutableDictionary*)asTree:(NSMutableSet*)seen")

          return(([Treeable asTree:seen object:self]));
    }
-(EndpointS*)atomicVars {MSGSTART("WIVar:-(EndpointS*)atomicVars")
  
  /*i-999*/EndpointS* ret=v_atomicVars;
  /*i999*/return(ret);}
-(NSObject<LinkEndpoint>*)atomicVarToEndpoint:(id)aatomicVar {MSGSTART("WIVar:-(NSObject<LinkEndpoint>*)atomicVarToEndpoint:(id)aatomicVar")
  return([aatomicVar performSelector:@selector(fluidVars)]);}
-(NSString*)bindingType {MSGSTART("WIVar:-(NSString*)bindingType")
  
  /*i-999*/NSString* ret=v_bindingType;
  /*i999*/return(ret);}
-(WIVar*)boundTo {MSGSTART("WIVar:-(WIVar*)boundTo")
  
  /*i-999*/WIVar* ret=v_boundTo;
  /*i999*/return(ret);}
-(constchar*)cdescription {MSGSTART("WIVar:-(constchar*)cdescription")
  return([self.description cStringUsingEncoding:NSASCIIStringEncoding]);}
-(constchar*)cobjectName {MSGSTART("WIVar:-(constchar*)cobjectName")
  return([self.objectName cStringUsingEncoding:NSASCIIStringEncoding]);}
-(WIVarContext*)context {MSGSTART("WIVar:-(WIVarContext*)context")
  return((WIVarContext*)v_context_endpoint.value);}
-(Endpoint1*)context_endpoint {MSGSTART("WIVar:-(Endpoint1*)context_endpoint")
  
  /*i-999*/Endpoint1* ret=v_context_endpoint;
  /*i999*/return(ret);}
-(NSObject<LinkEndpoint>*)contextToEndpoint:(id)acontext {MSGSTART("WIVar:-(NSObject<LinkEndpoint>*)contextToEndpoint:(id)acontext")
  return([acontext performSelector:@selector(vars)]);}
-(void)dealloc {MSGSTART("WIVar:-(void)dealloc")
...
/*i999*/}
-(WIBody*)defaultValue {MSGSTART("WIVar:-(WIBody*)defaultValue")
  return((WIBody*)v_defaultValue_endpoint.value);}
-(Endpoint1*)defaultValue_endpoint {MSGSTART("WIVar:-(Endpoint1*)defaultValue_endpoint")
  
  /*i-999*/Endpoint1* ret=v_defaultValue_endpoint;
  /*i999*/return(ret);}
-(NSObject<LinkEndpoint>*)defaultValueToEndpoint:(id)adefaultValue {MSGSTART("WIVar:-(NSObject<LinkEndpoint>*)defaultValueToEndpoint:(id)adefaultValue")
  return([adefaultValue performSelector:@selector(defaultValueForVar_endpoint)]);}
-(NSString*)description {MSGSTART("WIVar:-(NSString*)description")
  
  /*i-999*/NSMutableString *ret=self.objectName;
          
  /*i999*/return(ret);
    }
-(NSString*)descriptiveName {MSGSTART("WIVar:-(NSString*)descriptiveName")
  return([NSString stringWithFormat:@"%@::%@",self.context.descriptiveName,self.selectorString]);}
-(void)die {MSGSTART("WIVar:-(void)die")
  self.context=nil;
  self.type=nil;
  [v_args removeAllObjects];
  self.getter=nil;
  ...
  /*i900*/}
-(WIFile*)file {MSGSTART("WIVar:-(WIFile*)file")
  return(self.context.clazz.context.file);}
-(EndpointS*)fluidVars {MSGSTART("WIVar:-(EndpointS*)fluidVars")
  
  /*i-999*/EndpointS* ret=v_fluidVars;
  /*i999*/return(ret);}
-(NSObject<LinkEndpoint>*)fluidVarToEndpoint:(id)afluidVar {MSGSTART("WIVar:-(NSObject<LinkEndpoint>*)fluidVarToEndpoint:(id)afluidVar")
  return([afluidVar performSelector:@selector(atomicVars)]);}
-(WIBody*)getter {MSGSTART("WIVar:-(WIBody*)getter")
  return((WIBody*)v_getter_endpoint.value);}
-(Endpoint1*)getter_endpoint {MSGSTART("WIVar:-(Endpoint1*)getter_endpoint")
  
  /*i-999*/Endpoint1* ret=v_getter_endpoint;
  /*i999*/return(ret);}
-(NSObject<LinkEndpoint>*)getterToEndpoint:(id)agetter {MSGSTART("WIVar:-(NSObject<LinkEndpoint>*)getterToEndpoint:(id)agetter")
  return([agetter performSelector:@selector(getterForVar_endpoint)]);}
-(WIVar*)init {MSGSTART("WIVar:-(WIVar*)init")
...
/*i10001*/return(self);}
-(void)insertArg:(WIVarArg*)v atIndex:(Int)index {MSGSTART("WIVar:-(void)insertArg:(WIVarArg*)v atIndex:(Int)index")
  [v_args insertObject:v atIndex:index];}
-(NSNumber*)isAcceptableArg:(id)aarg {MSGSTART("WIVar:-(NSNumber*)isAcceptableArg:(id)aarg")
  return([aarg isKindOfClass:[WIVarArg class]]?@YES:nil);}
-(NSNumber*)isAcceptableAtomicVar:(id)aatomicVar {MSGSTART("WIVar:-(NSNumber*)isAcceptableAtomicVar:(id)aatomicVar")
  return([aatomicVar isKindOfClass:[WIVar class]]?@YES:nil);}
-(NSNumber*)isAcceptableContext:(id)acontext {MSGSTART("WIVar:-(NSNumber*)isAcceptableContext:(id)acontext")
  return([acontext isKindOfClass:[WIVarContext class]]?@YES:nil);}
-(NSNumber*)isAcceptableDefaultValue:(id)adefaultValue {MSGSTART("WIVar:-(NSNumber*)isAcceptableDefaultValue:(id)adefaultValue")
  return([adefaultValue isKindOfClass:[WIBody class]]?@YES:nil);}
-(NSNumber*)isAcceptableFluidVar:(id)afluidVar {MSGSTART("WIVar:-(NSNumber*)isAcceptableFluidVar:(id)afluidVar")
  return([afluidVar isKindOfClass:[WIVar class]]?@YES:nil);}
-(NSNumber*)isAcceptableGetter:(id)agetter {MSGSTART("WIVar:-(NSNumber*)isAcceptableGetter:(id)agetter")
  return([agetter isKindOfClass:[WIBody class]]?@YES:nil);}
-(NSNumber*)isAcceptableSetter:(id)asetter {MSGSTART("WIVar:-(NSNumber*)isAcceptableSetter:(id)asetter")
  return([asetter isKindOfClass:[WIBody class]]?@YES:nil);}
-(NSNumber*)isAcceptableType:(id)atype {MSGSTART("WIVar:-(NSNumber*)isAcceptableType:(id)atype")
  return([atype isKindOfClass:[WIType class]]?@YES:nil);}
-(kid)keyInContext {MSGSTART("WIVar:-(kid)keyInContext")

              for (id<NSCopying> key in self.keysInContext) return(key);
              return(nil);
        }
-(NSSet*)keysInContext {MSGSTART("WIVar:-(NSSet*)keysInContext")
...
+(NSArray*)keyWithType:(WIType*)type name:(NSString*)name args:(NSArray*)args {MSGSTART("WIVar:+(NSArray*)keyWithType:(WIType*)type name:(NSString*)name args:(NSArray*)args")
...
-(void)mergeWith:(WIVar*)other {MSGSTART("WIVar:-(void)mergeWith:(WIVar*)other")
...
-(NSString*)name {MSGSTART("WIVar:-(NSString*)name")
  
  /*i-999*/NSString* ret=v_name;
  /*i999*/return(ret);}
-(NSMutableString*)objectName {MSGSTART("WIVar:-(NSMutableString*)objectName")
...
#ifndef __SWIFT__
-(void)process:(Token*)token regexes:(NSMutableArray*)regexes settings:(NSSet*)settings doingInitialSettings:(bool&)doingInitialSettings {MSGSTART("WIVar:-(void)process:(Token*)token regexes:(NSMutableArray*)regexes settings:(NSSet*)settings doingInitialSettings:(bool&)doingInitialSettings")
          ...
          if ((chs=[TokenHelper childrenForToken:token havingRuleIn:@[@"setting"]])) {
                ...
                if (t==token) {
                      ...
                      for (Token *ch in chs) [self process:ch regexes:newRegexes settings:settings doingInitialSettings:doingInitialSettings];
                  }
            }
...
#endif// __SWIFT__
-(void)removeAllArgs {MSGSTART("WIVar:-(void)removeAllArgs")
  [v_args removeAllObjects];}
-(void)removeAllAtomicVars {MSGSTART("WIVar:-(void)removeAllAtomicVars")
  [v_atomicVars removeAllObjects];}
-(void)removeAllFluidVars {MSGSTART("WIVar:-(void)removeAllFluidVars")
  [v_fluidVars removeAllObjects];}
-(void)removeAllSetters {MSGSTART("WIVar:-(void)removeAllSetters")
  [v_setters removeAllObjects];}
-(void)removeArg:(WIVarArg*)v {MSGSTART("WIVar:-(void)removeArg:(WIVarArg*)v")
  [v_args removeObject:v];}
-(void)removeArgAtIndex:(Int)index {MSGSTART("WIVar:-(void)removeArgAtIndex:(Int)index")
  [v_args removeObjectAtIndex:index];}
-(void)removeAtomicVar:(WIVar*)v {MSGSTART("WIVar:-(void)removeAtomicVar:(WIVar*)v")
  [v_atomicVars removeObject:v];}
-(void)removeFluidVar:(WIVar*)v {MSGSTART("WIVar:-(void)removeFluidVar:(WIVar*)v")
  [v_fluidVars removeObject:v];}
-(void)removeSetterForKey:(id<NSCopying>)key {MSGSTART("WIVar:-(void)removeSetterForKey:(id<NSCopying>)key")
  [v_setters removeObjectForKey:key];}
-(void)retract {MSGSTART("WIVar:-(void)retract")
  self.context=nil;
  self.type=nil;
  [self.args removeAllObjects];
  self.getter=nil;
  ...
  [self.atomicVars removeAllObjects];
  [self.fluidVars removeAllObjects];}
-(NSDictionary*)seenTreeNodeData {MSGSTART("WIVar:-(NSDictionary*)seenTreeNodeData")
  ...
  /*i999*/return(ret?ret:self.treeNodeData);}
-(NSString*)selectorString {MSGSTART("WIVar:-(NSString*)selectorString")
...
-(void)setArgs:(EndpointA*)v {MSGSTART("WIVar:-(void)setArgs:(EndpointA*)v")
  ...
  /*i-900*/{v_args=(id)v;}
/*i-850*/REMOVEOWNER(v_args,self);ADDOWNER(v,self);}
-(void)setAtomicVars:(EndpointS*)v {MSGSTART("WIVar:-(void)setAtomicVars:(EndpointS*)v")
  ...
  /*i-900*/{v_atomicVars=(id)v;}
/*i-850*/REMOVEOWNER(v_atomicVars,self);ADDOWNER(v,self);}
-(void)setBindingType:(NSString*)v {MSGSTART("WIVar:-(void)setBindingType:(NSString*)v")
  
  /*i-905*/if(v_bindingType==v)return;
  /*i-900*/{v_bindingType=(id)v;}}
-(void)setBoundTo:(WIVar*)v {MSGSTART("WIVar:-(void)setBoundTo:(WIVar*)v")
  
  /*i-905*/if(v_boundTo==v)return;
  /*i-900*/{v_boundTo=(id)v;}
/*i-850*/REMOVEOWNER(v_boundTo,self);ADDOWNER(v,self);}
-(void)setContext:(WIVarContext*)v {MSGSTART("WIVar:-(void)setContext:(WIVarContext*)v")
  [v_context_endpoint setValue:v];}
-(void)setContext_endpoint:(Endpoint1*)v {MSGSTART("WIVar:-(void)setContext_endpoint:(Endpoint1*)v")
  ...
  /*i-900*/{v_context_endpoint=(id)v;}
/*i-850*/REMOVEOWNER(v_context_endpoint,self);ADDOWNER(v,self);}
-(void)setDefaultValue:(WIBody*)v {MSGSTART("WIVar:-(void)setDefaultValue:(WIBody*)v")
  [v_defaultValue_endpoint setValue:v];}
-(void)setDefaultValue_endpoint:(Endpoint1*)v {MSGSTART("WIVar:-(void)setDefaultValue_endpoint:(Endpoint1*)v")
  ...
  /*i-900*/{v_defaultValue_endpoint=(id)v;}
/*i-850*/REMOVEOWNER(v_defaultValue_endpoint,self);ADDOWNER(v,self);}
-(void)setFluidVars:(EndpointS*)v {MSGSTART("WIVar:-(void)setFluidVars:(EndpointS*)v")
  ...
  /*i-900*/{v_fluidVars=(id)v;}
/*i-850*/REMOVEOWNER(v_fluidVars,self);ADDOWNER(v,self);}
-(void)setGetter:(WIBody*)v {MSGSTART("WIVar:-(void)setGetter:(WIBody*)v")
  [v_getter_endpoint setValue:v];}
-(void)setGetter_endpoint:(Endpoint1*)v {MSGSTART("WIVar:-(void)setGetter_endpoint:(Endpoint1*)v")
  ...
  /*i-900*/{v_getter_endpoint=(id)v;}
/*i-850*/REMOVEOWNER(v_getter_endpoint,self);ADDOWNER(v,self);}
-(void)setKeyInContext:(kid)v {MSGSTART("WIVar:-(void)setKeyInContext:(kid)v")

              self.keysInContext=[NSSet setWithObject:v];
        }
-(void)setKeysInContext:(NSSet*)v {MSGSTART("WIVar:-(void)setKeysInContext:(NSSet*)v")
              ...
              if ([Util getInsertsAndDeletesForSetWhenChanging:context_keys_were to:v inss:&context_inss dels:&context_dels]) {
                    for (id<NSCopying> key in context_dels) [context_ep removeObjectForKey:key];
                    for (id<NSCopying> key in context_inss) [context_ep setObject:self forKey:key];
                }
        }
-(void)setName:(NSString*)v {MSGSTART("WIVar:-(void)setName:(NSString*)v")
  
  /*i-905*/if(v_name==v)return;
  /*i-900*/{v_name=(id)v;}}
-(void)setSetter:(id)v forKey:(id<NSCopying>)key {MSGSTART("WIVar:-(void)setSetter:(id)v forKey:(id<NSCopying>)key")
  [v_setters setObject:v forKey:key];}
-(void)setSetters:(EndpointD*)v {MSGSTART("WIVar:-(void)setSetters:(EndpointD*)v")
  ...
  /*i-900*/{v_setters=(id)v;}
/*i-850*/REMOVEOWNER(v_setters,self);ADDOWNER(v,self);}
-(void)setSettings:(MutableDictionary*)v {MSGSTART("WIVar:-(void)setSettings:(MutableDictionary*)v")
  
  /*i-905*/if(v_settings==v)return;
  /*i-900*/{v_settings=(id)v;}
/*i-850*/REMOVEOWNER(v_settings,self);ADDOWNER(v,self);}
-(WIBody*)setterForKey:(id<NSCopying>)key {MSGSTART("WIVar:-(WIBody*)setterForKey:(id<NSCopying>)key")
  return([v_setters objectForKey:key]);}
-(EndpointD*)setters {MSGSTART("WIVar:-(EndpointD*)setters")
  
  /*i-999*/EndpointD* ret=v_setters;
  /*i999*/return(ret);}
-(NSObject<LinkEndpoint>*)setterToEndpoint:(id)asetter {MSGSTART("WIVar:-(NSObject<LinkEndpoint>*)setterToEndpoint:(id)asetter")
  return([asetter performSelector:@selector(setterForVar_endpoint)]);}
-(WIBody*)setterWithSetterVar:(NSString*)setterVar {MSGSTART("WIVar:-(WIBody*)setterWithSetterVar:(NSString*)setterVar")

          WIBody *body=[self setterForKey:setterVar];
          if (!body) [self setSetter:body=[WIBody new] forKey:setterVar.copy];
          return(body);
    }
-(MutableDictionary*)settings {MSGSTART("WIVar:-(MutableDictionary*)settings")
  
  /*i-999*/MutableDictionary* ret=v_settings;
  /*i999*/return(ret);}
-(void)setType:(WIType*)v {MSGSTART("WIVar:-(void)setType:(WIType*)v")
  [v_type_endpoint setValue:v];}
-(void)setType_endpoint:(Endpoint1*)v {MSGSTART("WIVar:-(void)setType_endpoint:(Endpoint1*)v")
  ...
  /*i-900*/{v_type_endpoint=(id)v;}
/*i-850*/REMOVEOWNER(v_type_endpoint,self);ADDOWNER(v,self);}
-(NSDictionary*)treeNodeData {MSGSTART("WIVar:-(NSDictionary*)treeNodeData")
  ...
  /*i999*/return(ret?ret:@{});}
-(NSSet*)treePropertyNames {MSGSTART("WIVar:-(NSSet*)treePropertyNames")
  ...
  /*i-100*/if (!retSet) {NSArray *ret=nil;
    ...
    /*i100*/retSet=[NSSet setWithArray:ret?ret:@[]];}
  /*i999*/return(retSet);}
-(NSSet*)treeSingleNodePropertyNames {MSGSTART("WIVar:-(NSSet*)treeSingleNodePropertyNames")
  
  /*i-999*/static NSSet *retSet=nil;
  /*i-100*/if (!retSet) {NSArray *ret=nil;
    /*i100*/retSet=[NSSet setWithArray:ret?ret:@[]];}
  /*i999*/return(retSet);}
-(WIType*)type {MSGSTART("WIVar:-(WIType*)type")
  return((WIType*)v_type_endpoint.value);}
-(Endpoint1*)type_endpoint {MSGSTART("WIVar:-(Endpoint1*)type_endpoint")
  
  /*i-999*/Endpoint1* ret=v_type_endpoint;
  /*i999*/return(ret);}
-(NSObject<LinkEndpoint>*)typeToEndpoint:(id)atype {MSGSTART("WIVar:-(NSObject<LinkEndpoint>*)typeToEndpoint:(id)atype")
...
@synthesize objectIDInClass=objectIDInClass;
@synthesize objectIDInTotal=objectIDInTotal;
-(void)_startObjectOfClassWIVarArg {MSGSTART("WIVarArg:-(void)_startObjectOfClassWIVarArg")
  ...
  /*i0*/}
-(NSString*)arg {MSGSTART("WIVarArg:-(NSString*)arg")
  
  /*i-999*/NSString* ret=v_arg;
  /*i999*/return(ret);}
-(constchar*)cdescription {MSGSTART("WIVarArg:-(constchar*)cdescription")
  return([self.description cStringUsingEncoding:NSASCIIStringEncoding]);}
-(constchar*)cobjectName {MSGSTART("WIVarArg:-(constchar*)cobjectName")
  return([self.objectName cStringUsingEncoding:NSASCIIStringEncoding]);}
-(WIVarArg*)copyByApplyingRegexes:(NSArray*)regexes {MSGSTART("WIVarArg:-(WIVarArg*)copyByApplyingRegexes:(NSArray*)regexes")
...
-(void)dealloc {MSGSTART("WIVarArg:-(void)dealloc")
...
/*i999*/}
-(NSString*)description {MSGSTART("WIVarArg:-(NSString*)description")
  
  /*i-999*/NSMutableString *ret=self.objectName;
          
  /*i999*/return(ret);
    }
-(void)die {MSGSTART("WIVarArg:-(void)die")
  self.var=nil;
  self.type=nil;
  
  /*i900*/}
-(WIFile*)file {MSGSTART("WIVarArg:-(WIFile*)file")
  return(self.var.context.clazz.context.file);}
-(NSIndexSet*)indexesInVar {MSGSTART("WIVarArg:-(NSIndexSet*)indexesInVar")
...
-(Unsigned)indexInVar {MSGSTART("WIVarArg:-(Unsigned)indexInVar")

              return(self.indexesInVar.firstIndex);
        }
-(WIVarArg*)init {MSGSTART("WIVarArg:-(WIVarArg*)init")
...
/*i10001*/return(self);}
-(NSNumber*)isAcceptableType:(id)atype {MSGSTART("WIVarArg:-(NSNumber*)isAcceptableType:(id)atype")
  return([atype isKindOfClass:[WIType class]]?@YES:nil);}
-(NSNumber*)isAcceptableVar:(id)avar {MSGSTART("WIVarArg:-(NSNumber*)isAcceptableVar:(id)avar")
  return([avar isKindOfClass:[WIVar class]]?@YES:nil);}
-(NSString*)name {MSGSTART("WIVarArg:-(NSString*)name")
  
  /*i-999*/NSString* ret=v_name;
  /*i999*/return(ret);}
-(NSMutableString*)objectName {MSGSTART("WIVarArg:-(NSMutableString*)objectName")
...
-(void)retract {MSGSTART("WIVarArg:-(void)retract")
  self.var=nil;
  self.type=nil;}
-(void)setArg:(NSString*)v {MSGSTART("WIVarArg:-(void)setArg:(NSString*)v")
  
  /*i-905*/if(v_arg==v)return;
  /*i-900*/{v_arg=(id)v;}}
-(void)setIndexesInVar:(NSIndexSet*)v {MSGSTART("WIVarArg:-(void)setIndexesInVar:(NSIndexSet*)v")
...
-(void)setIndexInVar:(Unsigned)v {MSGSTART("WIVarArg:-(void)setIndexInVar:(Unsigned)v")

              self.indexesInVar=(v==NSNotFound?[NSIndexSet indexSet]:[NSIndexSet indexSetWithIndex:v]);
        }
-(void)setName:(NSString*)v {MSGSTART("WIVarArg:-(void)setName:(NSString*)v")
  
  /*i-905*/if(v_name==v)return;
  /*i-900*/{v_name=(id)v;}}
-(void)setType:(WIType*)v {MSGSTART("WIVarArg:-(void)setType:(WIType*)v")
  [v_type_endpoint setValue:v];}
-(void)setType_endpoint:(Endpoint1*)v {MSGSTART("WIVarArg:-(void)setType_endpoint:(Endpoint1*)v")
  ...
  /*i-900*/{v_type_endpoint=(id)v;}
/*i-850*/REMOVEOWNER(v_type_endpoint,self);ADDOWNER(v,self);}
-(void)setVar:(WIVar*)v {MSGSTART("WIVarArg:-(void)setVar:(WIVar*)v")
  [v_var_endpoint setValue:v];}
-(void)setVar_endpoint:(Endpoint1*)v {MSGSTART("WIVarArg:-(void)setVar_endpoint:(Endpoint1*)v")
  ...
  /*i-900*/{v_var_endpoint=(id)v;}
/*i-850*/REMOVEOWNER(v_var_endpoint,self);ADDOWNER(v,self);}
-(WIType*)type {MSGSTART("WIVarArg:-(WIType*)type")
  return((WIType*)v_type_endpoint.value);}
-(Endpoint1*)type_endpoint {MSGSTART("WIVarArg:-(Endpoint1*)type_endpoint")
  
  /*i-999*/Endpoint1* ret=v_type_endpoint;
  /*i999*/return(ret);}
-(NSObject<LinkEndpoint>*)typeToEndpoint:(id)atype {MSGSTART("WIVarArg:-(NSObject<LinkEndpoint>*)typeToEndpoint:(id)atype")
  return([atype performSelector:@selector(args)]);}
-(WIVar*)var {MSGSTART("WIVarArg:-(WIVar*)var")
  return((WIVar*)v_var_endpoint.value);}
-(Endpoint1*)var_endpoint {MSGSTART("WIVarArg:-(Endpoint1*)var_endpoint")
  
  /*i-999*/Endpoint1* ret=v_var_endpoint;
  /*i999*/return(ret);}
-(NSObject<LinkEndpoint>*)varToEndpoint:(id)avar {MSGSTART("WIVarArg:-(NSObject<LinkEndpoint>*)varToEndpoint:(id)avar")
...
@synthesize objectIDInClass=objectIDInClass;
@synthesize objectIDInTotal=objectIDInTotal;
-(void)_startObjectOfClassWIVarContext {MSGSTART("WIVarContext:-(void)_startObjectOfClassWIVarContext")
  ...
  /*i0*/}
-(void)_addArgsFromToken:(Token*)token key:(NSMutableArray*)key argTypes:(NSMutableArray*)argTypes argArgs:(NSMutableArray*)argArgs argNames:(NSMutableArray*)argNames regexes:(NSMutableArray*)regexes {MSGSTART("WIVarContext:-(void)_addArgsFromToken:(Token*)token key:(NSMutableArray*)key argTypes:(NSMutableArray*)argTypes argArgs:(NSMutableArray*)argArgs argNames:(NSMutableArray*)argNames regexes:(NSMutableArray*)regexes")
...
-(WIVarContext*)applyRegexes:(NSArray*)regexes {MSGSTART("WIVarContext:-(WIVarContext*)applyRegexes:(NSArray*)regexes")

          WIClass *toc=[self.clazz applyRegexes];
          return([self applyRegexes:regexes to:toc]);
    }
-(WIVarContext*)applyRegexes:(NSArray*)regexes to:(WIClass*)toc {MSGSTART("WIVarContext:-(WIVarContext*)applyRegexes:(NSArray*)regexes to:(WIClass*)toc")
...
-(NSDictionary*)asD3Tree {MSGSTART("WIVarContext:-(NSDictionary*)asD3Tree")
  return([Treeable asD3Tree:self.asTree]);}
-(NSString*)asD3TreeJSON {MSGSTART("WIVarContext:-(NSString*)asD3TreeJSON")

          NSError *err=nil;
          return([[NSString alloc] initWithData:[NSJSONSerialization dataWithJSONObject:self.asD3Tree options:0 error:&err] encoding:NSUTF8StringEncoding]);
    }
-(NSDictionary*)asTree {MSGSTART("WIVarContext:-(NSDictionary*)asTree")
  return([self asTree:NSMutableSet.set]);}
-(NSMutableDictionary*)asTree:(NSMutableSet*)seen {MSGSTART("WIVarContext:-(NSMutableDictionary*)asTree:(NSMutableSet*)seen")

          return(([Treeable asTree:seen object:self]));
    }
-(constchar*)cdescription {MSGSTART("WIVarContext:-(constchar*)cdescription")
  return([self.description cStringUsingEncoding:NSASCIIStringEncoding]);}
-(WIClass*)clazz {MSGSTART("WIVarContext:-(WIClass*)clazz")
  return((WIClass*)v_clazz_endpoint.value);}
-(Endpoint1*)clazz_endpoint {MSGSTART("WIVarContext:-(Endpoint1*)clazz_endpoint")
  
  /*i-999*/Endpoint1* ret=v_clazz_endpoint;
  /*i999*/return(ret);}
-(NSObject<LinkEndpoint>*)clazzToEndpoint:(id)aclazz {MSGSTART("WIVarContext:-(NSObject<LinkEndpoint>*)clazzToEndpoint:(id)aclazz")
  return([aclazz performSelector:@selector(varCtxts)]);}
-(constchar*)cobjectName {MSGSTART("WIVarContext:-(constchar*)cobjectName")
  return([self.objectName cStringUsingEncoding:NSASCIIStringEncoding]);}
-(void)dealloc {MSGSTART("WIVarContext:-(void)dealloc")
...
/*i999*/}
-(NSString*)description {MSGSTART("WIVarContext:-(NSString*)description")
  
  /*i-999*/NSMutableString *ret=self.objectName;
          
  /*i999*/return(ret);
    }
-(NSString*)descriptiveName {MSGSTART("WIVarContext:-(NSString*)descriptiveName")
...
-(void)die {MSGSTART("WIVarContext:-(void)die")
  self.clazz=nil;
  [v_vars removeAllObjects];
  
  /*i900*/}
-(WIVar*)equivVarTo:(WIVar*)other {MSGSTART("WIVarContext:-(WIVar*)equivVarTo:(WIVar*)other")
...
-(WIFile*)file {MSGSTART("WIVarContext:-(WIFile*)file")
  return(self.clazz.context.file);}
-(WIVarContext*)init {MSGSTART("WIVarContext:-(WIVarContext*)init")
...
/*i10001*/return(self);}
-(NSNumber*)isAcceptableClazz:(id)aclazz {MSGSTART("WIVarContext:-(NSNumber*)isAcceptableClazz:(id)aclazz")
  return([aclazz isKindOfClass:[WIClass class]]?@YES:nil);}
-(NSNumber*)isAcceptableVar:(id)avar {MSGSTART("WIVarContext:-(NSNumber*)isAcceptableVar:(id)avar")
  return([avar isKindOfClass:[WIVar class]]?@YES:nil);}
-(kid)keyInClazz {MSGSTART("WIVarContext:-(kid)keyInClazz")

              for (id<NSCopying> key in self.keysInClazz) return(key);
              return(nil);
        }
-(NSSet*)keysInClazz {MSGSTART("WIVarContext:-(NSSet*)keysInClazz")

              if (!v_clazz_endpoint.value) return([NSSet set]);
              NSMutableDictionary<DictionaryLinkEndpoint> *clazz_ep=(NSMutableDictionary<DictionaryLinkEndpoint>*)[self clazzToEndpoint:v_clazz_endpoint.value];
              return((NSSet*)[clazz_ep.__dictionaryObjectKeys objectForKey:self]);
        }
-(void)mergeWith:(WIVarContext*)other {MSGSTART("WIVarContext:-(void)mergeWith:(WIVarContext*)other")
...
-(NSMutableString*)objectName {MSGSTART("WIVarContext:-(NSMutableString*)objectName")
...
-(void)removeAllVars {MSGSTART("WIVarContext:-(void)removeAllVars")
  [v_vars removeAllObjects];}
-(void)removeVarForKey:(id<NSCopying>)key {MSGSTART("WIVarContext:-(void)removeVarForKey:(id<NSCopying>)key")
  [v_vars removeObjectForKey:key];}
-(void)retract {MSGSTART("WIVarContext:-(void)retract")
  self.clazz=nil;
  [self.vars removeAllObjects];}
-(NSDictionary*)seenTreeNodeData {MSGSTART("WIVarContext:-(NSDictionary*)seenTreeNodeData")
  ...
  /*i999*/return(ret?ret:self.treeNodeData);}
-(void)setClazz:(WIClass*)v {MSGSTART("WIVarContext:-(void)setClazz:(WIClass*)v")
  [v_clazz_endpoint setValue:v];}
-(void)setClazz_endpoint:(Endpoint1*)v {MSGSTART("WIVarContext:-(void)setClazz_endpoint:(Endpoint1*)v")
  ...
  /*i-900*/{v_clazz_endpoint=(id)v;}
/*i-850*/REMOVEOWNER(v_clazz_endpoint,self);ADDOWNER(v,self);}
-(void)setKeyInClazz:(kid)v {MSGSTART("WIVarContext:-(void)setKeyInClazz:(kid)v")

              self.keysInClazz=[NSSet setWithObject:v];
        }
-(void)setKeysInClazz:(NSSet*)v {MSGSTART("WIVarContext:-(void)setKeysInClazz:(NSSet*)v")
...
-(void)setVar:(id)v forKey:(id<NSCopying>)key {MSGSTART("WIVarContext:-(void)setVar:(id)v forKey:(id<NSCopying>)key")
  [v_vars setObject:v forKey:key];}
-(void)setVars:(EndpointD*)v {MSGSTART("WIVarContext:-(void)setVars:(EndpointD*)v")
  ...
  /*i-900*/{v_vars=(id)v;}
/*i-850*/REMOVEOWNER(v_vars,self);ADDOWNER(v,self);}
-(NSDictionary*)treeNodeData {MSGSTART("WIVarContext:-(NSDictionary*)treeNodeData")
  ...
  /*i999*/return(ret?ret:@{});}
-(NSSet*)treePropertyNames {MSGSTART("WIVarContext:-(NSSet*)treePropertyNames")
  ...
  /*i-100*/if (!retSet) {NSArray *ret=nil;
    ...
    /*i100*/retSet=[NSSet setWithArray:ret?ret:@[]];}
  /*i999*/return(retSet);}
-(NSSet*)treeSingleNodePropertyNames {MSGSTART("WIVarContext:-(NSSet*)treeSingleNodePropertyNames")
  
  /*i-999*/static NSSet *retSet=nil;
  /*i-100*/if (!retSet) {NSArray *ret=nil;
    /*i100*/retSet=[NSSet setWithArray:ret?ret:@[]];}
  /*i999*/return(retSet);}
-(WIType*)typeForFnBlock:(Token*)token mods:(NSMutableArray*)mods regexes:(NSMutableArray*)regexes {MSGSTART("WIVarContext:-(WIType*)typeForFnBlock:(Token*)token mods:(NSMutableArray*)mods regexes:(NSMutableArray*)regexes")
...
-(WIVar*)varForKey:(id<NSCopying>)key {MSGSTART("WIVarContext:-(WIVar*)varForKey:(id<NSCopying>)key")
  return([v_vars objectForKey:key]);}
-(WIVar*)varForVarToken:(Token*)token type:(WIType*)type regexes:(NSMutableArray*)regexes {MSGSTART("WIVarContext:-(WIVar*)varForVarToken:(Token*)token type:(WIType*)type regexes:(NSMutableArray*)regexes")
...
-(EndpointD*)vars {MSGSTART("WIVarContext:-(EndpointD*)vars")
  
  /*i-999*/EndpointD* ret=v_vars;
  /*i999*/return(ret);}
-(NSObject<LinkEndpoint>*)varToEndpoint:(id)avar {MSGSTART("WIVarContext:-(NSObject<LinkEndpoint>*)varToEndpoint:(id)avar")
  return([avar performSelector:@selector(context_endpoint)]);}
-(WIVar*)varWithVarKey:(NSArray*)key {MSGSTART("WIVarContext:-(WIVar*)varWithVarKey:(NSArray*)key")

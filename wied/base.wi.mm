...
-(void)_startObjectOfClassWeakSelf {MSGSTART("WeakSelf:-(void)_startObjectOfClassWeakSelf")
  
  /*i-996*/debugAutorelease=YES;
  /*i-995*/objInitFn(self,objectIDInTotal,objectIDInClass);
      
  /*i0*/}
-(constchar*)cdescription {MSGSTART("WeakSelf:-(constchar*)cdescription")
  return([self.description cStringUsingEncoding:NSASCIIStringEncoding]);}
-(constchar*)cobjectName {MSGSTART("WeakSelf:-(constchar*)cobjectName")
  return([self.objectName cStringUsingEncoding:NSASCIIStringEncoding]);}
-(instancetype)copyWithZone:(NSZone *)zone {MSGSTART("WeakSelf:-(instancetype)copyWithZone:(NSZone *)zone")
  return [[WeakSelf allocWithZone:zone] initCopyFrom:self];
}
-(void)dealloc {MSGSTART("WeakSelf:-(void)dealloc")
...
/*i999*/}
-(NSString*)description {MSGSTART("WeakSelf:-(NSString*)description")
  
  /*i-999*/NSMutableString *ret=self.objectName;
          
  /*i999*/return(ret);
    }
-(void)die {MSGSTART("WeakSelf:-(void)die")
  
  /*i900*/}
-(instancetype)initCopyFrom:(WeakSelf*)copy {MSGSTART("WeakSelf:-(instancetype)initCopyFrom:(WeakSelf*)copy")
  if ((self=[super init])) {
                index=copy->index;
                hash=copy->hash;
...
-(instancetype)initWithStrongSelf:(id)astrongSelf {MSGSTART("WeakSelf:-(instancetype)initWithStrongSelf:(id)astrongSelf")
...
-(BOOL)isEqual:(id)object {MSGSTART("WeakSelf:-(BOOL)isEqual:(id)object")
...
-(NSMutableString*)objectName {MSGSTART("WeakSelf:-(NSMutableString*)objectName")
...
-(id)selfWithWeakness:(bool)weak {MSGSTART("WeakSelf:-(id)selfWithWeakness:(bool)weak")
...
+(WeakSelf*)weakSelfFromObject:(id)astrongSelf {MSGSTART("WeakSelf:+(WeakSelf*)weakSelfFromObject:(id)astrongSelf")

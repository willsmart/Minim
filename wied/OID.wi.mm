...
-(void)_startObjectOfClassObjectGraph {MSGSTART("ObjectGraph:-(void)_startObjectOfClassObjectGraph")
  ...
  /*i0*/}
-(constchar*)cdescription {MSGSTART("ObjectGraph:-(constchar*)cdescription")
  return([self.description cStringUsingEncoding:NSASCIIStringEncoding]);}
-(constchar*)cobjectName {MSGSTART("ObjectGraph:-(constchar*)cobjectName")
  return([self.objectName cStringUsingEncoding:NSASCIIStringEncoding]);}
-(void)dealloc {MSGSTART("ObjectGraph:-(void)dealloc")
...
/*i999*/}
-(NSString*)description {MSGSTART("ObjectGraph:-(NSString*)description")
  
  /*i-999*/NSMutableString *ret=self.objectName;
          
  /*i999*/return(ret);
    }
-(void)die {MSGSTART("ObjectGraph:-(void)die")
  
  /*i900*/}
+(ObjectGraph*)get {MSGSTART("ObjectGraph:+(ObjectGraph*)get")
  return([[ObjectGraph alloc] init]);}
-(ObjectGraph*)init {MSGSTART("ObjectGraph:-(ObjectGraph*)init")
...
/*i10001*/return(self);}
-(NSMutableString*)newEdits {MSGSTART("ObjectGraph:-(NSMutableString*)newEdits")
  
  /*i-999*/NSMutableString* ret=newEdits;
  /*i999*/return(ret);}
-(NSMutableString*)newEdits2 {MSGSTART("ObjectGraph:-(NSMutableString*)newEdits2")
  
  /*i-999*/NSMutableString* ret=newEdits2;
  /*i999*/return(ret);}
-(void)object:(LL)owner ownsObject:(LL)object count:(Int)count {MSGSTART("ObjectGraph:-(void)object:(LL)owner ownsObject:(LL)object count:(Int)count")

          [newEdits appendFormat:@"[%qu,%f,%qu,%qu,%d],\n",g_sequence++,CACurrentMediaTime(),owner,object,(int)count];
    }
-(NSMutableString*)objectName {MSGSTART("ObjectGraph:-(NSMutableString*)objectName")
...
-(bool)savingGraph {MSGSTART("ObjectGraph:-(bool)savingGraph")
  return(v_tim!=nil);}
-(void)setTim:(NSTimer*)v {MSGSTART("ObjectGraph:-(void)setTim:(NSTimer*)v")
  
  /*i-905*/if(v_tim==v)return;
  /*i-900*/{v_tim=(id)v;}}
-(void)setWithDictionary:(NSDictionary*)d {MSGSTART("ObjectGraph:-(void)setWithDictionary:(NSDictionary*)d")
}
-(void)start {MSGSTART("ObjectGraph:-(void)start")
  g_objectGraph=self;[self startWithInterval:0.5];}
-(void)startWithInterval:(float)interval {MSGSTART("ObjectGraph:-(void)startWithInterval:(float)interval")

          [self.tim invalidate];
          self.tim=[NSTimer scheduledTimerWithTimeInterval:interval target:self selector:@selector(tick) userInfo:nil repeats:YES];
    }
-(void)stop {MSGSTART("ObjectGraph:-(void)stop")
...
-(void)tick {MSGSTART("ObjectGraph:-(void)tick")
...
-(NSTimer*)tim {MSGSTART("ObjectGraph:-(NSTimer*)tim")
...
-(void)die {  
  /*i900*/}
+(Trace*)get {  return([[Trace alloc] init]);}
-(Trace*)init {  
  /*i-10001*/if (!(self=[super init])) return(nil);

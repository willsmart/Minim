...
// !!!: Implementations: i
    ...
    - (void)_startObjectOfClassIntCarrier {
        MSGSTART("IntCarrier:-(void)_startObjectOfClassIntCarrier")
...
/*i999*/}
    - (NSString *)description {
        MSGSTART("IntCarrier:-(NSString*)description")
    ...
    - (void)die {
        MSGSTART("IntCarrier:-(void)die")

        /*i900*/}
    - (IntCarrier *)initWithInt:(Int)v {
        MSGSTART("IntCarrier:-(IntCarrier*)initWithInt:(Int)v")
...
/*i10001*/ return self;
    ...
    - (NSMutableString *)objectName {
        MSGSTART("IntCarrier:-(NSMutableString*)objectName")
...
// !!!: Implementations: l
    ...
    - (void)_startObjectOfClassLRUCache {
        MSGSTART("LRUCache:-(void)_startObjectOfClassLRUCache")
    ...
    - (NSDictionary *)__dictionary {
        MSGSTART("LRUCache:-(NSDictionary*)__dictionary")

        /*i-999*/ NSDictionary * ret = __dictionary;
        /*i999*/ return ret;
    }
    - (NSMutableDictionary *)__mutableDictionary {
        MSGSTART("LRUCache:-(NSMutableDictionary*)__mutableDictionary")

        /*i-999*/ NSMutableDictionary * ret = __mutableDictionary;
        /*i999*/ return ret;
    }
    - (bool)_removeObjectForKey:(id<NSCopying> )key {
        MSGSTART("LRUCache:-(bool)_removeObjectForKey:(id<NSCopying>)key")
    ...
    - (bool)_setObject:(id)object forKey:(id<NSCopying> )key {
        MSGSTART("LRUCache:-(bool)_setObject:(id)object forKey:(id<NSCopying>)key")
    ...
    - (void)addDelegate:(NSObject<MutableDictionaryDelegate> *)v {
        MSGSTART("LRUCache:-(void)addDelegate:(NSObject<MutableDictionaryDelegate>*)v")
    ...
    - (NSArray *)allKeys {
        MSGSTART("LRUCache:-(NSArray*)allKeys")
        return [__dictionary allKeys];
    }
    - (NSArray *)allKeysForObject:(id)object {
        MSGSTART("LRUCache:-(NSArray*)allKeysForObject:(id)object")
        return [__dictionary allKeysForObject:object];
    }
    - (NSArray *)allValues {
        MSGSTART("LRUCache:-(NSArray*)allValues")
        return [__dictionary allValues];
    }
    - (NSDictionary *)asDictionary {
        MSGSTART("LRUCache:-(NSDictionary*)asDictionary")
                ...
                if ([item.object isKindOfClass:[UIImage class]]) {
                    ...
                    [list addObject:item._cacheKey];
                      ...
                      NOTUI (
                          ...
                          - (constchar *)cdescription {
                              MSGSTART("LRUCache:-(constchar*)cdescription")
                              return [self.description cStringUsingEncoding:NSASCIIStringEncoding];
                          }
                          - (void)clear {
                              MSGSTART("LRUCache:-(void)clear")
                          ...
                          - (constchar *)cobjectName {
                              MSGSTART("LRUCache:-(constchar*)cobjectName")
                              return [self.objectName cStringUsingEncoding:NSASCIIStringEncoding];
                          }
                          - (id)copyWithZone:(NSZone *)zone {
                              MSGSTART("LRUCache:-(id)copyWithZone:(NSZone*)zone")

                              return [[ImmutableDictionary allocWithZone:zone] initWithDictionary:__dictionary];
                          }
                          - (Unsigned)count {
                              MSGSTART("LRUCache:-(Unsigned)count")
                              return [__dictionary count];
                          }
                          - (Unsigned)countByEnumeratingWithState:(NSFastEnumerationState *)state objects:(__unsafe_unretained id *)stackbuf count:(Unsigned)len {
                              MSGSTART("LRUCache:-(Unsigned)countByEnumeratingWithState:(NSFastEnumerationState *)state objects:(__unsafe_unretained id*)stackbuf count:(Unsigned)len")

                              Unsigned ret = [__dictionary countByEnumeratingWithState:state objects:stackbuf count:len];
                              return ret;
                          }
                          - (void)countWeakObjects {
                              MSGSTART("LRUCache:-(void)countWeakObjects")
                          ...
                          - (void)dealloc {
                              MSGSTART("LRUCache:-(void)dealloc")
...
/*i999*/}
                          - (NSDictionary *)delegateForDictionary {
                              MSGSTART("LRUCache:-(NSDictionary*)delegateForDictionary")

                              /*i-999*/ NSDictionary * ret = delegateForDictionary;
                              /*i999*/ return ret;
                          }
                          - (void)delegateForDictionaryChanged {
                              MSGSTART("LRUCache:-(void)delegateForDictionaryChanged")
                          }
                          - (NSObject *)derefedObjectForKey:(id<NSCopying> )key {
                              MSGSTART("LRUCache:-(NSObject*)derefedObjectForKey:(id<NSCopying>)key")
                          ...
                          - (NSString *)description {
                              MSGSTART("LRUCache:-(NSString*)description")
                          ...
                          - (NSString *)descriptionInStringsFileFormat {
                              MSGSTART("LRUCache:-(NSString*)descriptionInStringsFileFormat")
                              return [__dictionary descriptionInStringsFileFormat];
                          }
                          - (NSString *)descriptionWithLocale:(id)locale {
                              MSGSTART("LRUCache:-(NSString *)descriptionWithLocale:(id)locale")

                              return [__dictionary descriptionWithLocale:locale];
                          }
                          - (NSString *)descriptionWithLocale:(id)locale indent:(Unsigned)level {
                              MSGSTART("LRUCache:-(NSString *)descriptionWithLocale:(id)locale indent:(Unsigned)level")

                              return [__dictionary descriptionWithLocale:locale indent:level];
                          }
                          + (LRUCache *)dictionary {
                              MSGSTART("LRUCache:+(LRUCache*)dictionary")
                              return [[LRUCache alloc] init];
                          }
                          - (NSObject<MutableDictionaryDelegate> *)dictionaryDelegate {
                              MSGSTART("LRUCache:-(NSObject<MutableDictionaryDelegate>*)dictionaryDelegate")

                              /*i-999*/ NSObject<MutableDictionaryDelegate> *ret = dictionaryDelegate;
                              /*i999*/ return ret;
                          }
                          + (id)dictionaryWithCapacity:(Unsigned)numItems {
                              MSGSTART("LRUCache:+(id)dictionaryWithCapacity:(Unsigned)numItems")

                              return [[LRUCache alloc] initWithCapacity:numItems];
                          }
                          + (LRUCache *)dictionaryWithContentsOfFile:(NSString *)file {
                              MSGSTART("LRUCache:+(LRUCache*)dictionaryWithContentsOfFile:(NSString*)file")
                              return [[LRUCache alloc] initWithContentsOfFile:file];
                          }
                          + (LRUCache *)dictionaryWithContentsOfURL:(NSURL *)url {
                              MSGSTART("LRUCache:+(LRUCache*)dictionaryWithContentsOfURL:(NSURL*)url")
                              return [[LRUCache alloc] initWithContentsOfURL:url];
                          }
                          + (LRUCache *)dictionaryWithDictionary:(NSDictionary *)dictionary {
                              MSGSTART("LRUCache:+(LRUCache*)dictionaryWithDictionary:(NSDictionary*)dictionary")
                              return [[LRUCache alloc] initWithDictionary:dictionary];
                          }
                          + (LRUCache *)dictionaryWithObject:(id)object forKey:(id<NSCopying> )key {
                              MSGSTART("LRUCache:+(LRUCache*)dictionaryWithObject:(id)object forKey:(id<NSCopying>)key")
                              return [[LRUCache alloc] initWithObjects:&object forKeys:&key count:1];
                          }
                          + (LRUCache *)dictionaryWithObjects:(__unsafe_unretained id[])objects forKeys:(__strong id<NSCopying>[])keys count:(Unsigned)count {
                              MSGSTART("LRUCache:+(LRUCache*)dictionaryWithObjects:(__unsafe_unretained id[])objects forKeys:(__strong id<NSCopying>[])keys count:(Unsigned)count")
                              return [[LRUCache alloc] initWithObjects:objects forKeys:keys count:  /*ivar*/ count];
                          }
                          - (void)didReplaceObject:(id)fromObject withObject:(id)toObject forKey:(id<NSCopying> )key {
                              MSGSTART("LRUCache:-(void)didReplaceObject:(id)fromObject withObject:(id)toObject forKey:(id<NSCopying>)key") {
                                  if (toObject) {
                          ...
                          - (void)die {
                              MSGSTART("LRUCache:-(void)die")

                              /*i900*/}
                          - (void)encodeWithCoder:(NSCoder *)coder {
                              MSGSTART("LRUCache:-(void)encodeWithCoder:(NSCoder*)coder")

                              [__dictionary encodeWithCoder : coder];
                          }
                          - (void)enumerateKeysAndObjectsUsingBlock:( void (^)(id key, id obj, BOOL *stop) )block {
                              MSGSTART("LRUCache:-(void)enumerateKeysAndObjectsUsingBlock:(void (^)(id key, id obj, BOOL *stop))block")

                              [__dictionary enumerateKeysAndObjectsUsingBlock : block];
                          }
                          - (void)enumerateKeysAndObjectsWithOptions:(NSEnumerationOptions)opts usingBlock:( void (^)(id key, id obj, BOOL *stop) )block {
                              MSGSTART("LRUCache:-(void)enumerateKeysAndObjectsWithOptions:(NSEnumerationOptions)opts usingBlock:(void (^)(id key, id obj, BOOL *stop))block")

                              [__dictionary enumerateKeysAndObjectsWithOptions : opts usingBlock : block];
                          }
                          - (NSDate *)fileCreationDate {
                              MSGSTART("LRUCache:-(NSDate*)fileCreationDate")
                              return [__dictionary fileCreationDate];
                          }
                          - (BOOL)fileExtensionHidden {
                              MSGSTART("LRUCache:-(BOOL)fileExtensionHidden")
                              return [__dictionary fileExtensionHidden];
                          }
                          - (NSNumber *)fileGroupOwnerAccountID {
                              MSGSTART("LRUCache:-(NSNumber*)fileGroupOwnerAccountID")
                              return [__dictionary fileGroupOwnerAccountID];
                          }
                          - (NSString *)fileGroupOwnerAccountName {
                              MSGSTART("LRUCache:-(NSString*)fileGroupOwnerAccountName")
                              return [__dictionary fileGroupOwnerAccountName];
                          }
                          - (OSType)fileHFSCreatorCode {
                              MSGSTART("LRUCache:-(OSType)fileHFSCreatorCode")
                              return [__dictionary fileHFSCreatorCode];
                          }
                          - (OSType)fileHFSTypeCode {
                              MSGSTART("LRUCache:-(OSType)fileHFSTypeCode")
                              return [__dictionary fileHFSTypeCode];
                          }
                          - (BOOL)fileIsAppendOnly {
                              MSGSTART("LRUCache:-(BOOL)fileIsAppendOnly")
                              return [__dictionary fileIsAppendOnly];
                          }
                          - (BOOL)fileIsImmutable {
                              MSGSTART("LRUCache:-(BOOL)fileIsImmutable")
                              return [__dictionary fileIsImmutable];
                          }
                          - (NSDate *)fileModificationDate {
                              MSGSTART("LRUCache:-(NSDate*)fileModificationDate")
                              return [__dictionary fileModificationDate];
                          }
                          - (NSNumber *)fileOwnerAccountID {
                              MSGSTART("LRUCache:-(NSNumber*)fileOwnerAccountID")
                              return [__dictionary fileOwnerAccountID];
                          }
                          - (NSString *)fileOwnerAccountName {
                              MSGSTART("LRUCache:-(NSString*)fileOwnerAccountName")
                              return [__dictionary fileOwnerAccountName];
                          }
                          - (Unsigned)filePosixPermissions {
                              MSGSTART("LRUCache:-(Unsigned)filePosixPermissions")
                              return [__dictionary filePosixPermissions];
                          }
                          - (ULL)fileSize {
                              MSGSTART("LRUCache:-(ULL)fileSize")
                              return [__dictionary fileSize];
                          }
                          - (Unsigned)fileSystemFileNumber {
                              MSGSTART("LRUCache:-(Unsigned)fileSystemFileNumber")
                              return [__dictionary fileSystemFileNumber];
                          }
                          - (Int)fileSystemNumber {
                              MSGSTART("LRUCache:-(Int)fileSystemNumber")
                              return [__dictionary fileSystemNumber];
                          }
                          - (NSString *)fileType {
                              MSGSTART("LRUCache:-(NSString*)fileType")
                              return [__dictionary fileType];
                          }
                          + (LRUCache *)get {
                              MSGSTART("LRUCache:+(LRUCache*)get")
                              return [[LRUCache alloc] init];
                          }
                          - (void)getObjects:(id __unsafe_unretained [])objects andKeys:(id __unsafe_unretained [])keys {
                              MSGSTART("LRUCache:-(void)getObjects:(id __unsafe_unretained [])objects andKeys:(id __unsafe_unretained [])keys")

                              [__dictionary getObjects : objects andKeys : keys];
                          }
                          - (Unsigned)hash {
                              MSGSTART("LRUCache:-(Unsigned)hash")
                              return (Unsigned)obfuscateULL(objectIDInTotal);
                          }
                          - (NSObject<ListItem> *)headItem {
                              MSGSTART("LRUCache:-(NSObject<ListItem>*)headItem")

                              /*i-999*/ NSObject<ListItem> *ret = v_headItem;
                              /*i999*/ return ret;
                          }
                          - (LRUCache *)init {
                              MSGSTART("LRUCache:-(LRUCache*)init")
...
/*i10001*/ return self;
                          ...
                          - (LRUCache *)initWithCapacity:(Unsigned)numItems {
                              MSGSTART("LRUCache:-(LRUCache*)initWithCapacity:(Unsigned)numItems")
...
/*i10001*/ return self;
                          ...
                          - (LRUCache *)initWithCoder:(NSCoder *)coder {
                              MSGSTART("LRUCache:-(LRUCache*)initWithCoder:(NSCoder*)coder")
...
/*i10001*/ return self;
                          ...
                          - (LRUCache *)initWithContentsOfFile:(NSString *)file {
                              MSGSTART("LRUCache:-(LRUCache*)initWithContentsOfFile:(NSString*)file")
...
/*i10001*/ return self;
                          ...
                          - (LRUCache *)initWithContentsOfURL:(NSURL *)url {
                              MSGSTART("LRUCache:-(LRUCache*)initWithContentsOfURL:(NSURL*)url")
...
/*i10001*/ return self;
                          ...
                          - (LRUCache *)initWithDictionary:(NSDictionary *)dictionary {
                              MSGSTART("LRUCache:-(LRUCache*)initWithDictionary:(NSDictionary*)dictionary")
...
/*i10001*/ return self;
                          ...
                          - (LRUCache *)initWithDictionary:(NSDictionary *)dictionary copyItems:(BOOL)copy {
                              MSGSTART("LRUCache:-(LRUCache*)initWithDictionary:(NSDictionary*)dictionary copyItems:(BOOL)copy")
...
/*i10001*/ return self;
                          ...
                          - (LRUCache *)initWithObjects:(const id[])objects forKeys:(const id<NSCopying>[])keys count:(Unsigned)count {
                              MSGSTART("LRUCache:-(LRUCache*)initWithObjects:(const id[])objects forKeys:(const id<NSCopying>[])keys count:(Unsigned)count")
...
/*i10001*/ return self;
                          ...
                          - (BOOL)isEqual:(id)obj {
                              MSGSTART("LRUCache:-(BOOL)isEqual:(id)obj")
                          ...
                          - (BOOL)isEqualToDictionary:(NSDictionary *)dictionary {
                              MSGSTART("LRUCache:-(BOOL)isEqualToDictionary:(NSDictionary*)dictionary")
                              return [__dictionary isEqualToDictionary:dictionary];
                          }
                          - (NSEnumerator *)keyEnumerator {
                              MSGSTART("LRUCache:-(NSEnumerator*)keyEnumerator")
                              return [__dictionary keyEnumerator];
                          }
                          - (NSSet *)keysOfEntriesPassingTest:( BOOL (^)(id key, id obj, BOOL *stop) )predicate {
                              MSGSTART("LRUCache:-(NSSet *)keysOfEntriesPassingTest:(BOOL (^)(id key, id obj, BOOL *stop))predicate")

                              return [__dictionary keysOfEntriesPassingTest:predicate];
                          }
                          - (NSSet *)keysOfEntriesWithOptions:(NSEnumerationOptions)opts passingTest:( BOOL (^)(id key, id obj, BOOL *stop) )predicate {
                              MSGSTART("LRUCache:-(NSSet *)keysOfEntriesWithOptions:(NSEnumerationOptions)opts passingTest:(BOOL (^)(id key, id obj, BOOL *stop))predicate")

                              return [__dictionary keysOfEntriesWithOptions:opts passingTest:predicate];
                          }
                          - (NSArray *)keysSortedByValueUsingComparator:(NSComparator)cmptr {
                              MSGSTART("LRUCache:-(NSArray*)keysSortedByValueUsingComparator:(NSComparator)cmptr")

                              return [__dictionary keysSortedByValueUsingComparator:cmptr];
                          }
                          - (NSArray *)keysSortedByValueUsingSelector:(SEL)selector {
                              MSGSTART("LRUCache:-(NSArray*)keysSortedByValueUsingSelector:(SEL)selector")

                              return [__dictionary keysSortedByValueUsingSelector:selector];
                          }
                          - (NSArray *)keysSortedByValueWithOptions:(NSSortOptions)opts usingComparator:(NSComparator)cmptr {
                              MSGSTART("LRUCache:-(NSArray*)keysSortedByValueWithOptions:(NSSortOptions)opts usingComparator:(NSComparator)cmptr")

                              return [__dictionary keysSortedByValueWithOptions:opts usingComparator:cmptr];
                          }
                          - (NSObject<LRUCacheItem> *)makeForKey:(NSObject<NSCopying> *)key {
                              MSGSTART("LRUCache:-(NSObject<LRUCacheItem>*)makeForKey:(NSObject<NSCopying>*)key")
                          ...
                          - (NSMutableString *)objectName {
                              MSGSTART("LRUCache:-(NSMutableString*)objectName")
                          ...
                          - (NSArray *)objectsForKeys:(NSArray *)keys notFoundMarker:(id)anObject {
                              MSGSTART("LRUCache:-(NSArray*)objectsForKeys:(NSArray *)keys notFoundMarker:(id)anObject")

                              return [__dictionary objectsForKeys:keys notFoundMarker:anObject];
                          }
                          - (void)removedDelegate {
                              MSGSTART("LRUCache:-(void)removedDelegate")

                              /*i-100*/ dictionaryDelegate = nil;
                          }
                          - (void)removeDelegate:(NSObject<MutableDictionaryDelegate> *)v {
                              MSGSTART("LRUCache:-(void)removeDelegate:(NSObject<MutableDictionaryDelegate>*)v")
                          ...
                          - (void)removeObjectForKey:(id<NSCopying> )key {
                              MSGSTART("LRUCache:-(void)removeObjectForKey:(id<NSCopying>)key")

                              if ([self _removeObjectForKey:key]) [self stateOK];
                          }
                          - (void)setAsDictionary:(NSDictionary *)v {
                              MSGSTART("LRUCache:-(void)setAsDictionary:(NSDictionary*)v")

                              [self clear];

                              NSArray *list = [v objectForKey:@"___li_st___"];
                              for (NSString *key in list) {
                                  if (![key isEqual:@"___li_st___"]) {
                          ...
                          - (void)setDelegateForDictionary:(NSDictionary *)v {
                              MSGSTART("LRUCache:-(void)setDelegateForDictionary:(NSDictionary*)v")
                          ...
                          - (void)setHeadItem:(NSObject<ListItem> *)v {
                              MSGSTART("LRUCache:-(void)setHeadItem:(NSObject<ListItem>*)v")
                          ...
                          - (void)setObject:(id)object forKey:(id<NSCopying> )key {
                              MSGSTART("LRUCache:-(void)setObject:(id)object forKey:(id<NSCopying>)key")

                              if ([self _setObject:object forKey:key]) [self stateOK];
                          }
                          - (void)setTailItem:(NSObject<ListItem> *)v {
                              MSGSTART("LRUCache:-(void)setTailItem:(NSObject<ListItem>*)v")
                          ...
                          - (void)setWeakness:(CollectionWeakness)v {
                              MSGSTART("LRUCache:-(void)setWeakness:(CollectionWeakness)v")
                          ...
                          - (void)setWithDictionary:(NSDictionary *)d {
                              MSGSTART("LRUCache:-(void)setWithDictionary:(NSDictionary*)d")
                          }
    #ifndef __SWIFT__
                              - (bool)shouldAddObject:(id)object forKey:(id<NSCopying> )key makeWeak:(bool &)weak {
                                  MSGSTART("LRUCache:-(bool)shouldAddObject:(id)object forKey:(id<NSCopying>)key makeWeak:(bool&)weak")
...
/*i999*/ return ret;
    ...
    #endif  // __SWIFT__
                          - (void)stateOK {
                              MSGSTART("LRUCache:-(void)stateOK")
                          ...
                          - (NSObject<ListItem> *)tailItem {
                              MSGSTART("LRUCache:-(NSObject<ListItem>*)tailItem")

                              /*i-999*/ NSObject<ListItem> *ret = v_tailItem;
                              /*i999*/ return ret;
                          }
                          - (id)valueForKey:(NSString *)key {
                              MSGSTART("LRUCache:-(id)valueForKey:(NSString*)key")
                              return [__dictionary valueForKey:key];
                          }
                          - (CollectionWeakness)weakness {
                              MSGSTART("LRUCache:-(CollectionWeakness)weakness")
                          ...
                          - (void)willReplaceObject:(id)fromObject withObject:(id)toObject forKey:(id<NSCopying> )key {
                              MSGSTART("LRUCache:-(void)willReplaceObject:(id)fromObject withObject:(id)toObject forKey:(id<NSCopying>)key") {
                                  if (fromObject) {
                          ...
                          - (BOOL)writeToFile:(NSString *)path atomically:(BOOL)flag {
                              MSGSTART("LRUCache:-(BOOL)writeToFile:(NSString *)path atomically:(BOOL)flag")

                              return [__dictionary writeToFile:path atomically:flag];
                          }
                          - (BOOL)writeToURL:(NSURL *)url atomically:(BOOL)flag {
                              MSGSTART("LRUCache:-(BOOL)writeToURL:(NSURL *)url atomically:(BOOL)flag")
    ...
    #undef _Class_
        ...
        #undef _PrivateAccessMask_
                          ...
                          - (void)_startObjectOfClassLRUCacheItem {
                              MSGSTART("LRUCacheItem:-(void)_startObjectOfClassLRUCacheItem")
                              ...
                              /*i0*/}
                          - (NSObject<NSCopying> *)_cacheKey {
                              MSGSTART("LRUCacheItem:-(NSObject<NSCopying>*)_cacheKey")

                              /*i-999*/ NSObject<NSCopying> *ret = v__cacheKey;
                              /*i999*/ return ret;
                          }
                          - (void)append {
                              MSGSTART("LRUCacheItem:-(void)append")
                              [self linkBefore : nil];
                          }
                          - (NSObject<LRUCache> *)cache {
                              MSGSTART("LRUCacheItem:-(NSObject<LRUCache>*)cache")

                              /*i-999*/ NSObject<LRUCache> *ret = cache;
                              /*i999*/ return ret;
                          }
                          - (constchar *)cdescription {
                              MSGSTART("LRUCacheItem:-(constchar*)cdescription")
                              return [self.description cStringUsingEncoding:NSASCIIStringEncoding];
                          }
                          - (constchar *)cobjectName {
                              MSGSTART("LRUCacheItem:-(constchar*)cobjectName")
                              return [self.objectName cStringUsingEncoding:NSASCIIStringEncoding];
                          }
                          - (void)dealloc {
                              MSGSTART("LRUCacheItem:-(void)dealloc")
...
/*i999*/}
                          - (NSString *)description {
                              MSGSTART("LRUCacheItem:-(NSString*)description")
                          ...
                          - (void)die {
                              MSGSTART("LRUCacheItem:-(void)die")

                              /*i900*/}
                          - (LRUCacheItem *)initWithObject:(NSObject *)aobject size:(float)asize {
                              MSGSTART("LRUCacheItem:-(LRUCacheItem*)initWithObject:(NSObject*)aobject size:(float)asize")
...
/*i10001*/ return self;
                          ...
                          - (void)linkAfter:(NSObject<ListItem> *)prev {
                              MSGSTART("LRUCacheItem:-(void)linkAfter:(NSObject<ListItem>*)prev")
                          ...
                          - (void)linkBefore:(NSObject<ListItem> *)next {
                              MSGSTART("LRUCacheItem:-(void)linkBefore:(NSObject<ListItem>*)next")
                          ...
                          - (NSObject<List> *)list {
                              MSGSTART("LRUCacheItem:-(NSObject<List>*)list")

                              /*i-999*/ NSObject<List> *ret = list;
                              /*i999*/ return ret;
                          }
                          - (NSObject<ListItem> *)next {
                              MSGSTART("LRUCacheItem:-(NSObject<ListItem>*)next")

                              /*i-999*/ NSObject<ListItem> *ret = v_next;
                              /*i999*/ return ret;
                          }
                          - (NSObject *)object {
                              MSGSTART("LRUCacheItem:-(NSObject*)object")

                              /*i-999*/ NSObject * ret = object;
                              /*i999*/ return ret;
                          }
                          - (NSMutableString *)objectName {
                              MSGSTART("LRUCacheItem:-(NSMutableString*)objectName")
                          ...
                          - (void)prepend {
                              MSGSTART("LRUCacheItem:-(void)prepend")
                              [self linkAfter : nil];
                          }
                          - (NSObject<ListItem> *)prev {
                              MSGSTART("LRUCacheItem:-(NSObject<ListItem>*)prev")

                              /*i-999*/ NSObject<ListItem> *ret = v_prev;
                              /*i999*/ return ret;
                          }
                          - (void)set_cacheKey:(NSObject<NSCopying> *)v {
                              MSGSTART("LRUCacheItem:-(void)set_cacheKey:(NSObject<NSCopying>*)v")
                          ...
                          - (void)setCache:(NSObject<LRUCache> *)v {
                              MSGSTART("LRUCacheItem:-(void)setCache:(NSObject<LRUCache>*)v")
                          ...
                          - (void)setList:(NSObject<List> *)v {
                              MSGSTART("LRUCacheItem:-(void)setList:(NSObject<List>*)v")
                          ...
                          - (void)setNext:(NSObject<ListItem> *)v {
                              MSGSTART("LRUCacheItem:-(void)setNext:(NSObject<ListItem>*)v")
                          ...
                          - (void)setPrev:(NSObject<ListItem> *)v {
                              MSGSTART("LRUCacheItem:-(void)setPrev:(NSObject<ListItem>*)v")
                          ...
                          - (void)unlink {
                              MSGSTART("LRUCacheItem:-(void)unlink")
...
// !!!: Implementations: m
        ...
        #undef _PrivateAccessMask_
                          ...
                          @synthesize objectIDInTotal = objectIDInTotal;
                          - (void)_startObjectOfClassMemMonitor {
                              MSGSTART("MemMonitor:-(void)_startObjectOfClassMemMonitor")
                              ...
                              /*i0*/}
                          - (constchar *)cdescription {
                              MSGSTART("MemMonitor:-(constchar*)cdescription")
                              return [self.description cStringUsingEncoding:NSASCIIStringEncoding];
                          }
                          - (constchar *)cobjectName {
                              MSGSTART("MemMonitor:-(constchar*)cobjectName")
                              return [self.objectName cStringUsingEncoding:NSASCIIStringEncoding];
                          }
                          - (void)dealloc {
                              MSGSTART("MemMonitor:-(void)dealloc")
...
/*i999*/}
                          - (NSString *)description {
                              MSGSTART("MemMonitor:-(NSString*)description")
                          ...
                          - (void)die {
                              MSGSTART("MemMonitor:-(void)die")

                              /*i900*/}
                          + (NSString *)memString {
                              MSGSTART("MemMonitor:+(NSString*)memString")
                          ...
                          - (NSMutableString *)objectName {
                              MSGSTART("MemMonitor:-(NSMutableString*)objectName")
...
// !!!: Implementations: r
        ...
        #undef _PrivateAccessMask_
                          ...
                          @synthesize objectIDInTotal = objectIDInTotal;
                          - (void)_startObjectOfClassRequestCaches {
                              MSGSTART("RequestCaches:-(void)_startObjectOfClassRequestCaches")
                              ...
                              /*i0*/}
                          - (NSData *)asData {
                              MSGSTART("RequestCaches:-(NSData*)asData")
                              return [NSKeyedArchiver archivedDataWithRootObject:self.asDictionary];
                          }
                          - (NSDictionary *)asDictionary {
                              MSGSTART("RequestCaches:-(NSDictionary*)asDictionary")
                          ...
                          - (NSObject<RequestCache> *)cacheForKey:(id<NSCopying> )key {
                              MSGSTART("RequestCaches:-(NSObject<RequestCache>*)cacheForKey:(id<NSCopying>)key")
                              return [v_caches objectForKey:key];
                          }
                          - (EndpointD *)caches {
                              MSGSTART("RequestCaches:-(EndpointD*)caches")

                              /*i-999*/ EndpointD * ret = v_caches;
                              /*i999*/ return ret;
                          }
                          - (NSObject<LinkEndpoint> *)cacheToEndpoint:(id)acache {
                              MSGSTART("RequestCaches:-(NSObject<LinkEndpoint>*)cacheToEndpoint:(id)acache")
                              return [acache performSelector:@selector(caches_endpoint)];
                          }
                          - (constchar *)cdescription {
                              MSGSTART("RequestCaches:-(constchar*)cdescription")
                              return [self.description cStringUsingEncoding:NSASCIIStringEncoding];
                          }
                          - (void)clearCaches {
                              MSGSTART("RequestCaches:-(void)clearCaches")
                          ...
                          - (constchar *)cobjectName {
                              MSGSTART("RequestCaches:-(constchar*)cobjectName")
                              return [self.objectName cStringUsingEncoding:NSASCIIStringEncoding];
                          }
                          - (NSString *)codingFilename {
                              MSGSTART("RequestCaches:-(NSString*)codingFilename")

                              /*i-999*/ NSString * ret = v_codingFilename;
                              /*i999*/ return ret;
                          }
                          - (void)dealloc {
                              MSGSTART("RequestCaches:-(void)dealloc")
...
/*i999*/}
                          - (bool)deleteCodableFile {
                              MSGSTART("RequestCaches:-(bool)deleteCodableFile")
                          ...
                          - (NSString *)description {
                              MSGSTART("RequestCaches:-(NSString*)description")
                          ...
                          - (void)die {
                              MSGSTART("RequestCaches:-(void)die")
                              [v_caches removeAllObjects];

                              /*i900*/}
                          - (NSString *)documentsCodingFilename {
                              MSGSTART("RequestCaches:-(NSString*)documentsCodingFilename")
                              return v_documentsCodingFilename;
                          }
                          + (RequestCaches *)get {
                              MSGSTART("RequestCaches:+(RequestCaches*)get")
                              return [[RequestCaches alloc] init];
                          }
                          - (Int)goForSeconds:(float)sec {
                              MSGSTART("RequestCaches:-(Int)goForSeconds:(float)sec")
                          ...
                          - (bool)goNext {
                              MSGSTART("RequestCaches:-(bool)goNext")
                          ...
                          - (RequestCaches *)init {
                              MSGSTART("RequestCaches:-(RequestCaches*)init")
...
/*i10001*/ return self;
                          ...
                          - (NSNumber *)isAcceptableCache:(id)acache {
                              MSGSTART("RequestCaches:-(NSNumber*)isAcceptableCache:(id)acache")
                              return [acache conformsToProtocol:@protocol(RequestCache)] ? @YES : nil;
                          }
                          - (void)loadCodable {
                              MSGSTART("RequestCaches:-(void)loadCodable")

                              [self loadCodableFromFilename : self.codingFilename];
                          }
                          - (void)loadCodableFromFilename:(NSString *)fn {
                              MSGSTART("RequestCaches:-(void)loadCodableFromFilename:(NSString*)fn")
                          ...
                          - (NSMutableString *)objectName {
                              MSGSTART("RequestCaches:-(NSMutableString*)objectName")
                          ...
                          - (void)removeAllCaches {
                              MSGSTART("RequestCaches:-(void)removeAllCaches")
                              [v_caches removeAllObjects];
                          }
                          - (void)removeCacheForKey:(id<NSCopying> )key {
                              MSGSTART("RequestCaches:-(void)removeCacheForKey:(id<NSCopying>)key")
                              [v_caches removeObjectForKey : key];
                          }
                          - (void)retract {
                              MSGSTART("RequestCaches:-(void)retract")
                              [self.caches removeAllObjects];
                          }
                          - (void)saveCodable {
                              MSGSTART("RequestCaches:-(void)saveCodable")

                              [self saveCodableToFilename : self.codingFilename];
                          }
                          - (void)saveCodableToFilename:(NSString *)fn {
                              MSGSTART("RequestCaches:-(void)saveCodableToFilename:(NSString*)fn")
                          ...
                          - (void)saveCodableToServer {
                              MSGSTART("RequestCaches:-(void)saveCodableToServer")
                          ...
                          - (void)setAsData:(NSData *)v {
                              MSGSTART("RequestCaches:-(void)setAsData:(NSData*)v")
                              self.asDictionary = [NSKeyedUnarchiver unarchiveObjectWithData:v];
                          }
                          - (void)setAsDictionary:(NSDictionary *)v {
                              MSGSTART("RequestCaches:-(void)setAsDictionary:(NSDictionary*)v")
                          ...
                          - (void)setCache:(id)v forKey:(id<NSCopying> )key {
                              MSGSTART("RequestCaches:-(void)setCache:(id)v forKey:(id<NSCopying>)key")
                              [v_caches setObject : v forKey : key];
                          }
                          - (void)setCaches:(EndpointD *)v {
                              MSGSTART("RequestCaches:-(void)setCaches:(EndpointD*)v")
...
/*i-850*/ REMOVEOWNER(v_caches,self); ADDOWNER(v,self);
                          ...
                          - (void)setCodingFilename:(NSString *)v {
                              MSGSTART("RequestCaches:-(void)setCodingFilename:(NSString*)v")
                          ...
                          - (void)setDocumentsCodingFilename:(NSString *)v {
                              MSGSTART("RequestCaches:-(void)setDocumentsCodingFilename:(NSString*)v")
                          ...
                          - (void)setWithDictionary:(NSDictionary *)d {
                              MSGSTART("RequestCaches:-(void)setWithDictionary:(NSDictionary*)d")
                          }
                          - (NSObject<Request> *)worthiestRequest {
                              MSGSTART("RequestCaches:-(NSObject<Request>*)worthiestRequest")
    ...
    #undef _Class_
        ...
        #undef _PrivateAccessMask_
                          ...
                          @synthesize objectIDInTotal = objectIDInTotal;
                          - (void)_startObjectOfClassRequestProxy {
                              MSGSTART("RequestProxy:-(void)_startObjectOfClassRequestProxy")
                              ...
                              /*i0*/}
                          - (void)append {
                              MSGSTART("RequestProxy:-(void)append")
                              [self linkBefore : nil];
                          }
                          - (constchar *)cdescription {
                              MSGSTART("RequestProxy:-(constchar*)cdescription")
                              return [self.description cStringUsingEncoding:NSASCIIStringEncoding];
                          }
                          - (constchar *)cobjectName {
                              MSGSTART("RequestProxy:-(constchar*)cobjectName")
                              return [self.objectName cStringUsingEncoding:NSASCIIStringEncoding];
                          }
                          - (void)dealloc {
                              MSGSTART("RequestProxy:-(void)dealloc")
...
/*i999*/}
                          - (NSString *)description {
                              MSGSTART("RequestProxy:-(NSString*)description")
                          ...
                          - (void)die {
                              MSGSTART("RequestProxy:-(void)die")
                              self.request = nil;
                              ...
                              /*i900*/}
                          - (RequestProxy *)initWithRequest:(NSObject<Request> *)request {
                              MSGSTART("RequestProxy:-(RequestProxy*)initWithRequest:(NSObject<Request>*)request")
...
/*i10001*/ return self;
                          ...
                          - (NSNumber *)isAcceptableListAsHead:(id)alistAsHead {
                              MSGSTART("RequestProxy:-(NSNumber*)isAcceptableListAsHead:(id)alistAsHead")
                              return [alistAsHead conformsToProtocol:@protocol(WeakList)] ? @YES : nil;
                          }
                          - (NSNumber *)isAcceptableListAsTail:(id)alistAsTail {
                              MSGSTART("RequestProxy:-(NSNumber*)isAcceptableListAsTail:(id)alistAsTail")
                              return [alistAsTail conformsToProtocol:@protocol(WeakList)] ? @YES : nil;
                          }
                          - (NSNumber *)isAcceptableNext:(id)anext {
                              MSGSTART("RequestProxy:-(NSNumber*)isAcceptableNext:(id)anext")
                              return [anext conformsToProtocol:@protocol(WeakListItem)] ? @YES : nil;
                          }
                          - (NSNumber *)isAcceptablePrev:(id)aprev {
                              MSGSTART("RequestProxy:-(NSNumber*)isAcceptablePrev:(id)aprev")
                              return [aprev conformsToProtocol:@protocol(WeakListItem)] ? @YES : nil;
                          }
                          - (NSNumber *)isAcceptableRequest:(id)arequest {
                              MSGSTART("RequestProxy:-(NSNumber*)isAcceptableRequest:(id)arequest")
                              return [arequest conformsToProtocol:@protocol(Request)] ? @YES : nil;
                          }
                          - (void)linkAfter:(NSObject<WeakListItem> *)prev {
                              MSGSTART("RequestProxy:-(void)linkAfter:(NSObject<WeakListItem>*)prev")
                          ...
                          - (void)linkBefore:(NSObject<WeakListItem> *)next {
                              MSGSTART("RequestProxy:-(void)linkBefore:(NSObject<WeakListItem>*)next")
                          ...
                          - (NSObject<WeakList> *)list {
                              MSGSTART("RequestProxy:-(NSObject<WeakList>*)list")

                              /*i-999*/ NSObject<WeakList> *ret = list;
                              /*i999*/ return ret;
                          }
                          - (NSObject<WeakList> *)listAsHead {
                              MSGSTART("RequestProxy:-(NSObject<WeakList>*)listAsHead")
                              return (NSObject<WeakList> *)v_listAsHead_endpoint.value;
                          }
                          - (Endpoint1 *)listAsHead_endpoint {
                              MSGSTART("RequestProxy:-(Endpoint1*)listAsHead_endpoint")

                              /*i-999*/ Endpoint1 * ret = v_listAsHead_endpoint;
                              /*i999*/ return ret;
                          }
                          - (NSObject<LinkEndpoint> *)listAsHeadToEndpoint:(id)alistAsHead {
                              MSGSTART("RequestProxy:-(NSObject<LinkEndpoint>*)listAsHeadToEndpoint:(id)alistAsHead")
                              return [alistAsHead performSelector:@selector(headItem_endpoint)];
                          }
                          - (NSObject<WeakList> *)listAsTail {
                              MSGSTART("RequestProxy:-(NSObject<WeakList>*)listAsTail")
                              return (NSObject<WeakList> *)v_listAsTail_endpoint.value;
                          }
                          - (Endpoint1 *)listAsTail_endpoint {
                              MSGSTART("RequestProxy:-(Endpoint1*)listAsTail_endpoint")

                              /*i-999*/ Endpoint1 * ret = v_listAsTail_endpoint;
                              /*i999*/ return ret;
                          }
                          - (NSObject<LinkEndpoint> *)listAsTailToEndpoint:(id)alistAsTail {
                              MSGSTART("RequestProxy:-(NSObject<LinkEndpoint>*)listAsTailToEndpoint:(id)alistAsTail")
                              return [alistAsTail performSelector:@selector(tailItem_endpoint)];
                          }
                          - (NSObject<WeakListItem> *)next {
                              MSGSTART("RequestProxy:-(NSObject<WeakListItem>*)next")
                              return (NSObject<WeakListItem> *)v_next_endpoint.value;
                          }
                          - (Endpoint1 *)next_endpoint {
                              MSGSTART("RequestProxy:-(Endpoint1*)next_endpoint")

                              /*i-999*/ Endpoint1 * ret = v_next_endpoint;
                              /*i999*/ return ret;
                          }
                          - (NSObject<LinkEndpoint> *)nextToEndpoint:(id)anext {
                              MSGSTART("RequestProxy:-(NSObject<LinkEndpoint>*)nextToEndpoint:(id)anext")
                              return [anext performSelector:@selector(prev_endpoint)];
                          }
                          - (NSMutableString *)objectName {
                              MSGSTART("RequestProxy:-(NSMutableString*)objectName")
                          ...
                          - (void)prepend {
                              MSGSTART("RequestProxy:-(void)prepend")
                              [self linkAfter : nil];
                          }
                          - (NSObject<WeakListItem> *)prev {
                              MSGSTART("RequestProxy:-(NSObject<WeakListItem>*)prev")
                              return (NSObject<WeakListItem> *)v_prev_endpoint.value;
                          }
                          - (Endpoint1 *)prev_endpoint {
                              MSGSTART("RequestProxy:-(Endpoint1*)prev_endpoint")

                              /*i-999*/ Endpoint1 * ret = v_prev_endpoint;
                              /*i999*/ return ret;
                          }
                          - (NSObject<LinkEndpoint> *)prevToEndpoint:(id)aprev {
                              MSGSTART("RequestProxy:-(NSObject<LinkEndpoint>*)prevToEndpoint:(id)aprev")
                              return [aprev performSelector:@selector(next_endpoint)];
                          }
                          - (NSObject<Request> *)request {
                              MSGSTART("RequestProxy:-(NSObject<Request>*)request")
                              return (NSObject<Request> *)v_request_endpoint.value;
                          }
                          - (Endpoint1 *)request_endpoint {
                              MSGSTART("RequestProxy:-(Endpoint1*)request_endpoint")

                              /*i-999*/ Endpoint1 * ret = v_request_endpoint;
                              /*i999*/ return ret;
                          }
                          - (NSObject<LinkEndpoint> *)requestToEndpoint:(id)arequest {
                              MSGSTART("RequestProxy:-(NSObject<LinkEndpoint>*)requestToEndpoint:(id)arequest")
                              return [arequest performSelector:@selector(proxys)];
                          }
                          - (void)retract {
                              MSGSTART("RequestProxy:-(void)retract")
                              self.request = nil;
                              self.listAsHead = nil;
                              self.listAsTail = nil;
                              self.prev = nil;
                          ...
                          - (void)setList:(NSObject<WeakList> *)v {
                              MSGSTART("RequestProxy:-(void)setList:(NSObject<WeakList>*)v")
                          ...
                          - (void)setListAsHead:(NSObject<WeakList> *)v {
                              MSGSTART("RequestProxy:-(void)setListAsHead:(NSObject<WeakList>*)v")
                              [v_listAsHead_endpoint setValue : v];
                          }
                          - (void)setListAsHead_endpoint:(Endpoint1 *)v {
                              MSGSTART("RequestProxy:-(void)setListAsHead_endpoint:(Endpoint1*)v")
...
/*i-850*/ REMOVEOWNER(v_listAsHead_endpoint,self); ADDOWNER(v,self);
                          ...
                          - (void)setListAsTail:(NSObject<WeakList> *)v {
                              MSGSTART("RequestProxy:-(void)setListAsTail:(NSObject<WeakList>*)v")
                              [v_listAsTail_endpoint setValue : v];
                          }
                          - (void)setListAsTail_endpoint:(Endpoint1 *)v {
                              MSGSTART("RequestProxy:-(void)setListAsTail_endpoint:(Endpoint1*)v")
...
/*i-850*/ REMOVEOWNER(v_listAsTail_endpoint,self); ADDOWNER(v,self);
                          ...
                          - (void)setNext:(NSObject<WeakListItem> *)v {
                              MSGSTART("RequestProxy:-(void)setNext:(NSObject<WeakListItem>*)v")
                              [v_next_endpoint setValue : v];
                          }
                          - (void)setNext_endpoint:(Endpoint1 *)v {
                              MSGSTART("RequestProxy:-(void)setNext_endpoint:(Endpoint1*)v")
...
/*i-850*/ REMOVEOWNER(v_next_endpoint,self); ADDOWNER(v,self);
                          ...
                          - (void)setPrev:(NSObject<WeakListItem> *)v {
                              MSGSTART("RequestProxy:-(void)setPrev:(NSObject<WeakListItem>*)v")
                              [v_prev_endpoint setValue : v];
                          }
                          - (void)setPrev_endpoint:(Endpoint1 *)v {
                              MSGSTART("RequestProxy:-(void)setPrev_endpoint:(Endpoint1*)v")
...
/*i-850*/ REMOVEOWNER(v_prev_endpoint,self); ADDOWNER(v,self);
                          ...
                          - (void)setRequest:(NSObject<Request> *)v {
                              MSGSTART("RequestProxy:-(void)setRequest:(NSObject<Request>*)v")
                              [v_request_endpoint setValue : v];
                          }
                          - (void)setRequest_endpoint:(Endpoint1 *)v {
                              MSGSTART("RequestProxy:-(void)setRequest_endpoint:(Endpoint1*)v")
...
/*i-850*/ REMOVEOWNER(v_request_endpoint,self); ADDOWNER(v,self);
                          ...
                          - (void)unlink {
                              MSGSTART("RequestProxy:-(void)unlink")
...
// !!!: Implementations: u
        ...
        #undef _PrivateAccessMask_
                          ...
                          - (void)_startObjectOfClassULLCarrier {
                              MSGSTART("ULLCarrier:-(void)_startObjectOfClassULLCarrier")
                              ...
                              /*i0*/}
                          + (ULLCarrier *)carrierWithULL:(ULL)v {
                              MSGSTART("ULLCarrier:+(ULLCarrier*)carrierWithULL:(ULL)v")

                              return [[ULLCarrier alloc] initWithULL:v];
                          }
                          - (constchar *)cdescription {
                              MSGSTART("ULLCarrier:-(constchar*)cdescription")
                              return [self.description cStringUsingEncoding:NSASCIIStringEncoding];
                          }
                          - (constchar *)cobjectName {
                              MSGSTART("ULLCarrier:-(constchar*)cobjectName")
                              return [self.objectName cStringUsingEncoding:NSASCIIStringEncoding];
                          }
                          - (void)dealloc {
                              MSGSTART("ULLCarrier:-(void)dealloc")
...
/*i999*/}
                          - (NSString *)description {
                              MSGSTART("ULLCarrier:-(NSString*)description")
                          ...
                          - (void)die {
                              MSGSTART("ULLCarrier:-(void)die")

                              /*i900*/}
                          - (ULLCarrier *)initWithULL:(ULL)v {
                              MSGSTART("ULLCarrier:-(ULLCarrier*)initWithULL:(ULL)v")
...
/*i10001*/ return self;
                          ...
                          - (NSMutableString *)objectName {
                              MSGSTART("ULLCarrier:-(NSMutableString*)objectName")
    ...
    #undef _Class_
        ...
        #undef _PrivateAccessMask_
                          ...
                          @synthesize objectIDInTotal = objectIDInTotal;
                          - (void)_startObjectOfClassURLHandlerRegistry {
                              MSGSTART("URLHandlerRegistry:-(void)_startObjectOfClassURLHandlerRegistry")
                              ...
                              /*i0*/}
                          - (bool)actOnURL:(NSURL *)url {
                              MSGSTART("URLHandlerRegistry:-(bool)actOnURL:(NSURL*)url")

                              NSObject * ret = [self makeResourceFromURL:url];
                              if ( !(ret && [ret respondsToSelector:@selector(act)]) ) {
                                  return NO;
                              }
                              else {
                          ...
                          - (void)addHandler:(id)handler {
                              MSGSTART("URLHandlerRegistry:-(void)addHandler:(id)handler")

                              [self.handlers addObject : handler];
                          }
                          - (constchar *)cdescription {
                              MSGSTART("URLHandlerRegistry:-(constchar*)cdescription")
                              return [self.description cStringUsingEncoding:NSASCIIStringEncoding];
                          }
                          - (constchar *)cobjectName {
                              MSGSTART("URLHandlerRegistry:-(constchar*)cobjectName")
                              return [self.objectName cStringUsingEncoding:NSASCIIStringEncoding];
                          }
                          - (void)dealloc {
                              MSGSTART("URLHandlerRegistry:-(void)dealloc")
...
/*i999*/}
                          - (NSString *)description {
                              MSGSTART("URLHandlerRegistry:-(NSString*)description")
                          ...
                          - (void)die {
                              MSGSTART("URLHandlerRegistry:-(void)die")

                              /*i900*/}
                          + (URLHandlerRegistry *)getDefault {
                              MSGSTART("URLHandlerRegistry:+(URLHandlerRegistry*)getDefault")
                          ...
                          - (MutableArray *)handlers {
                              MSGSTART("URLHandlerRegistry:-(MutableArray*)handlers")

                              /*i-999*/ MutableArray * ret = handlers;
                              /*i999*/ return ret;
                          }
                          - (URLHandlerRegistry *)init {
                              MSGSTART("URLHandlerRegistry:-(URLHandlerRegistry*)init")
...
/*i10001*/ return self;
                          ...
                          - (NSObject *)makeResourceFromURL:(NSURL *)url {
                              MSGSTART("URLHandlerRegistry:-(NSObject*)makeResourceFromURL:(NSURL*)url")
                          ...
                          - (NSMutableString *)objectName {
                              MSGSTART("URLHandlerRegistry:-(NSMutableString*)objectName")
                          ...
                          - (void)setHandlers:(MutableArray *)v {
                              MSGSTART("URLHandlerRegistry:-(void)setHandlers:(MutableArray*)v")
...
/*i-850*/ REMOVEOWNER(handlers,self); ADDOWNER(v,self);
    ...
    #undef _Class_
        ...
        #undef _PrivateAccessMask_
                          ...
                          @synthesize objectIDInTotal = objectIDInTotal;
                          - (void)_startObjectOfClassUtil {
                              MSGSTART("Util:-(void)_startObjectOfClassUtil")
                              ...
                              /*i0*/}
                          + (bool)getInsertsAndDeletesAsIndexSetWhenChanging:(NSArray *)from to:(NSArray *)to inss:(NSIndexSet *__strong *)pinss dels:(NSIndexSet *__strong *)pdels {
                              MSGSTART("Util:+(bool) getInsertsAndDeletesAsIndexSetWhenChanging:(NSArray*)from to:(NSArray*)to inss:(NSIndexSet*__strong*)pinss dels:(NSIndexSet*__strong*)pdels")
                              ...
                              for (NSNumber *num in dels) {
                                  [s addIndex:num.intValue];
                              }
                              *pdels = s;
                              s = [[NSMutableIndexSet alloc] init];
                              for (NSNumber *num in inss) {
                                  [s addIndex:num.intValue];
                              }
                              *pinss = s;
                              return YES;
                          ...
                          + (bool)getInsertsAndDeletesForSetWhenChanging:(NSSet *)from to:(NSSet *)to inss:(NSSet *__strong *)pinss dels:(NSSet *__strong *)pdels {
                              MSGSTART("Util:+(bool) getInsertsAndDeletesForSetWhenChanging:(NSSet*)from to:(NSSet*)to inss:(NSSet*__strong*)pinss dels:(NSSet*__strong*)pdels")
                          ...
                          + (bool)getInsertsAndDeletesWhenChanging:(NSArray *)from to:(NSArray *)to inss:(NSArray *__strong *)pinss dels:(NSArray *__strong *)pdels {
                              MSGSTART("Util:+(bool) getInsertsAndDeletesWhenChanging:(NSArray*)from to:(NSArray*)to inss:(NSArray*__strong*)pinss dels:(NSArray*__strong*)pdels")
                              ...
                              if (from == nil) {
                                  ...
                                  while ( (toi < [to count]) || (fromi < [from count]) ) {
                                      ...
                                      if (fromi >= [from count]) op = 'i';
                                              ...
                                              else if (fromi + j >= [from count]) {
                                                  op = 'i'; break;
                                              }
                                              else if ([Util objectOrString:[from objectAtIndex:fromi] equals:[to objectAtIndex:toi + j]]) {
                                                  op = 'i'; break;
                                              }
                                              else if ([Util objectOrString:[from objectAtIndex:fromi + j] equals:[to objectAtIndex:toi]]) {
                                                  op = 'd'; break;
                                              }
                                          }
                          ...
                          + (bool)getInsertsDeletesAndChangesForDictionaryWhenChanging:(NSDictionary *)from to:(NSDictionary *)to insKeys:(NSSet *__strong *)pinss delKeys:(NSSet *__strong *)pdels changeKeys:(NSSet *__strong *)pchanges {
                              MSGSTART("Util:+(bool) getInsertsDeletesAndChangesForDictionaryWhenChanging:(NSDictionary*)from to:(NSDictionary*)to insKeys:(NSSet*__strong*)pinss delKeys:(NSSet*__strong*)pdels changeKeys:(NSSet*__strong*)pchanges")
                              ...
                              if (from.count < to.count)
                                  for (id<NSCopying> key in from) {
                                      if ( (obj = [to objectForKey:key]) && ![obj isEqual:[from objectForKey:key]] ) {
                                          if (!changes) changes = [[MutableSet alloc] init];
                                          [changes addObject:key];
                                      }
                                  }
                              else
                                  for (id<NSCopying> key in to) {
                                      if ( (obj = [from objectForKey:key]) && ![obj isEqual:[to objectForKey:key]] ) {
                                          if (!changes) changes = [[MutableSet alloc] init];
                                          [changes addObject:key];
                                      }
                                  }
                          ...
                          - (constchar *)cdescription {
                              MSGSTART("Util:-(constchar*)cdescription")
                              return [self.description cStringUsingEncoding:NSASCIIStringEncoding];
                          }
                          + (const char *)cdescriptionFor:(id)object {
                              MSGSTART("Util:+(const char*)cdescriptionFor:(id)object")
                              return [Util descriptionFor:object].UTF8String;
                          }
                          + (void)clearStaticData {
                              MSGSTART("Util:+(void)clearStaticData")

                              if (_Util_default) _Util_default = nil;
                          }
                          + (const char *)cnameFor:(id)object {
                              MSGSTART("Util:+(const char*)cnameFor:(id)object")
                              return [Util nameFor:object].UTF8String;
                          }
                          - (constchar *)cobjectName {
                              MSGSTART("Util:-(constchar*)cobjectName")
                              return [self.objectName cStringUsingEncoding:NSASCIIStringEncoding];
                          }
                          - (void)dealloc {
                              MSGSTART("Util:-(void)dealloc")
...
/*i999*/}
                          - (NSString *)description {
                              MSGSTART("Util:-(NSString*)description")
                          ...
                          + (NSString *)descriptionFor:(id)object {
                              MSGSTART("Util:+(NSString*)descriptionFor:(id)object")
                          ...
                          - (void)die {
                              MSGSTART("Util:-(void)die")

                              /*i900*/}
                          + (Util *)getDefault {
                              MSGSTART("Util:+(Util*)getDefault")

                              if (!_Util_default) _Util_default = [[Util alloc] init];
                              return _Util_default;
                          }
                          + (void)logString:(NSString *)str object:(NSObject *)obj {
                              MSGSTART("Util:+(void)logString:(NSString*)str object:(NSObject*)obj")
                          ...
                          + (void)logStringRecurse:(NSString *)str object:(NSObject *)obj {
                              MSGSTART("Util:+(void)logStringRecurse:(NSString*)str object:(NSObject*)obj")
                          ...
                          + (NSString *)nameFor:(id)object {
                              MSGSTART("Util:+(NSString*)nameFor:(id)object")
                          ...
                          - (NSMutableString *)objectName {
                              MSGSTART("Util:-(NSMutableString*)objectName")
                          ...
                          + (bool)objectOrString:(id)a equals:(id)b {
                              MSGSTART("Util:+(bool)objectOrString:(id)a equals:(id)b")
...
// !!!: Implementations: w
        ...
        #undef _PrivateAccessMask_
                          ...
                          @synthesize objectIDInTotal = objectIDInTotal;
                          - (void)_startObjectOfClassWeakList {
                              MSGSTART("WeakList:-(void)_startObjectOfClassWeakList")
                              ...
                              /*i0*/}
                          - (void)append:(NSObject<WeakListItem> *)item {
                              MSGSTART("WeakList:-(void)append:(NSObject<WeakListItem>*)item")
                              [self link : item before : nil];
                          }
                          - (constchar *)cdescription {
                              MSGSTART("WeakList:-(constchar*)cdescription")
                              return [self.description cStringUsingEncoding:NSASCIIStringEncoding];
                          }
                          - (constchar *)cobjectName {
                              MSGSTART("WeakList:-(constchar*)cobjectName")
                              return [self.objectName cStringUsingEncoding:NSASCIIStringEncoding];
                          }
                          - (Unsigned)count {
                              MSGSTART("WeakList:-(Unsigned)count")
                              return _count;
                          }
                          - (void)dealloc {
                              MSGSTART("WeakList:-(void)dealloc")
...
/*i999*/}
                          - (NSString *)description {
                              MSGSTART("WeakList:-(NSString*)description")
                          ...
                          - (void)die {
                              MSGSTART("WeakList:-(void)die")

                              self.headItem = nil;
                              self.tailItem = nil;
                              /*i900*/}
                          + (WeakList *)get {
                              MSGSTART("WeakList:+(WeakList*)get")
                              return [[WeakList alloc] init];
                          }
                          - (NSObject<WeakListItem> *)headItem {
                              MSGSTART("WeakList:-(NSObject<WeakListItem>*)headItem")
                              return (NSObject<WeakListItem> *)v_headItem_endpoint.value;
                          }
                          - (Endpoint1 *)headItem_endpoint {
                              MSGSTART("WeakList:-(Endpoint1*)headItem_endpoint")

                              /*i-999*/ Endpoint1 * ret = v_headItem_endpoint;
                              /*i999*/ return ret;
                          }
                          - (NSObject<LinkEndpoint> *)headItemToEndpoint:(id)aheadItem {
                              MSGSTART("WeakList:-(NSObject<LinkEndpoint>*)headItemToEndpoint:(id)aheadItem")
                              return [aheadItem performSelector:@selector(listAsHead_endpoint)];
                          }
                          - (WeakList *)init {
                              MSGSTART("WeakList:-(WeakList*)init")
...
/*i10001*/ return self;
                          ...
                          - (NSNumber *)isAcceptableHeadItem:(id)aheadItem {
                              MSGSTART("WeakList:-(NSNumber*)isAcceptableHeadItem:(id)aheadItem")
                              return [aheadItem conformsToProtocol:@protocol(WeakListItem)] ? @YES : nil;
                          }
                          - (NSNumber *)isAcceptableTailItem:(id)atailItem {
                              MSGSTART("WeakList:-(NSNumber*)isAcceptableTailItem:(id)atailItem")
                              return [atailItem conformsToProtocol:@protocol(WeakListItem)] ? @YES : nil;
                          }
                          - (void)link:(NSObject<WeakListItem> *)item after:(NSObject<WeakListItem> *)prev {
                              MSGSTART("WeakList:-(void)link:(NSObject<WeakListItem>*)item after:(NSObject<WeakListItem>*)prev")
                          ...
                          - (void)link:(NSObject<WeakListItem> *)item before:(NSObject<WeakListItem> *)next {
                              MSGSTART("WeakList:-(void)link:(NSObject<WeakListItem>*)item before:(NSObject<WeakListItem>*)next")
                          ...
                          - (NSMutableString *)objectName {
                              MSGSTART("WeakList:-(NSMutableString*)objectName")
                          ...
                          - (void)prepend:(NSObject<WeakListItem> *)item {
                              MSGSTART("WeakList:-(void)prepend:(NSObject<WeakListItem>*)item")
                              [self link : item after : nil];
                          }
                          - (void)retract {
                              MSGSTART("WeakList:-(void)retract")
                              self.headItem = nil;
                              self.tailItem = nil;
                          }
                          - (void)setHeadItem:(NSObject<WeakListItem> *)v {
                              MSGSTART("WeakList:-(void)setHeadItem:(NSObject<WeakListItem>*)v")
                              [v_headItem_endpoint setValue : v];
                          }
                          - (void)setHeadItem_endpoint:(Endpoint1 *)v {
                              MSGSTART("WeakList:-(void)setHeadItem_endpoint:(Endpoint1*)v")
...
/*i-850*/ REMOVEOWNER(v_headItem_endpoint,self); ADDOWNER(v,self);
                          ...
                          - (void)setTailItem:(NSObject<WeakListItem> *)v {
                              MSGSTART("WeakList:-(void)setTailItem:(NSObject<WeakListItem>*)v")
                              [v_tailItem_endpoint setValue : v];
                          }
                          - (void)setTailItem_endpoint:(Endpoint1 *)v {
                              MSGSTART("WeakList:-(void)setTailItem_endpoint:(Endpoint1*)v")
...
/*i-850*/ REMOVEOWNER(v_tailItem_endpoint,self); ADDOWNER(v,self);
                          ...
                          - (void)setWithDictionary:(NSDictionary *)d {
                              MSGSTART("WeakList:-(void)setWithDictionary:(NSDictionary*)d")
                          }
                          - (NSObject<WeakListItem> *)tailItem {
                              MSGSTART("WeakList:-(NSObject<WeakListItem>*)tailItem")
                              return (NSObject<WeakListItem> *)v_tailItem_endpoint.value;
                          }
                          - (Endpoint1 *)tailItem_endpoint {
                              MSGSTART("WeakList:-(Endpoint1*)tailItem_endpoint")

                              /*i-999*/ Endpoint1 * ret = v_tailItem_endpoint;
                              /*i999*/ return ret;
                          }
                          - (NSObject<LinkEndpoint> *)tailItemToEndpoint:(id)atailItem {
                              MSGSTART("WeakList:-(NSObject<LinkEndpoint>*)tailItemToEndpoint:(id)atailItem")

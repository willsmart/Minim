...
-(void)_startObjectOfClassClassCount {MSGSTART("ClassCount:-(void)_startObjectOfClassClassCount")

    }
+(ClassCount*)classCount {MSGSTART("ClassCount:+(ClassCount*)classCount")

          return([[ClassCount alloc] init]);
    }
-(void)dealloc {MSGSTART("ClassCount:-(void)dealloc")
  
  /*i-151*/[self die];
/*i0*/name=nil;
/*i999*/}
-(NSString*)description {MSGSTART("ClassCount:-(NSString*)description")
  return([NSString stringWithFormat:@"%@x%qu",name,count]);}
-(void)die {MSGSTART("ClassCount:-(void)die")
  
  /*i900*/}
-(ClassCount*)initWithName:(NSString*)aname {MSGSTART("ClassCount:-(ClassCount*)initWithName:(NSString*)aname")
...
/*i10001*/return(self);}
-(NSString*)name {MSGSTART("ClassCount:-(NSString*)name")
...
-(void)_startObjectOfClassObjectPointer {MSGSTART("ObjectPointer:-(void)_startObjectOfClassObjectPointer")

    }
-(id)copyWithZone:(NSZone*)zone {MSGSTART("ObjectPointer:-(id)copyWithZone:(NSZone*)zone")

          return([[ObjectPointer allocWithZone:zone] initWithObjectID:objectIDInTotal]);
    }
-(void)dealloc {MSGSTART("ObjectPointer:-(void)dealloc")
  
  /*i-151*/[self die];
/*i999*/}
-(void)die {MSGSTART("ObjectPointer:-(void)die")
  
  /*i900*/}
-(Unsigned)hash {MSGSTART("ObjectPointer:-(Unsigned)hash")
  return((Unsigned)obfuscateULL(objectIDInTotal));}
-(ObjectPointer*)initWithObjectID:(LL)aobjectIDInTotal {MSGSTART("ObjectPointer:-(ObjectPointer*)initWithObjectID:(LL)aobjectIDInTotal")
...
/*i10001*/return(self);}
-(BOOL)isEqual:(id)obj {MSGSTART("ObjectPointer:-(BOOL)isEqual:(id)obj")
...
-(void)_startObjectOfClassSingletons {MSGSTART("Singletons:-(void)_startObjectOfClassSingletons")
  ...
  /*i-500*//*ivar*/v_homeURLPrefix=(@"http://localhost/");
   /*ivar*/v_styleName=(@"Synesthete");
   /*ivar*/online=(YES);
   /*ivar*/v_typeCountHistory=([NSMutableArray array]);
  
  /*i0*/for (Int i=0;i<5;i++) [self.typeCountHistory addObject:[NSMutableDictionary dictionary]];
...
+(Singletons*)_ {MSGSTART("Singletons:+(Singletons*)_")
  return(self.getDefault);}
-(void)dealloc {MSGSTART("Singletons:-(void)dealloc")
...
/*i999*/}
-(NSString*)description {MSGSTART("Singletons:-(NSString*)description")
...
-(void)die {MSGSTART("Singletons:-(void)die")
  
  /*i900*/}
-(Files*)files {MSGSTART("Singletons:-(Files*)files")

              return !files?files=[Files new]:files;
        }
+(Singletons*)getDefault {MSGSTART("Singletons:+(Singletons*)getDefault")
...
-(NSString*)homeURLPrefix {MSGSTART("Singletons:-(NSString*)homeURLPrefix")
  
  /*i-999*/NSString* ret=v_homeURLPrefix;
  /*i999*/return(ret);}
-(NSMutableString*)htmlParseOutput {MSGSTART("Singletons:-(NSMutableString*)htmlParseOutput")

              return !htmlParseOutput?htmlParseOutput=[NSMutableString new]:htmlParseOutput;
        }
-(Singletons*)init {MSGSTART("Singletons:-(Singletons*)init")
...
/*i10001*/return(self);}
-(Log*)log {MSGSTART("Singletons:-(Log*)log")
  return(log?log:(log=[[Log alloc] init]));}
-(ObjectGraph*)objectGraph {MSGSTART("Singletons:-(ObjectGraph*)objectGraph")
  return(!objectGraph?objectGraph=[[ObjectGraph alloc] init]:objectGraph);}
-(NSMutableDictionary*)regexCache {MSGSTART("Singletons:-(NSMutableDictionary*)regexCache")

          return(!regexCache?regexCache=@{}.mutableCopy:regexCache);
    }
-(void)setHomeURLPrefix:(NSString*)v {MSGSTART("Singletons:-(void)setHomeURLPrefix:(NSString*)v")
  
  /*i-905*/if(v_homeURLPrefix==v)return;
  /*i-900*/{v_homeURLPrefix=(id)v;}}
-(void)setStyleName:(NSString*)v {MSGSTART("Singletons:-(void)setStyleName:(NSString*)v")
  
  /*i-905*/if(v_styleName==v)return;
  /*i-900*/{v_styleName=(id)v;}}
-(void)setTim:(NSTimer*)v {MSGSTART("Singletons:-(void)setTim:(NSTimer*)v")
  
  /*i-905*/if(v_tim==v)return;
  /*i-900*/{v_tim=(id)v;}}
-(void)setTotalObjectCount:(ClassCount*)v {MSGSTART("Singletons:-(void)setTotalObjectCount:(ClassCount*)v")
  
  /*i-905*/if(totalObjectCount==v)return;
  /*i-900*/{totalObjectCount=(id)v;}
/*i-850*/REMOVEOWNER(totalObjectCount,self);ADDOWNER(v,self);}
-(void)setTypeCountHistory:(NSMutableArray*)v {MSGSTART("Singletons:-(void)setTypeCountHistory:(NSMutableArray*)v")
  
  /*i-905*/if(v_typeCountHistory==v)return;
  /*i-900*/{v_typeCountHistory=(id)v;}}
-(void)startWithInterval:(float)interval {MSGSTART("Singletons:-(void)startWithInterval:(float)interval")

          [self.tim invalidate];
          self.tim=[NSTimer scheduledTimerWithTimeInterval:interval target:self selector:@selector(tick) userInfo:nil repeats:YES];
    }
-(void)stop {MSGSTART("Singletons:-(void)stop")

          [self.tim invalidate];
          self.tim=nil;
    }
-(NSString*)styleName {MSGSTART("Singletons:-(NSString*)styleName")
  
  /*i-999*/NSString* ret=v_styleName;
  /*i999*/return(ret);}
-(void)tick {MSGSTART("Singletons:-(void)tick")
...
-(NSTimer*)tim {MSGSTART("Singletons:-(NSTimer*)tim")
  
  /*i-999*/NSTimer* ret=v_tim;
  /*i999*/return(ret);}
-(ClassCount*)totalObjectCount {MSGSTART("Singletons:-(ClassCount*)totalObjectCount")
  
  /*i-999*/ClassCount* ret=totalObjectCount;
  /*i999*/return(ret);}
-(Trace*)trace {MSGSTART("Singletons:-(Trace*)trace")
  return(!trace?trace=[[Trace alloc] init]:trace);}
-(NSMutableArray*)typeCountHistory {MSGSTART("Singletons:-(NSMutableArray*)typeCountHistory")
  
  /*i-999*/NSMutableArray* ret=v_typeCountHistory;
  /*i999*/return(ret);}
-(WIParse*)wiParse {MSGSTART("Singletons:-(WIParse*)wiParse")

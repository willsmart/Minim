...
#pragma mark Interfaces:
        ...
        @property (strong,nonatomic,readwrite) NSArray *tokens;
...
// !!!: Implementations: f
    ...
    - (void)_startObjectOfClassFile {
        MSGSTART("File:-(void)_startObjectOfClassFile")
    ...
    - (void)addChildren:(File *)v {
        MSGSTART("File:-(void)addChildren:(File*)v")
        [v_childrens addObject : v];
    }
    - (void)addParent:(File *)v {
        MSGSTART("File:-(void)addParent:(File*)v")
        [v_parents addObject : v];
    }
    - (constchar *)cdescription {
        MSGSTART("File:-(constchar*)cdescription")
        return [self.description cStringUsingEncoding:NSASCIIStringEncoding];
    }
    - (NSString *)childPathForPath:(NSString *)childPath {
        MSGSTART("File:-(NSString*)childPathForPath:(NSString*)childPath")
        return childPath.isAbsolutePath ?
               childPath :
               [path.stringByDeletingLastPathComponent stringByAppendingPathComponent:childPath];
    }
    - (EndpointS *)childrens {
        MSGSTART("File:-(EndpointS*)childrens")

        /*i-999*/ EndpointS * ret = v_childrens;
        /*i999*/ return ret;
    }
    - (NSObject<LinkEndpoint> *)childrenToEndpoint:(id)achildren {
        MSGSTART("File:-(NSObject<LinkEndpoint>*)childrenToEndpoint:(id)achildren")
        return [achildren performSelector:@selector(parents)];
    }
    - (File *)childWithPath:(NSString *)childPath {
        MSGSTART("File:-(File*)childWithPath:(NSString*)childPath")
...
/*i999*/}
    - (NSString *)description {
        MSGSTART("File:-(NSString*)description")
...
/*i10001*/ return self;
    ...
    - (File *)initialParent {
        MSGSTART("File:-(File*)initialParent")

        /*i-999*/ File * ret = initialParent;
        /*i999*/ return ret;
    }
    - (NSNumber *)isAcceptableChildren:(id)achildren {
        MSGSTART("File:-(NSNumber*)isAcceptableChildren:(id)achildren")
        return [achildren isKindOfClass:[File class]] ? @YES : nil;
    }
    - (NSNumber *)isAcceptableParent:(id)aparent {
        MSGSTART("File:-(NSNumber*)isAcceptableParent:(id)aparent")
        return [aparent isKindOfClass:[File class]] ? @YES : nil;
    }
    + (instancetype)newFileWithPath:(NSString *)apath inParent:(File *)aparent {
        MSGSTART("File:+(instancetype)newFileWithPath:(NSString*)apath inParent:(File*)aparent")
        return [[self alloc] initFileWithPath:apath inParent:aparent];
    }
    - (NSMutableString *)objectName {
        MSGSTART("File:-(NSMutableString*)objectName")
    ...
    - (EndpointS *)parents {
        MSGSTART("File:-(EndpointS*)parents")

        /*i-999*/ EndpointS * ret = v_parents;
        /*i999*/ return ret;
    }
    - (NSObject<LinkEndpoint> *)parentToEndpoint:(id)aparent {
        MSGSTART("File:-(NSObject<LinkEndpoint>*)parentToEndpoint:(id)aparent")
        return [aparent performSelector:@selector(childrens)];
    }
    - (NSString *)path {
        MSGSTART("File:-(NSString*)path")

        /*i-999*/ NSString * ret = path;
        /*i999*/ return ret;
    }
    - (void)removeAllChildrens {
        MSGSTART("File:-(void)removeAllChildrens")
        [v_childrens removeAllObjects];
    }
    - (void)removeAllParents {
        MSGSTART("File:-(void)removeAllParents")
        [v_parents removeAllObjects];
    }
    - (void)removeChildren:(File *)v {
        MSGSTART("File:-(void)removeChildren:(File*)v")
        [v_childrens removeObject : v];
    }
    - (void)removeParent:(File *)v {
        MSGSTART("File:-(void)removeParent:(File*)v")
        [v_parents removeObject : v];
    }
    - (void)retract {
        MSGSTART("File:-(void)retract")
        [self.childrens removeAllObjects];
        [self.parents removeAllObjects];
    }
    - (void)setChildrens:(EndpointS *)v {
        MSGSTART("File:-(void)setChildrens:(EndpointS*)v")
...
/*i-850*/ REMOVEOWNER(v_childrens,self); ADDOWNER(v,self);
    ...
    - (void)setParents:(EndpointS *)v {
        MSGSTART("File:-(void)setParents:(EndpointS*)v")
...
/*i-850*/ REMOVEOWNER(v_parents,self); ADDOWNER(v,self);
    ...
    - (void)setTokens:(NSArray *)v {
        MSGSTART("File:-(void)setTokens:(NSArray*)v")

        /*i-905*/ if (tokens == v) return;
    ...
    @synthesize objectIDInTotal = objectIDInTotal;
    - (void)_startObjectOfClassFiles {
        MSGSTART("Files:-(void)_startObjectOfClassFiles")

        /*i-996*/ debugAutorelease = YES;
        /*i-995*/ objInitFn(self,objectIDInTotal,objectIDInClass);

        /*i-500*//*ivar*/ v_basePath = ([[NSFileManager defaultManager] currentDirectoryPath]);
    ...
    - (constchar *)cobjectName {
        MSGSTART("Files:-(constchar*)cobjectName")
        return [self.objectName cStringUsingEncoding:NSASCIIStringEncoding];
    }
    - (void)dealloc {
        MSGSTART("Files:-(void)dealloc")
...
/*i999*/}
    - (NSString *)description {
        MSGSTART("Files:-(NSString*)description")
    ...
    - (void)die {
        MSGSTART("Files:-(void)die")

        /*i900*/}
    - (NSMutableDictionary *)files {
        MSGSTART("Files:-(NSMutableDictionary*)files")

        /*i-999*/ NSMutableDictionary * ret = files;
        /*i999*/ return ret;
    }
    - (File *)fileWithPath:(NSString *)path {
        MSGSTART("Files:-(File*)fileWithPath:(NSString*)path")
...
/*i10001*/ return self;
    ...
    - (NSMutableString *)objectName {
        MSGSTART("Files:-(NSMutableString*)objectName")
    ...
    - (NSString *)pathForPath:(NSString *)path {
        MSGSTART("Files:-(NSString*)pathForPath:(NSString*)path")
...
// !!!: Implementations: w
    ...
    @synthesize objectIDInTotal = objectIDInTotal;
    - (void)_startObjectOfClassWIParse {
        MSGSTART("WIParse:-(void)_startObjectOfClassWIParse")
        ...
        ( (id<ParseClass> )Parse.class ).rulesFilename = @"/Users/Will/Documents/WInterface/Parse/rules_wi.txt";
    }
    - (constchar *)cdescription {
        MSGSTART("WIParse:-(constchar*)cdescription")
        return [self.description cStringUsingEncoding:NSASCIIStringEncoding];
    }
    - (constchar *)cobjectName {
        MSGSTART("WIParse:-(constchar*)cobjectName")
        return [self.objectName cStringUsingEncoding:NSASCIIStringEncoding];
    }
    - (void)dealloc {
        MSGSTART("WIParse:-(void)dealloc")
...
/*i999*/}
    - (NSString *)description {
        MSGSTART("WIParse:-(NSString*)description")
    ...
    - (void)die {
        MSGSTART("WIParse:-(void)die")

        /*i900*/}
    - (WIParse *)init {
        MSGSTART("WIParse:-(WIParse*)init")
...
/*i10001*/ return self;
    ...
    - (NSMutableString *)objectName {
        MSGSTART("WIParse:-(NSMutableString*)objectName")
        ...
        if (ret) {
            ...
            if (!hasError) {
                if (isEmpty) {
                    ...
                    Token *t = [(Token *)ret[0] children][1];
            ...
            NSDictionary *d = @{
                @"prog":body,
                @"graph":[Parse graphFromTokens:ret],

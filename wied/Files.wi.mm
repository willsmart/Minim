...
/*i-850*/ REMOVEOWNER(v_parents,self); ADDOWNER(v,self);
    ...
    - (void)setWiFile:(WIFile *)v {
        MSGSTART("File:-(void)setWiFile:(WIFile*)v")
...
/*i10001*/ return self;
    ...
    - (void)writeMergeHTML {
        MSGSTART("Files:-(void)writeMergeHTML")
...
/*i10001*/ return self;
    ...
    - (WIFile *)wiFileFromFile:(NSString *)path {
        MSGSTART("WIParse:-(WIFile*)wiFileFromFile:(NSString*)path")
        path = [Singletons._.files pathForPath:path];
        NSError *err = nil;
        NSString *body = nil;
        NSMutableArray *tokens = [Parse getTokensForFile:path options:ParseOptions_none retForString:&body].mutableCopy;
        if (tokens) {

...
-(void)_startObjectOfClassTokenHelper {MSGSTART("TokenHelper:-(void)_startObjectOfClassTokenHelper")
  
  /*i-996*/debugAutorelease=YES;
  /*i-995*/objInitFn(self,objectIDInTotal,objectIDInClass);
      
  /*i0*/}
+(Token*)actualToken:(Token*)token {MSGSTART("TokenHelper:+(Token*)actualToken:(Token*)token")

          return([self actualToken:token havingRuleIn:nil]);
    }
+(Token*)actualToken:(Token*)token havingRuleIn:(NSArray*)ruleNames {MSGSTART("TokenHelper:+(Token*)actualToken:(Token*)token havingRuleIn:(NSArray*)ruleNames")
...
-(constchar*)cdescription {MSGSTART("TokenHelper:-(constchar*)cdescription")
  return([self.description cStringUsingEncoding:NSASCIIStringEncoding]);}
+(NSArray*)childrenForToken:(Token*)token {MSGSTART("TokenHelper:+(NSArray*)childrenForToken:(Token*)token")

          return([self childrenForToken:token havingRuleIn:nil]);
    }
+(NSArray*)childrenForToken:(Token*)token havingRuleIn:(NSArray*)ruleNames {MSGSTART("TokenHelper:+(NSArray*)childrenForToken:(Token*)token havingRuleIn:(NSArray*)ruleNames")
...
-(constchar*)cobjectName {MSGSTART("TokenHelper:-(constchar*)cobjectName")
  return([self.objectName cStringUsingEncoding:NSASCIIStringEncoding]);}
-(void)dealloc {MSGSTART("TokenHelper:-(void)dealloc")
...
/*i999*/}
-(NSString*)description {MSGSTART("TokenHelper:-(NSString*)description")
  
  /*i-999*/NSMutableString *ret=self.objectName;
          
  /*i999*/return(ret);
    }
-(void)die {MSGSTART("TokenHelper:-(void)die")
  
  /*i900*/}
+(bool)isJustSetting:(Token*)token {MSGSTART("TokenHelper:+(bool)isJustSetting:(Token*)token")
...
-(NSMutableString*)objectName {MSGSTART("TokenHelper:-(NSMutableString*)objectName")
...
+(NSDictionary*)settingDictionaryForToken:(Token*)token addTo:(NSMutableDictionary*)ret {MSGSTART("TokenHelper:+(NSDictionary*)settingDictionaryForToken:(Token*)token addTo:(NSMutableDictionary*)ret")
...
@synthesize objectIDInClass=objectIDInClass;
@synthesize objectIDInTotal=objectIDInTotal;
-(void)_startObjectOfClassTreeable {MSGSTART("Treeable:-(void)_startObjectOfClassTreeable")
  
  /*i-996*/debugAutorelease=YES;
  /*i-995*/objInitFn(self,objectIDInTotal,objectIDInClass);
      
  /*i0*/}
+(NSMutableDictionary*)asD3Tree:(NSObject*)dictOrArray {MSGSTART("Treeable:+(NSMutableDictionary*)asD3Tree:(NSObject*)dictOrArray")
...
+(NSMutableDictionary*)asTree:(NSMutableSet*)seen object:(NSObject<Treeable>*)me {MSGSTART("Treeable:+(NSMutableDictionary*)asTree:(NSMutableSet*)seen object:(NSObject<Treeable>*)me")
...
-(constchar*)cdescription {MSGSTART("Treeable:-(constchar*)cdescription")
  return([self.description cStringUsingEncoding:NSASCIIStringEncoding]);}
-(constchar*)cobjectName {MSGSTART("Treeable:-(constchar*)cobjectName")
  return([self.objectName cStringUsingEncoding:NSASCIIStringEncoding]);}
-(void)dealloc {MSGSTART("Treeable:-(void)dealloc")
...
/*i999*/}
-(NSString*)description {MSGSTART("Treeable:-(NSString*)description")
  
  /*i-999*/NSMutableString *ret=self.objectName;
          
  /*i999*/return(ret);
    }
-(void)die {MSGSTART("Treeable:-(void)die")
  
  /*i900*/}
-(NSMutableString*)objectName {MSGSTART("Treeable:-(NSMutableString*)objectName")

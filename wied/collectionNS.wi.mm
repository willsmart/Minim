...
// !!!: Implementations: p
    ...
    - (void)_startObjectOfClassPointerKey {
        MSGSTART("PointerKey:-(void)_startObjectOfClassPointerKey")
    }
    - (id)copyWithZone:(NSZone *)zone {
        MSGSTART("PointerKey:-(id)copyWithZone:(NSZone*)zone")

        return [[PointerKey allocWithZone:zone] initWithObject:o];
    }
    - (void)dealloc {
        MSGSTART("PointerKey:-(void)dealloc")

        /*i-151*/[self die];
/*i0*/ o = nil;
/*i999*/}
    - (NSString *)debugDescription {
        MSGSTART("PointerKey:-(NSString*)debugDescription")
        return [NSString stringWithFormat:@"Wrapped:%p",o];
    }
    - (NSString *)description {
        MSGSTART("PointerKey:-(NSString*)description")
        return [NSString stringWithFormat:@"Wrapped:%p",o];
    }
    - (void)die {
        MSGSTART("PointerKey:-(void)die")

        /*i900*/}
    - (id)initWithObject:(id)ao {
        MSGSTART("PointerKey:-(id)initWithObject:(id)ao")
    ...
    - (BOOL)isEqual:(id)object {
        MSGSTART("PointerKey:-(BOOL)isEqual:(id)object")
...
// !!!: Implementations: w
    ...
    @synthesize hash = hash;
    - (void)_startObjectOfClassWeakObject {
        MSGSTART("WeakObject:-(void)_startObjectOfClassWeakObject")
    }
    - (id)copyWithZone:(NSZone *)zone {
        MSGSTART("WeakObject:-(id)copyWithZone:(NSZone*)zone")

        return [[WeakObject allocWithZone:zone] initWithObject:o];
    }
    - (void)dealloc {
        MSGSTART("WeakObject:-(void)dealloc")

        /*i-151*/[self die];
/*i0*/ o = nil;
/*i999*/}
    - (NSString *)debugDescription {
        MSGSTART("WeakObject:-(NSString*)debugDescription")
        return [NSString stringWithFormat:@"Weak:%p",o];
    }
    + (NSObject *)deref:(NSObject *)ao {
        MSGSTART("WeakObject:+(NSObject*)deref:(NSObject*)ao")

        return ao ? ( [ao isKindOfClass:[WeakObject class]] ? ( (WeakObject *)ao ).o :
                      ([ao isKindOfClass:[PointerKey class]] ? ( (PointerKey *)ao ).o : ao) ) : nil;
    }
    - (NSString *)description {
        MSGSTART("WeakObject:-(NSString*)description")
        return [NSString stringWithFormat:@"Weak:%p",o];
    }
    - (void)die {
        MSGSTART("WeakObject:-(void)die")

        /*i900*/}
    - (id)initWithObject:(id)ao {
        MSGSTART("WeakObject:-(id)initWithObject:(id)ao")
    ...
    - (BOOL)isEqual:(id)object {
        MSGSTART("WeakObject:-(BOOL)isEqual:(id)object")
    ...
    + (WeakObject *)keyWithObject:(id)ao {
        MSGSTART("WeakObject:+(WeakObject*)keyWithObject:(id)ao")

        return [[WeakObject alloc] initWithObject:ao];
    }
    - (id)o {
        MSGSTART("WeakObject:-(id)o")
